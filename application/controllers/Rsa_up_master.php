...
//                                'urut' => $this->rsa_up_model->get_urut($kd_unit,$jenis,$tahun)
                           ...
                           // echo '<pre>'; var_dump($data_spp); die;
                            ...
                            // $dokumen_up = ''; //$this->rsa_up_model->check_dokumen_up($kd_unit,$tahun,$id_nomor_up);
...
//                                'urut' => $this->rsa_up_model->get_urut($kd_unit,$jenis,$tahun)
                           ...
                           // echo '<pre>'; var_dump($data); die;
                            ...
                            $dokumen_up = 'SPP-FINAL';//$this->rsa_up_model->check_dokumen_up($kd_unit,$tahun,$id_nomor_up);
    ...
    //                        var_dump($data_spm);die;
                ...
                function proses_spp_up(){
                    if($this->input->post('proses')){
                        ...
                        //$dokumen = 'SPP-DRAFT'; //$this->rsa_up_model->check_dokumen_up($kd_unit,$tahun,$id_nomor_up);
