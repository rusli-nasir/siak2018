<?php
    ...
    class rsa_gup_nihil extends CI_Controller{
/* -------------- Constructor ------------- */
    ...
    public function __construct(){ 
        parent::__construct();
            ...
            $this->load->model(array('rsa_gup_nihil_model','akun_model','setting_up_model','kuitansi_model','kuitansipengembalian_model'));
        ...
        function index(){
                    if($this->check_session->user_session()){
                        ...
                        $subdata['jenis']           = 'gup_nihil';
                        $data['main_content']   = $this->load->view('rsa_pengesahan/index',$subdata,TRUE);
...
//                        $data['message']  = validation_errors();
                ...
                function create_spp_gup_nihil(){
                    if($this->check_session->user_session() && (($this->check_session->get_level()==13)||($this->check_session->get_level()==100))){
                        if($this->input->post('rel_kuitansi')){
                            ...
                            $str_nomor_trx_spm_gup = $this->input->post('str_nomor_trx_spm_gup');

                            // CHECK APAKAH nomer_spm_gup MEMANG BENAR BISA DBUAT SPP

                            $status = $this->rsa_gup_nihil_model->get_status_spm_gup($str_nomor_trx_spm_gup);

                            if($status == '1'){
                                    $this->load->library('user_agent');
                                    $this->session->set_flashdata('message', '<div class="alert alert-danger" style="text-align:center"><span class="glyphicon glyphicon-warning-sign" aria-hidden="true"></span> Tidak bisa, karena SPM GUP-NIHIL yang terkait sudah diproses <u>NIHIL</u>.</div>');
                            ...
                            // END CHECK
                                ...
                                $this->session->set_tempdata('str_nomor_trx_spm_gup', $str_nomor_trx_spm_gup, 300);
                                
                            // redirect(site_url('rsa_gup/spp_gup/' . $data . '/' . $data_pengembalian));
                            redirect(site_url('rsa_gup_nihil/spp_gup_nihil/')) ;
                        }
                ...
                function spp_gup_nihil(){
                    if($this->check_session->user_session() && (($this->check_session->get_level()==13)||($this->check_session->get_level()==100))){
                        ...
                        // var_dump($this->session->tempdata()); die;

                        // CHECK LATEST GUP IS DONE OR NOT //

                        // $posisi = $this->rsa_gup_nihil_model->check_dokumen_gup_latest($this->check_session->get_unit(),$this->cur_tahun) ;

                        // if(($posisi != 'SPM-FINAL-KBUU')&&(!(strpos($posisi, 'DITOLAK') !== false))){ 
                        //     $this->session->set_flashdata('message', '<div class="alert alert-danger" style="text-align:center"><span class="glyphicon glyphicon-warning-sign" aria-hidden="true"></span> Tidak bisa proses NIHIL karena GUP Sebelumnya belum selesai.</div>');
                        //     redirect('kuitansi/daftar_kuitansi/GP');
                        // }
                        ...
                        if($this->session->tempdata('str_nomor_trx_spm_gup')!=null){
                            $str_nomor_trx_spm_gup = $this->session->tempdata('str_nomor_trx_spm_gup');
                        }else{
                            redirect('kuitansi/daftar_kuitansi/GP');
                        }
                        ...
                        $data['main_menu']  = $this->load->view('main_menu','',TRUE);     
                                ...
                                $id_max_nomor = $this->rsa_gup_nihil_model->get_nomor_spp_urut($this->check_session->get_unit(),$this->cur_tahun) ;
...
//                                        'tgl_spp' => $rsa_user->tgl_spp,
                                    ...
                                    $nomor_trx_ = $this->rsa_gup_nihil_model->get_nomor_next_spp($this->check_session->get_unit(),$this->cur_tahun);

                                    setlocale(LC_ALL, 'id_ID.utf8');$bln = strftime("%h");$thn = strftime("%Y");

                                    $nomor_trx = $nomor_trx_.'/'.$this->check_session->get_alias().'/'.'SPP-GUP-NIHIL'.'/'.strtoupper($bln).'/'.$thn;
                                ...
                                // if($pengeluaran > 0){
                                    ...
                                    // $data_akun_pengeluaran = $this->kuitansi_model->get_pengeluaran_by_akun5digit($data__,'TUP');
                                    $data_akun_pengeluaran = $this->kuitansi_model->get_pengeluaran_by_akun4digit($data__);
...
//                                  // echo '<pre>';
                                    ...
                                    // $nomor_spm = $this->rsa_gup_nihil_model->get_spm_by_spp($nomor_trx);
    ...
    //                                    echo '<pre>';print_r($data___lalu);echo '</pre>';die;
                                        ...
                                        // $data_akun_pengeluaran_lalu = $this->kuitansi_model->get_pengeluaran_by_akun5digit_lalu($data___lalu,'TUP');

                                        $data_akun_pengeluaran_lalu = $this->kuitansi_model->get_pengeluaran_by_akun4digit_lalu($data___lalu);
                                    
                                    }
                                        

                                    // $rincian_keluaran = $this->rsa_gup_nihil_model->get_keluaran($nomor_trx);
//                                    echo '<pre>';print_r($rincian_akun_pengeluaran);echo '</pre>';die;
                                ...
                                $subdata['str_nomor_trx_spm_gup'] = $str_nomor_trx_spm_gup ;
            ...
            function spp_gup_nihil_lihat($url = ''){


                    if($this->check_session->user_session() && (($this->check_session->get_level()==11)||($this->check_session->get_level()==2)||($this->check_session->get_level()==3)||($this->check_session->get_level()==13)||($this->check_session->get_level()==14)||($this->check_session->get_level()==100))){
                ...
                //$subdata_rsa_up['result_rsa_up']      = $this->rsa_up_model->search_rsa_up();
                                ...
                                // $dokumen_gup_nihil = $this->rsa_gup_nihil_model->check_dokumen_gup_nihil($this->check_session->get_unit(),$this->cur_tahun);


                                $nomor_trx_spp = $url ;
                                
                                
                                $dokumen = $this->rsa_gup_nihil_model->check_dokumen_gup_nihil_by_str_trx($url);


                                // echo $dokumen_gup_nihil ; die;
                                ...
                                ///////////
                                    ...
                                    $data_spp = $this->rsa_gup_nihil_model->get_data_spp($nomor_trx);
                                    
                                    $du = '' ;
//                                    if($data_url != ''){
                                    $data_kuitansi = $this->kuitansi_model->get_id_detail_by_str_nomor_spp($nomor_trx,'GUP-NIHIL');
                                    $kuitansi_d = array();
...
//                                    }
                                    ...
                                    $data_kuitansi_pengembalian = $this->kuitansipengembalian_model->get_id_detail_by_str_nomor_spp($nomor_trx,'GUP-NIHIL');
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
    ...
    //                                if(($dokumen_gup_nihil == '') || ($dokumen_gup_nihil == 'SPP-DITOLAK') || ($dokumen_gup_nihil == 'SPM-DITOLAK')){
    //                                    $subdata['siap_spp'] = 'ok';
    //                                }else{
    ...
    //                                }
                                ...
                                $daftar_kuitansi_pengembalian = array();
                                    ...
                                    // echo '<pre>';
                                    // // echo 'data_rekap_pajak';
                                    // var_dump($data_rekap_pajak);
                                    // // echo 'data_rekap_bruto';
                                    // // var_dump($data_rekap_bruto);
                                    // die;


                                    // foreach($data_rekap_pajak as $data_pajak => $akun ){
                                    //     echo 'data_pajak : ' . $data_pajak . '<br>' ;
                                    //     echo 'akun : ' . var_dump($akun) . '<br>' ;
                                    // }
...
//                                  // echo '<pre>';
    ...
    //                                    echo '<pre>';print_r($data___lalu);echo '</pre>';die;
                                    ...
                                    $rincian_keluaran = $this->rsa_gup_nihil_model->get_keluaran($nomor_trx_spp);
                                ...
                                // vdebug($daftar_kuitansi_pengembalian);
                                ...
                                // $subdata['ket'] = $this->rsa_gup_nihil_model->lihat_ket($this->check_session->get_unit(),$this->cur_tahun);
                                $subdata['detail_ppk']  = $this->user_model->get_detail_rsa_user($kd_unit,'14');
                                $subdata['ket'] = $this->rsa_gup_nihil_model->lihat_ket_by_str_trx($nomor_trx); //$kd_unit,$tahun);
            ...
            function spm_gup_nihil($url = ''){
                ...
                $data['main_menu']  = $this->load->view('main_menu','',TRUE); 
                                ...
                                $id_nomor = $this->rsa_gup_nihil_model->get_nomor_spp_urut_by_nomor_spp($nomor_trx_spp) ;

                                // echo $id_nomor_gup_nihil; die;
                                ...
                                /////////////
                                    ...
                                    $data_spp = $this->rsa_gup_nihil_model->get_data_spp($nomor_trx_spp);
//                                    var_dump($data_spp);die;
                                    
//                                    if($data_url != ''){
                                    $data_kuitansi = $this->kuitansi_model->get_id_detail_by_str_nomor_spp($nomor_trx_spp,'GUP-NIHIL');
                                    $kuitansi_d = array();
                                    if(!empty($data_kuitansi)){
                                        foreach($data_kuitansi as $dk){
                                            $kuitansi_d[] = $dk->id_kuitansi;
...
//                                    }
                                    ...
                                    $data_kuitansi_pengembalian = $this->kuitansipengembalian_model->get_id_detail_by_str_nomor_spp($nomor_trx_spp,'GUP-NIHIL');
                                    // var_dump($data_kuitansi_pengembalian); die;
                                    $kuitansi_d_pengembalian = array();
                                    if(!empty($data_kuitansi_pengembalian)){
                                        foreach($data_kuitansi_pengembalian as $dk){
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
                                ...
                                $subdata['detail_verifikator']  = $this->rsa_gup_nihil_model->get_verifikator($this->check_session->get_unit());

                                // $subdata['detail_verifikator']  = $this->rsa_gup_nihil_model->get_verifikator_by_spm($nomor_trx_spm);
                                
                                $subdata['tgl_spm_kpa'] = $this->rsa_gup_nihil_model->get_tgl_spm_kpa_by_spp($nomor_trx_spp);
                                
                                $subdata['tgl_spm_verifikator'] = $this->rsa_gup_nihil_model->get_tgl_spm_verifikator_by_spp($nomor_trx_spp);
                                
                                $subdata['tgl_spm_kbuu'] = $this->rsa_gup_nihil_model->get_tgl_spm_kbuu_by_spp($nomor_trx_spp);

                                $subdata['ket'] = $this->rsa_gup_nihil_model->lihat_ket_by_str_trx($nomor_trx_spp);
...
//                                var_dump($subdata);die;
            ...
            function spm_gup_nihil_lanjut($url = ''){
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
                                ...
                                /////////////
                                    ...
                                    $nomor_trx_ = $this->rsa_gup_nihil_model->get_nomor_next_spm($this->check_session->get_unit(),$this->cur_tahun);
                                    setlocale(LC_ALL, 'id_ID.utf8');$bln = strftime("%h");
                                    $nomor_trx_spm = $nomor_trx_.'/'.$this->check_session->get_alias().'/'.'SPM-GUP-NIHIL'.'/'.strtoupper($bln).'/'.$this->cur_tahun;
...
//                                    $data_spp = $this->rsa_up_model->get_data_spp($nomor_trx_spp);
                                    ...
                                    // var_dump($subdata['detail_gup_nihil_spm']);die;
                                    
//                                    $subdata['detail_pic']  = $this->user_model->get_detail_rsa_user($this->check_session->get_unit(),'13');
                                    
                                    $subdata['detail_ppk']  = $this->user_model->get_detail_rsa_user($this->check_session->get_unit(),'14');
                                    $subdata['detail_kpa']  = $this->user_model->get_detail_rsa_user($this->check_session->get_unit(),'2');
                                    $subdata['detail_verifikator']  = $this->rsa_gup_nihil_model->get_verifikator(substr($this->check_session->get_unit(),0,2));
...
//                                var_dump($subdata);die;
            ...
            function spm_gup_nihil_lihat($url){
...
//                                $subdata['tgl_spm'] = $this->rsa_gup_nihil_model->get_tgl_spm($this->check_session->get_unit(),$this->cur_tahun);
                                
                                // $nomor_trx_spp = $this->rsa_gup_nihil_model->get_nomor_spp($this->check_session->get_unit(),$this->cur_tahun); 

                                $nomor_trx_spm = $this->rsa_gup_nihil_model->get_spm_by_spp($nomor_trx_spp);
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
                                ...
                                /////////////
                                    ...
                                    $data_spm = $this->rsa_gup_nihil_model->get_data_spm($nomor_trx_spm);
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
                                ...
                                // echo $this->rsa_gup_nihil_model->get_tgl_spm_kpa_by_spm($nomor_trx_spp); die;
...
//                                var_dump($subdata);die;
                ...
                function spm_gup_nihil_kpa($url = ''){
...
//                                var_dump($subdata);die;
                ...
                function spm_gup_nihil_verifikator($url = ''){
...
//                                $subdata['tgl_spm'] = $this->rsa_gup_nihil_model->get_tgl_spm($this->check_session->get_unit(),$this->cur_tahun);
                                ...
                                // if(($dokumen_gup_nihil == 'SPM-DRAFT-PPK')){
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
    ...
    //                                }
                                ...
                                // if(($dokumen_gup_nihil == 'SPM-DRAFT-PPK')){
                                    ...
                                    // $nomor_trx_spm = $this->rsa_gup_nihil_model->get_nomor_spm($this->check_session->get_unit(),$this->cur_tahun);  
...
//                                var_dump($subdata);die;
                ...
                function spm_gup_nihil_kbuu($url = ''){
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
                                ...
                                $trx_gup_to_nihil = $this->rsa_gup_nihil_model->get_trx_gup_to_nihil_by_spp_gup_nihil($nomor_trx_spp);

                                $kas_undip = $this->kas_undip_model->get_data_kas_by_spm_cair($trx_gup_to_nihil->str_nomor_trx_spm_gup);

                                // vdebug($kas_undip); die;

                                $subdata['kas_undip'] = $kas_undip ;

                                $kas_undip_saldo = $this->kas_undip_model->get_saldo_kas_by_akun($kas_undip->kd_akun_kas);

                                // var_dump($kas_undip_saldo[0]); die;

                                $subdata['kas_undip_saldo'] = $kas_undip_saldo[0]->saldo ;
...
//                                var_dump($subdata);die;
                ...
                function spm_gup_nihil_lihat_99($url,$kd_unit="",$tahun=""){
                ...
                $data['main_menu']  = $this->load->view('main_menu','',TRUE); 
                                ...
                                $dokumen_gup_nihil = $this->rsa_gup_nihil_model->check_dokumen_gup_nihil_by_str_trx($url);
                                ...
                                $subdata['doc_gup_nihil'] = $dokumen_gup_nihil;
...
//                                $subdata['tgl_spm'] = $this->rsa_gup_nihil_model->get_tgl_spm($this->check_session->get_unit(),$this->cur_tahun);
                                ...
                                $id_nomor_gup_nihil = $this->rsa_gup_nihil_model->get_nomor_spp_urut_by_nomor_spp($nomor_trx_spp) ;
...
//                                            $array_id = $this->input->post('rel_kuitansi');
                                    ...
                                    $subdata['detail_gup_nihil']   = array(
                                                                    'nom' => $data_spp->jumlah_bayar,
                                                                    'pengembalian' => $data_spp->jumlah_pengembalian ,
                                                                    'terbilang' => $data_spp->terbilang, 
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
    ...
    //                                }
                                ...
                                // if(($dokumen_gup_nihil == 'SPM-DRAFT-PPK')){
                                    ...
                                    $data_spm = $this->rsa_gup_nihil_model->get_data_spm($nomor_trx_spm);
                                    // var_dump($data_spm);die;
                                    $subdata['detail_gup_nihil_spm']  = array(
                                                                    'nom' => $data_spm->jumlah_bayar,
                                                                    'pengembalian' => $data_spp->jumlah_pengembalian ,
                                                                    'terbilang' => $data_spm->terbilang, 
...
//                                    echo '<pre>';print_r($data___);echo '</pre>';die;
                                    ...
                                    $nomor_spm = $this->rsa_gup_nihil_model->get_spm_by_spp($nomor_trx_spp);
                                    
//                                    echo $nomor_spm_cair_before; die;
                                    
                                    if(empty($nomor_spm)){
                                        
                                        $data_akun_before = $this->kuitansi_model->get_gup_nihil_akun_before_by_unit($kd_unit,$tahun);
                                    
//                                        var_dump($data_akun_before); die;
                                        
                                    }else{
                                        
                                        $nomor_spm_cair_before = $this->rsa_gup_nihil_model->get_nomer_spm_cair_lalu($kd_unit,$tahun);

                                        // echo $nomor_spm_cair_before ; die;
                                        
                                        $data_akun_before = $this->kuitansi_model->get_gup_nihil_akun_before_by_spm($nomor_spm);
...
//                                        var_dump($data_akun_before); die;
    ...
    //                                    if(!empty($data_akun_pengeluaran)){
        ...
        //                                    echo '<pre>';print_r($data___lalu);echo '</pre>';die;
                                ...
                                $subdata['id_nomor_gup_nihil'] = $id_nomor_gup_nihil ;
                ...
                //$subdata['opt_unit_kepeg']        = $this->option->opt_unit_kepeg();
//                                var_dump($subdata);die;
                $data['main_content']           = $this->load->view("rsa_gup_nihil/spm_gup_nihil_lihat",$subdata,TRUE);
                $this->load->view('main_template',$data);
            } 
            else{
                redirect('welcome','refresh');  // redirect ke halaman home
...
//                             $subdata['unit_usul']       = $this->rsa_gup_nihil_model->get_gup_nihil_unit_usul_verifikator($user->id,$tahun);
//                             $subdata['subunit_usul']        = $this->rsa_gup_nihil_model->get_gup_nihil_subunit_usul_verifikator($user->id,$tahun);
...
//                             $data['main_content']       = $this->load->view("rsa_gup_nihil/daftar_unit",$subdata,TRUE);
//                             /*  Load main template  */
...
//                            $subdata['opt_sumber_dana']   = $this->option->sumber_dana();
                ...
                function daftar_unit_kbuu($tahun=''){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==11))){
                            $data['main_menu']              = $this->load->view('main_menu','',TRUE);
                            $subdata['unit_usul']       = $this->rsa_gup_nihil_model->get_gup_nihil_unit_usul($tahun);
                            // echo '<pre>';var_dump($subdata['unit_usul']);echo '</pre>';die;
                            $subdata['subunit_usul']        = $this->rsa_gup_nihil_model->get_gup_nihil_subunit_usul($tahun);
                            $subdata['cur_tahun'] =  $tahun;
                            $subdata['jenis'] =  'gup_nihil';
//                            $subdata['opt_sumber_dana']   = $this->option->sumber_dana();
...
//                        echo $html;die;
                ...
                function usulkan_spp_gup_nihil(){
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==13))){
                        if($this->input->post('proses')){
                            ...
                            $id_nomor_gup_nihil = $this->input->post('id_nomor_gup_nihil') ;
...
//                            echo $c_keluaran . '  ' . $c_subkomponen ; die;
                            ...
                            if((($c_subkomponen > 0) && ($c_subkomponen == $c_keluaran) && ($jml_kuitansi > 0))||($jml_kuitansi_pengembalian >0)){
                                ...
                                $dokumen_gup_nihil = $this->rsa_gup_nihil_model->check_dokumen_gup_nihil_by_str_trx($nomor_trx);

                                $check_exist_gup_nihil = $this->rsa_gup_nihil_model->check_exist_gup_nihil($nomor_trx,$this->cur_tahun);

                                if((!$check_exist_gup_nihil)&&($dokumen_gup_nihil == '')){

                                // if(true){

                                // if($dokumen_gup_nihil == ''){
                                    ...
                                    if($this->rsa_gup_nihil_model->proses_nomor_spp_gup_nihil($kd_unit,$data)){
                                        ...
                                        $data_spp = array(
                                            'kode_unit_subunit' => $kd_unit,
                                            'nomor_trx_spp' => $this->rsa_gup_nihil_model->get_id_nomor_gup_nihil_by_nomor_trx($nomor_trx),
                                            'str_nomor_trx' => $nomor_trx,
                                        ...
                                        $data = array(
                                            'kode_unit_subunit' => $kd_unit,
                                            'posisi' => $proses,
                                            'id_trx_nomor_gup_nihil' => $this->rsa_gup_nihil_model->get_id_nomor_gup_nihil_by_nomor_trx($nomor_trx),
                                            'ket' => $ket,
                                            'aktif' => '1',
                                            'tahun' => $tahun,
                                            'tgl_proses' => $tgl_proses,
                                       ...
                                       // var_dump($data_spp);die;
                                        ...
                                        if($this->rsa_gup_nihil_model->proses_gup_nihil($kd_unit,$data,$id_nomor_gup_nihil) && $this->rsa_gup_nihil_model->proses_data_spp($data_spp)){
                                            $keluaran = json_decode($this->input->post('keluaran'));
                                            $data = array();
                                            foreach($keluaran as $kel){
                                                if(!empty($kel)){
                                            ...
                                            $this->rsa_gup_nihil_model->insert_keluaran($data);
                                            ...
                                            $this->rsa_gup_nihil_model->proses_gup_nihil_spp_rka($data);

                                            // INSERT TO TRX_KS_TO_NIHIL //

                                            $ks_to_nihil = array(
                                                    'kode_unit_subunit' => $kd_unit,
                                                    'str_nomor_trx_spm_gup' => $this->input->post('str_nomor_trx_spm_gup'),
                                                    'str_nomor_trx_spp_gup_nihil' => $nomor_trx,
                                                    'tgl_proses_gup' => $tgl_proses,
                                                    'tahun' => $this->cur_tahun,
                                                    'aktif' => '1',
                                                );

                                            $this->rsa_gup_nihil_model->insert_gup_to_nihil($ks_to_nihil);

                                            $this->session->set_flashdata('message', '<div class="alert alert-success" style="text-align:center"><span class="glyphicon glyphicon glyphicon-ok" aria-hidden="true"></span> SPP/SPM GUP-NIHIL anda berhasil disubmit.</div>');

                                            $this->session->unset_tempdata('array_id');
                                            $this->session->unset_tempdata('array_id_pengembalian');
                                            $this->session->unset_tempdata('str_nomor_trx_spm_gup');
                ...
                function usulkan_spm_gup_nihil(){
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==14))){
                        if($this->input->post('proses')){
                            ...
                            $dokumen_gup_nihil = $this->rsa_gup_nihil_model->check_dokumen_gup_nihil_by_str_trx($nomor_trx_spp);

                            $check_exist_gup_nihil = $this->rsa_gup_nihil_model->check_exist_gup_nihil($nomor_trx,$this->cur_tahun);

                             
                            if((!$check_exist_gup_nihil)&&($dokumen_gup_nihil == 'SPP-FINAL')){
                                ...
                                if($this->rsa_gup_nihil_model->proses_nomor_spm_gup_nihil($kd_unit,$data) ){

                                    $id_trx_nomor_gup_nihil = $this->rsa_gup_nihil_model->get_id_nomor_gup_nihil_by_nomor_trx($nomor_trx_spp) ;
                                    $id_trx_nomor_gup_nihil_spm = $this->rsa_gup_nihil_model->get_id_nomor_gup_nihil_by_nomor_trx($nomor_trx) ;
                                    ...
                                    $data_spm = array(
                                        'kode_unit_subunit' => $kd_unit,
                                        'nomor_trx_spm' => $id_trx_nomor_gup_nihil_spm,
                                        'str_nomor_trx' => $nomor_trx,
                                        ...
                                        'tgl_spm' => $tgl_proses,//$tgl_spm_dibuat,//date("Y-m-d H:i:s"),
                                        'data_kuitansi' => $rel_kuitansi,
                                        'jumlah_pengembalian' => $this->input->post('jumlah_pengembalian'),
                                        'data_kuitansi_pengembalian' => $rel_kuitansi_pengembalian,
                                    );
//                                    var_dump($data_spm);die;
                                    $data_spp_spm = array(
                                        'kode_unit_subunit' => $kd_unit,
                                        'nomor_trx_spp' => $id_trx_nomor_gup_nihil,//$nomor_spp_[0],$this->rsa_up_model->get_id_nomor_up($jenis,$kd_unit,$this->cur_tahun),
                                        'str_nomor_trx_spp' => $nomor_trx_spp,
                                        'nomor_trx_spm' => $id_trx_nomor_gup_nihil_spm,//$nomor_[0],
                                    ...
                                    $data = array(
                                        'kode_unit_subunit' => $kd_unit,
                                        'posisi' => $proses,
                                        'id_trx_nomor_gup_nihil' => $id_trx_nomor_gup_nihil,
                                        'id_trx_nomor_gup_nihil_spm' => $id_trx_nomor_gup_nihil_spm,
                                        'ket' => $ket,
                                        'aktif' => '1',
                                        'tahun' => $tahun,
                                        'tgl_proses' => $tgl_proses,
                                    ...
                                    if($this->rsa_gup_nihil_model->proses_gup_nihil($kd_unit,$data,$id_trx_nomor_gup_nihil)&& $this->rsa_gup_nihil_model->proses_trx_spp_spm($data_spp_spm) && $this->rsa_gup_nihil_model->proses_data_spm($data_spm)){
                                        ...
                                        $this->rsa_gup_nihil_model->proses_gup_nihil_spm_rka($data);
                                        $this->session->set_flashdata('message', '<div class="alert alert-success" style="text-align:center"><span class="glyphicon glyphicon glyphicon-ok" aria-hidden="true"></span> SPP/SPM GUP-NIHIL anda berhasil disubmit.</div>');
                                        echo "sukses";
                                    }else{
                                        echo "gagal";
                ...
                function proses_spp_gup_nihil(){
                    if($this->input->post('proses')){
                        ...
                        // $dokumen_gup_nihil = $this->rsa_gup_nihil_model->check_dokumen_gup_nihil($kd_unit,$tahun);

                        $dokumen = $this->rsa_gup_nihil_model->check_dokumen_gup_nihil_by_str_trx($nomor_trx);
                        ...
                        if($ok){
//                            echo 'jos'; die;
                            // echo $kd_unit . ' - ' . $id_nomor_gup_nihil ;
                            // echo '<pre>';
                            // var_dump($data);
                            // die;
                            ...
                            $data = array(
                                ...
                                'aktif' => '1',
                                'tahun' => $tahun,
                                'tgl_proses' => $tgl_proses, // date("Y-m-d H:i:s")
                            );

                            if($this->rsa_gup_nihil_model->proses_gup_nihil($kd_unit,$data,$id_nomor_gup_nihil)){
                                ...
                                if($proses == 'SPP-DITOLAK'){ // APABILA PPK SUKPA MENOLAK SPP
                                    ...
                                    $this->rsa_gup_nihil_model->tolak_gup_nihil_spp_rka($data);
                                    $data = array(
                                        'rel_kuitansi' => $rel_kuitansi,
//                                        'str_nomor_trx' => $nomor_trx,
                                    );
...
//                                        'str_nomor_trx' => $nomor_trx,
                                    ...
                                    $this->rsa_gup_nihil_model->nonaktifkan_status_spp_gup($nomor_trx);
                                }
                                $this->session->set_flashdata('message', '<div class="alert alert-success" style="text-align:center"><span class="glyphicon glyphicon glyphicon-ok" aria-hidden="true"></span> SPP/SPM GUP-NIHIL anda berhasil disubmit.</div>');
                ...
                function proses_spm_gup_nihil(){
                    if($this->input->post('proses')){
                        ...
                        // echo $this->rsa_gup_nihil_model->get_id_nomor_gup_nihil_by_nomor_trx($nomor_trx); die;
                            ...
                            $dokumen_gup_nihil = $this->rsa_gup_nihil_model->check_dokumen_gup_nihil($kd_unit,$tahun,$id_nomor_gup_nihil);

                            // echo 'a : ' .$dokumen_gup_nihil; die;

                            if(($proses == 'SPM-DRAFT-KPA')&&($dokumen_gup_nihil == 'SPM-DRAFT-PPK')){
                                $ok = TRUE ;
                            }elseif(($proses == 'SPM-DITOLAK-KPA')&&($dokumen_gup_nihil == 'SPM-DRAFT-PPK')){
                                $ok = TRUE ;
                            }elseif(($proses == 'SPM-FINAL-VERIFIKATOR')&&($dokumen_gup_nihil == 'SPM-DRAFT-KPA')){
                                $ok = TRUE ;
                            }elseif(($proses == 'SPM-DITOLAK-VERIFIKATOR')&&($dokumen_gup_nihil == 'SPM-DRAFT-KPA')){
                                $ok = TRUE ;
                            }elseif(($proses == 'SPM-FINAL-KBUU')&&($dokumen_gup_nihil == 'SPM-FINAL-VERIFIKATOR')){
                                $ok = TRUE ;
                            }elseif(($proses == 'SPM-DITOLAK-KBUU')&&($dokumen_gup_nihil == 'SPM-FINAL-VERIFIKATOR')){
                                $ok = TRUE ;
                            }elseif(($proses == 'SPM-FINAL-BUU')&&($dokumen_gup_nihil == 'SPM-FINAL-KBUU')){
                                $ok = TRUE ;
                            }elseif(($proses == 'SPM-DITOLAK-BUU')&&($dokumen_gup_nihil == 'SPM-FINAL-KBUU')){
                                $ok = TRUE ;
                            }else{
                                $ok = FALSE;
                            }
                            ...
                            if($ok){
                           // echo 'jos';die;
                            $nomor_trx_spm = $this->rsa_gup_nihil_model->get_id_nomor_gup_nihil_by_nomor_trx($nomor_trx) ;
                            ...
                            $data = array(
                                    'kode_unit_subunit' => $kd_unit,
                                    'posisi' => $proses,
                                    'id_trx_nomor_gup_nihil' => $id_nomor_gup_nihil,
                                    'id_trx_nomor_gup_nihil_spm' => $this->rsa_gup_nihil_model->get_id_nomor_gup_nihil_by_nomor_trx($nomor_trx),
                                    'ket' => $ket,
                                    'aktif' => '1',
                                    'tahun' => $tahun,
...
//                                    var_dump(base64_decode(urldecode($rel_kuitansi)));die;
                                    $this->rsa_gup_nihil_model->tolak_gup_nihil_spm_rka($data);
...
//                                        'str_nomor_trx' => $nomor_trx,
                                    ...
                                    $str_nomor_trx_spp = $this->rsa_gup_nihil_model->get_spp_by_spm($nomor_trx);

                                    $this->rsa_gup_nihil_model->nonaktifkan_status_spp_gup($str_nomor_trx_spp);
                                ...
                                if($this->check_session->get_level() == 3){
                                    ...
                                    if($this->rsa_gup_nihil_model->proses_verifikator_gup_nihil($data_verifikator)){
                                        $this->session->set_flashdata('message', '<div class="alert alert-success" style="text-align:center"><span class="glyphicon glyphicon glyphicon-ok" aria-hidden="true"></span> SPP/SPM GUP-NIHIL anda berhasil disubmit.</div>');
                                        echo "sukses";
                                    }else{
                                        echo "gagal";
                ...
                //     $data_gup_nihil_to_nihil = array(
                //                     'kode_unit_subunit' => '71',
                //                     'str_nomor_trx_spm_gup_nihil' => '00003/LPM/SPM-GUP-NIHIL/JUN/2017',
                //                     'tgl_proses_gup_nihil' => '2017-07-10 14:22:47',
                //                     'tahun' => '2017',
                //                     'status' => '1',
                //                 );

                //     // var_dump($data_gup_nihil_to_nihil) ; die ;

                //     var_dump($this->rsa_gup_nihil_model->tup_to_nihil($data_gup_nihil_to_nihil)) ; die ;
                // }
                
                function proses_final_gup_nihil(){
                    if($this->input->post('proses')){
                        $proses = $this->input->post('proses');
                        ...
                        $nomor_trx_spm_cair = $this->input->post('nomor_trx_spm_cair');
                        ...
                        // $id_trx_nomor_gup_nihil = $this->rsa_gup_nihil_model->get_id_nomor_gup_nihil_by_nomor_trx($nomor_trx_spp) ;
                        $id_trx_nomor_gup_nihil = $this->input->post('id_nomor_gup_nihil') ;
                        $id_trx_nomor_gup_nihil_spm = $this->rsa_gup_nihil_model->get_id_nomor_gup_nihil_by_nomor_trx($nomor_trx_spm) ;

                        $nomor_trx_spp = $this->rsa_gup_nihil_model->get_spp_by_spm($nomor_trx_spm);
                        ...
                        if(($proses == 'SPM-FINAL-KBUU')&&($dokumen_gup_nihil == 'SPM-FINAL-VERIFIKATOR')){
                            $ok = TRUE ;
                        }else{
                            $ok = FALSE;
                        }
                        ...
                        if($ok){
                            ...
                            if($this->rsa_gup_nihil_model->proses_gup_nihil($kd_unit,$data,$id_trx_nomor_gup_nihil)){
                                ...
                                $kd_akun_gup = $this->kas_bendahara_model->get_kas_bendahara_kd_akun_by_spm($nomor_trx_spm_cair);
                                $saldo_ben = $this->kas_bendahara_model->get_kas_bendahara_by_spm($nomor_trx_spm_cair);

                                $kredit = $this->input->post('kredit');
                                $debet = 0 ; // $kredit ;
                                $sisa = 0 ; // $saldo_ben - $kredit ;
                                $saldo = 0 ; // $sisa + $debet ;
                                $pengembalian = $this->input->post('jumlah_pengembalian');
                                // echo 'k : ' . $kredit . '<br>' ;
                                // echo 'd : ' . $debet . '<br>' ;
                                // echo 's : ' . $sisa . '<br>' ; 
                                // echo 'sal : ' . $saldo . '<br>' ;die;

                                $data = array(
                                    'tgl_trx' => $tgl_proses,
                                    'kd_akun_kas' => $kd_akun_gup,
                                    'kd_unit' => $kd_unit,
                                    'deskripsi' => $this->input->post('deskripsi'),//'KREDIT TUP UNIT ' . $kd_unit,//$this->input->post('deskripsi'),
                                    'jenis' => 'UP',
                                    'no_spm' => $nomor_trx_spm_cair, // $this->input->post('nomor_trx'),
                                    'no_spm_pengembalian' => $this->input->post('nomor_trx'),
                                    'kredit' => $kredit,
                                    'debet' => $debet,
                                    'pengembalian' => $pengembalian,
                                    'saldo' => $saldo, // $saldo_ben->saldo - $this->input->post('kredit'), // DI '0' KAN KARENA AKAN DIKEMBALIKAN
                                    'aktif' => '1',
                                    'tahun' => $this->input->post('tahun'),
                                );
                                
                                // $this->load->model('kas_bendahara_model');
                                // $saldo_ben = $this->kas_bendahara_model->get_kas_bendahara_gup_nihil($kd_unit,$this->input->post('tahun'));
                                ...
                                $data_kas = array(
                                    ...
                                    'kd_unit' => $kd_unit,//'99',
                                    'deskripsi' => $this->input->post('deskripsi'),//'PEMBAYARAN GUP-NIHIL UNIT ' . $kd_unit,
                                ...
                                $data_spm_cair = array(
                                    'no_urut' => $this->rsa_gup_nihil_model->get_next_urut_spm_cair($this->input->post('tahun')),
//                                    'nomor_trx_spm' => $this->rsa_up_model->get_id_nomor_up('SPM',$kd_unit,$this->input->post('tahun')),//,$nomor,
    ...
    //                            var_dump($data_spm_cair);die;
                                ...
                                // $data_gup_nihil_to_nihil = array(
                                //     'kode_unit_subunit' => $kd_unit,
                                //     'str_nomor_trx_spm_gup_nihil' => $nomor_trx_spm,
                                //     'tgl_proses_gup_nihil' => date('Y-m-d H:i:s'),
                                //     'tahun' => $this->input->post('tahun'),
                                //     'status' => '0',
                                // );

                                if($this->rsa_gup_nihil_model->final_gup_nihil($kd_unit,$data) && $this->kas_undip_model->isi_trx($data_kas) && $this->rsa_gup_nihil_model->spm_cair($data_spm_cair)){
                                    ...
                                    // $this->rsa_gup_nihil_model->final_gup_nihil($kd_unit,$data_debet);
                                    ...
                                    $this->rsa_gup_nihil_model->proses_gup_nihil_cair_rka($data);

                                    $data_gup_nihil = array(
                                            'str_nomor_trx_spp_gup_nihil' => $nomor_trx_spp,
                                            'str_nomor_trx_spm_gup_nihil' => $nomor_trx_spm,
                                            'tgl_proses_gup_nihil' => $tgl_proses,
                                        );

                                    $this->rsa_gup_nihil_model->proses_gup_to_nihil($data_gup_nihil);
    ...
    //          echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                ...
                function daftar_spp($tahun="",$kode_unit_subunit=""){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==13))){
                            $data['main_menu']              = $this->load->view('main_menu','',TRUE);
                            $subdata['cur_tahun']           = $tahun;
                            $subdata['daftar_spp']          = $this->rsa_gup_nihil_model->get_daftar_spp($kode_unit_subunit,$tahun);
    ...
    //          echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                ...
                function daftar_spm($tahun="",$kode_unit_subunit=""){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==14)||($this->check_session->get_level()==2))){
                            $data['main_menu']              = $this->load->view('main_menu','',TRUE);
                            $subdata['cur_tahun']           = $tahun;
                            // $subdata['daftar_spm']          = $this->rsa_gup_nihil_model->get_daftar_spm($kode_unit_subunit,$tahun);
                            $subdata['daftar_spp']          = $this->rsa_gup_nihil_model->get_daftar_spp($kode_unit_subunit,$tahun);
                            $subdata['jenis']           = 'gup_nihil';
                           // echo '<pre>';var_dump($subdata['daftar_spp']);echo '</pre>';die;
    ...
    //          echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                ...
                function daftar_spm_kbuu($tahun="",$kode_unit_subunit=""){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==11))){
                            ...
                            // $subdata['daftar_spm']          = $this->rsa_gup_nihil_model->get_daftar_spm($kode_unit_subunit,$tahun);
                            $subdata['daftar_spm']          = $this->rsa_gup_nihil_model->get_daftar_spp($kode_unit_subunit,$tahun);
//                            echo '<pre>';var_dump($subdata['daftar_spp']);echo '</pre>';die;
    ...
    //          echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                ...
                function get_notif_approve(){
                    ...
                    if($this->check_session->user_session()){
                        ...
                        $notif = $this->rsa_gup_nihil_model->get_notif_approve($kode_unit_subunit,$level,$user->id);
                ...
                function get_notif_approve_all(){
                    ...
                    if($this->check_session->user_session()){
                        ...
                        $notif_gup_nihil = $this->rsa_gup_nihil_model->get_notif_approve($kode_unit_subunit,$level,$user->id);

                        echo $notif_gup_nihil ;
                    }
                ...
                function get_data_untuk_pekerjaan(){
                    ...
                    $kode_unit_subunit = $this->check_session->get_unit();
                    $data = $this->rsa_gup_nihil_model->get_data_untuk_pekerjaan($d['untuk_bayar'],$kode_unit_subunit,$this->cur_tahun);
                    $json = [];
                ...
                function get_data_penerima(){
                    $q = $this->input->get('query');
                    $kode_unit_subunit = $this->check_session->get_unit();
                    $data = $this->rsa_gup_nihil_model->get_data_penerima($q,$kode_unit_subunit,$this->cur_tahun);
                    $json = [];
                ...
                function get_data_json(){
                    ...
                    $d = array('penerima'=>$q);
                    $kode_unit_subunit = $this->check_session->get_unit();
                    $data = $this->rsa_gup_nihil_model->get_data_json($d,$kode_unit_subunit,$this->cur_tahun);
                    $json = [];
                ...
                function check_gup_nihil_done(){
                    if($this->input->post()){
                        $no_spm = $this->input->post('no_spm');

                        if($this->rsa_gup_nihil_model->check_gup_nihil_done($no_spm) == '1'){ // IF 1 = BARU BISA TRX NIHIL
                            echo 'ok' ;
                        }else{
                            echo 'no' ;
                        }
