...
/* -------------- Constructor ------------- */
    ...
    public function __construct(){ 
        parent::__construct();
            ...
            $this->load->model(array('rsa_lsnk_model','akun_model','setting_up_model','kuitansi_model','kuitansipengembalian_model'));
                ...
                function create_spp_lsnk(){
                    if($this->check_session->user_session() && (($this->check_session->get_level()==13)||($this->check_session->get_level()==100))){
                        if($this->input->post('rel_kuitansi')){
                            ...
                            redirect(site_url('rsa_lsnk/spp_lsnk/')) ;
                        }
                ...
                function spp_lsnk(){
                    if($this->check_session->user_session() && (($this->check_session->get_level()==13)||($this->check_session->get_level()==100))){
                        ...
                        if($this->session->tempdata('array_id')!=null){
                            ...
                            redirect('kuitansi/daftar_kuitansi/LN');
                        }
                        ...
                        $data['main_menu']  = $this->load->view('main_menu','',TRUE);     
                                ...
                                $id_max_nomor = $this->rsa_lsnk_model->get_nomor_spp_urut($this->check_session->get_unit(),$this->cur_tahun) ;
...
//                                        'tgl_spp' => $rsa_user->tgl_spp,
                                    ...
                                    $nomor_trx = $nomor_trx_.'/'.$this->check_session->get_alias().'/'.'SPP-LSNK'.'/'.strtoupper($bln).'/'.$thn;
                                ...
                                // if($pengeluaran > 0){
                                    ...
                                    $data_akun_pengeluaran = $this->kuitansi_model->get_pengeluaran_by_akun4digit($data__,'LN');
...
//                                  // echo '<pre>';
    ...
    //                                    echo '<pre>';print_r($data___lalu);echo '</pre>';die;
                                        ...
                                        $data_akun_pengeluaran_lalu = $this->kuitansi_model->get_pengeluaran_by_akun4digit_lalu($data___lalu,'LN');
...
//                                    echo '<pre>';print_r($rincian_akun_pengeluaran);echo '</pre>';die;
            ...
            function spp_lsnk_lihat($url = ''){
                ...
                //$subdata_rsa_up['result_rsa_up']      = $this->rsa_up_model->search_rsa_up();
                                ...
                                $dokumen = $this->rsa_lsnk_model->check_dokumen_lsnk_by_str_trx($url);
    ...
    //                                    echo '<pre>';print_r($data___lalu);echo '</pre>';die;
            ...
            function spm_lsnk($url = ''){
                ...
                $data['main_menu']  = $this->load->view('main_menu','',TRUE); 
                                ...
                                $id_nomor = $this->rsa_lsnk_model->get_nomor_spp_urut_by_nomor_spp($nomor_trx_spp) ;
...
//                            echo $c_keluaran . '  ' . $c_subkomponen ; die;
    ...
    //                            die;
                               // var_dump($data);die;
                                ...
                                if((!$check_exist_lsnk)&&($dokumen_lsnk == '')){
...
//                                    var_dump($data_spm);die;
                ...
                function proses_spp_lsnk(){
                    if($this->input->post('proses')){
                        ...
                        $dokumen = $this->rsa_lsnk_model->check_dokumen_lsnk_by_str_trx($nomor_trx);
