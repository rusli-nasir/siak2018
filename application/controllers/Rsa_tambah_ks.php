...
//                                    var_dump($subdata['detail_pic']);die;
    ...
    //                                }
                                    ...
                                    $nomor_trx = $nomor_trx_.'/'.$this->check_session->get_alias().'/'.'SPP-TUP'.'/'.strtoupper($bln).'/'.$this->cur_tahun;
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
                                    ...
                                    setlocale(LC_ALL, 'id_ID.utf8');$bln = strftime("%h");
                                    $nomor_trx_spm = $nomor_trx_.'/'.$this->check_session->get_alias().'/'.'SPM-TUP'.'/'.strtoupper($bln).'/'.$this->cur_tahun;
    ...
    //                            echo 'jos';die;
                                ...
                                if($this->rsa_tambah_ks_model->proses_nomor_spp_tambah_ks($kd_unit,$data) ){
                                   ...
                                   // var_dump($data);die;
                                    ...
                                    if($this->rsa_tambah_ks_model->proses_tambah_ks($kd_unit,$data)&& $this->rsa_tambah_ks_model->proses_data_spp($data_spp)){
                                        $this->session->set_flashdata('message', '<div class="alert alert-success" style="text-align:center"><span class="glyphicon glyphicon glyphicon-ok" aria-hidden="true"></span> SPP/SPM TUP anda berhasil disubmit.</div>');
                                        echo "sukses";
                                    }else{
                                        echo "gagal";
                                    }
...
//                                'urut' => $this->rsa_tambah_ks_model->get_urut($kd_unit,$jenis,$tahun)
    ...
    //                        var_dump($data_spm);die;
        ...
        //                            var_dump($data);die;
                                    ...
                                    if($this->rsa_tambah_ks_model->proses_tambah_ks($kd_unit,$data) && $this->rsa_tambah_ks_model->proses_trx_spp_spm($data_spp_spm) && $this->rsa_tambah_ks_model->proses_data_spm($data_spm)){
                                        $this->session->set_flashdata('message', '<div class="alert alert-success" style="text-align:center"><span class="glyphicon glyphicon glyphicon-ok" aria-hidden="true"></span> SPP/SPM TUP anda berhasil disubmit.</div>');
                                        echo "sukses";
                                    }else{
                                        echo "gagal";
...
//                            echo '<pre>';var_dump($subdata['daftar_spp']);echo '</pre>';die;
                            ...
                            $subdata['urut_spp']            = $this->rsa_tambah_ks_model->get_nomor_spp_urut();
