...
/* -------------- Constructor ------------- */
    ...
    public function __construct(){ 
        parent::__construct();
            ...
            $this->load->model(array('rsa_lsk_model','akun_model','setting_up_model','kuitansi_model','kuitansipengembalian_model'));
                ...
                function create_spp_lsk(){
                    if($this->check_session->user_session() && (($this->check_session->get_level()==13)||($this->check_session->get_level()==100))){
                        if($this->input->post('rel_kuitansi')){
                            ...
                            redirect(site_url('rsa_lsk/spp_lsk/')) ;
                        }
                ...
                function spp_lsk(){
                    if($this->check_session->user_session() && (($this->check_session->get_level()==13)||($this->check_session->get_level()==100))){
                        ...
                        if($this->session->tempdata('array_id')!=null){
                            ...
                            redirect('kuitansi/daftar_kuitansi/LK');
                        }
                        ...
                        $data['main_menu']  = $this->load->view('main_menu','',TRUE);     
                                ...
                                $id_max_nomor = $this->rsa_lsk_model->get_nomor_spp_urut($this->check_session->get_unit(),$this->cur_tahun) ;
...
//                                        'tgl_spp' => $rsa_user->tgl_spp,
                                    ...
                                    $nomor_trx = $nomor_trx_.'/'.$this->check_session->get_alias().'/'.'SPP-LSK'.'/'.strtoupper($bln).'/'.$thn;
                                ...
                                // if($pengeluaran > 0){
                                    ...
                                    $data_akun_pengeluaran = $this->kuitansi_model->get_pengeluaran_by_akun4digit($data__,'LK');
...
//                                    echo '<pre>';print_r($rincian_akun_pengeluaran);echo '</pre>';die;
            ...
            function spp_lsk_lihat($url = ''){
                ...
                //$subdata_rsa_up['result_rsa_up']      = $this->rsa_up_model->search_rsa_up();
                                ...
                                $dokumen = $this->rsa_lsk_model->check_dokumen_lsk_by_str_trx($url);
    ...
    //                                    echo '<pre>';print_r($data___lalu);echo '</pre>';die;
            ...
            function spm_lsk($url = ''){
                ...
                $data['main_menu']  = $this->load->view('main_menu','',TRUE); 
                                ...
                                $id_nomor = $this->rsa_lsk_model->get_nomor_spp_urut_by_nomor_spp($nomor_trx_spp) ;
...
//                            echo $c_keluaran . '  ' . $c_subkomponen ; die;
                            ...
                            if((($c_subkomponen > 0) && ($c_subkomponen == $c_keluaran) && ($jml_kuitansi > 0))||($jml_kuitansi_pengembalian >0)){
                                ...
                                if((!$check_exist_lsk)&&($dokumen_lsk == '')){
                                ...
                                // if($dokumen_lsk == ''){
                                    ...
                                    if($this->rsa_lsk_model->proses_nomor_spp_lsk($kd_unit,$data)){
                                        ...
                                        $data_spp = array(
                                            ...
                                            'tgl_spp' => $tgl_proses, //date("Y-m-d H:i:s"),
                                       ...
                                       // var_dump($data_spp);die;
                                        ...
                                        if($this->rsa_lsk_model->proses_lsk($kd_unit,$data,$id_nomor_lsk) && $this->rsa_lsk_model->proses_data_spp($data_spp)){
                                            ...
                                            $this->session->set_flashdata('message', '<div class="alert alert-success" style="text-align:center"><span class="glyphicon glyphicon glyphicon-ok" aria-hidden="true"></span> SPP/SPM LSNK anda berhasil disubmit.</div>');
...
//                                    var_dump($data_spm);die;
                ...
                function proses_spp_lsk(){
                    if($this->input->post('proses')){
                        ...
                        $dokumen = $this->rsa_lsk_model->check_dokumen_lsk_by_str_trx($nomor_trx);
                ...
                function proses_final_lsk(){
                    if($this->input->post('proses')){
                        ...
                        $data = array(
                                    ...
                                    'aktif' => '1',
                                    'tahun' => $this->input->post('tahun'),
                                    'tgl_proses' => $tgl_proses,//$this->input->post('tgl_proses'),//date("Y-m-d H:i:s")
                                );
...
//                            echo $saldo_ben->saldo;die;
                            ...
                            if($this->rsa_lsk_model->proses_lsk($kd_unit,$data,$id_trx_nomor_lsk)){
                                ...
                                $data_kas = array(
                                    ...
                                    'kd_unit' => $kd_unit,//'99',
                                    'deskripsi' => $this->input->post('deskripsi'),//'PEMBAYARAN LSNK UNIT ' . $kd_unit,
                                    'no_spm' => $this->input->post('nomor_trx'),
                                    'debet' => '0',
                                    'kredit' => $nominal,
                                    'saldo' => $saldo,
...
//                            echo '<pre>';var_dump($subdata['daftar_spp']);echo '</pre>';die;
    ...
    //          echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                ...
                function get_data_kontrak_full(){
                 ...
                 function tampil_data_kontrak($tahun=""){
                    ...
                    if($tahun == ''){
                        $tahun = $this->cur_tahun ;
                            ...
                            $subdata['cur_tahun']           = $tahun;
                            $subdata['jenis']           = 'lsk';
                            $subdata['daftar_kontrak']          = $res;
                            $data['main_content']           = $this->load->view("rsa_lsk/daftar_kontrak",$subdata,TRUE);
                            // vdebug(  $subdata['daftar_kontrak']);
                            $this->load->view('main_template',$data);

                }

                function modal_data_kontrak(){
                    ...
                    $res = json_decode($result,true);
                            $subdata['daftar_kontrak']          = $res;
                            // vdebug($res);
                             $this->load->view("rsa_lsk/modal_kontrak",$subdata);
