<?php
	...
	class rsa_tambah_tup extends CI_Controller{
/* -------------- Constructor ------------- */
	...
	public function __construct(){ 
		parent::__construct();
			...
			$this->load->model(array('rsa_tambah_tup_model','akun_model','kas_undip_model','kas_bendahara_model'));//,'setting_tambah_tup_model'));
...
//                        $data['message']	= validation_errors();
		...
		function daftar_rsa_tambah_tup(){
			if($this->check_session->user_session() && $this->check_session->get_level()==2){
				...
				$data['main_menu']	= $this->load->view('main_menu','',TRUE);		
				$subdata_rsa_tambah_tup['result_rsa_tambah_tup'] 		= $this->rsa_tambah_tup_model->search_rsa_tambah_tup();
				$subdata['opt_unit_kepeg']		= $this->option->opt_unit_kepeg();
				$subdata['row_rsa_tambah_tup'] 			= $this->load->view("rsa_permintaan/row_rsa_tambah_tup",$subdata_rsa_tambah_tup,TRUE);
				$data['main_content'] 			= $this->load->view("rsa_permintaan/daftar_rsa_tambah_tup",$subdata,TRUE);
				$this->load->view('main_template',$data);
			}
			else{
                ...
                $id_max_nomor = $this->rsa_tambah_tup_model->get_nomor_spp_urut($this->check_session->get_unit(),$this->cur_tahun) ;

                $id_max_nomor = $id_max_nomor + 1 ;

                // echo  $id_max_nomor_tambah_tup; die;
                                
                                $dokumen = '';//$this->rsa_tambah_tup_model->check_dokumen_tambah_tup($this->check_session->get_unit(),$this->cur_tahun,$id_max_nomor_tambah_tup);
                               
                               // echo $dokumen_tambah_tup ; die ;
...
//                                        'tgl_spp' => $rsa_user->tgl_spp,
                                    ...
                                    $subdata['tgl_spp'] = $this->rsa_tambah_tup_model->get_tgl_spp($this->check_session->get_unit(),$this->cur_tahun);

                                    $nomor_trx_ = $this->rsa_tambah_tup_model->get_nomor_next_spp($this->check_session->get_unit(),$this->cur_tahun);
                                    setlocale(LC_ALL, 'id_ID.utf8');$bln = strftime("%h");$thn = strftime("%Y");  
                                    $nomor_trx = $nomor_trx_.'/'.$this->check_session->get_alias().'/'.'SPP-TUP'.'/'.strtoupper($bln).'/'.$thn;
                ...
                $id_max_nomor_tambah_tup = $this->rsa_tambah_tup_model->get_nomor_spp_urut($this->check_session->get_unit(),$this->cur_tahun) ;

                $id_max_nomor_tambah_tup = $id_max_nomor_tambah_tup + 1 ;

                // echo  $id_max_nomor_tambah_tup; die;
                                
                                $dokumen_tambah_tup = $this->rsa_tambah_tup_model->check_dokumen_tambah_tup($this->check_session->get_unit(),$this->cur_tahun,$id_max_nomor_tambah_tup);
                               ...
                               // echo $dokumen_tambah_tup ; die ;
                                ...
                                if(($dokumen_tambah_tup == '')||($dokumen_tambah_tup == 'SPP-DITOLAK')||($dokumen_tambah_tup == 'SPM-DITOLAK-KPA')||($dokumen_tambah_tup == 'SPM-DITOLAK-VERIFIKATOR')||($dokumen_tambah_tup == 'SPM-DITOLAK-KBUU')){
                                    $subdata['detail_tambah_tup']    = array(
                                                                    'nom' => '0',
                                                                    'terbilang' => $this->convertion->terbilang('0'), 
...
//                                    var_dump($subdata['detail_pic']);die;
    ...
    //                                if(($dokumen_tambah_tup == '') || ($dokumen_tambah_tup == 'SPP-DITOLAK') || ($dokumen_tambah_tup == 'SPM-DITOLAK')){
    //                                    $subdata['siap_spp'] = 'ok';
    //                                }else{
    ...
    //                                }
                                    ...
                                    $nomor_trx = $this->rsa_tambah_tup_model->get_nomor_spp($this->check_session->get_unit(),$this->cur_tahun); 
                                    $data_spp = $this->rsa_tambah_tup_model->get_data_spp($nomor_trx);
                                    $subdata['detail_tambah_tup']    = array(
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
    ...
    //                                }
                                ...
                                $subdata['id_nomor_tambah_tup'] = $id_max_nomor_tambah_tup ;
                                
                                $subdata['doc_tambah_tup'] = $dokumen_tambah_tup;
                                $subdata['nomor_spp'] = $nomor_trx;
                                $subdata['ket'] = $this->rsa_tambah_tup_model->lihat_ket($this->check_session->get_unit(),$this->cur_tahun);
                                
//                                $urut_spp_pup = $this->rsa_tambah_tup_model->get_urut($this->check_session->get_unit(),'SPP',$this->cur_tahun);
                                
                //$subdata['opt_unit_kepeg']        = $this->option->opt_unit_kepeg();
//                                var_dump($subdata['detail_pic']);die;
                $data['main_content']           = $this->load->view("rsa_permintaan/spumk_tambah_tup",$subdata,TRUE);
                $this->load->view('main_template',$data);
            } 
            else{
                redirect('welcome','refresh');  // redirect ke halaman home
                ...
                function spp_tambah_tup_lihat($url = ''){
                ...
                $data['main_menu']  = $this->load->view('main_menu','',TRUE);       
                                ...
                                $dokumen = $this->rsa_tambah_tup_model->check_dokumen_tambah_tup_by_str_trx($url);
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
                                ...
                                $subdata['id_nomor_tambah_tup'] = $this->rsa_tambah_tup_model->get_id_nomor_tambah_tup_by_nomor_trx($nomor_trx);

                                $subdata['doc'] = $dokumen;
                                $subdata['nomor_spp'] = $nomor_trx;
                                $subdata['detail_ppk']  = $this->user_model->get_detail_rsa_user($kd_unit,'14');

                                $subdata['ket'] = $this->rsa_tambah_tup_model->lihat_ket_by_nomor_trx($nomor_trx);
                ...
                function spm_tambah_tup_lihat($url = ''){
                ...
                $data['main_menu']  = $this->load->view('main_menu','',TRUE);       
                                ...
                                $id_nomor = $this->rsa_tambah_tup_model->get_nomor_spp_urut_by_nomor_spp($nomor_trx_spp) ;
                                
                                
                                $dokumen = $this->rsa_tambah_tup_model->check_dokumen_tambah_tup_by_str_trx($url);

                                $nomor_trx_spm = $this->rsa_tambah_tup_model->get_spm_by_spp($nomor_trx_spp);
...
//                                    echo $data_spp->tgl_spp; die
                                ...
                                // SPM //
                                    ...
                                    // $nomor_trx_spm = $this->rsa_tambah_tup_model->get_nomor_spm($this->check_session->get_unit(),$this->cur_tahun);  

                                     // $id_nomor_tambah_tup_spm = $this->rsa_tambah_tup_model->get_nomor_spm_urut_by_nomor_spp($nomor_trx_spp) ;
                                    
                                    // $nomor_trx_spm = $this->rsa_tambah_tup_model->get_nomor_spm_by_id($id_nomor_tambah_tup_spm);  
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
                                ...
                                // $subdata['tgl_spm_kpa'] = $this->rsa_tambah_tup_model->get_tgl_spm_kpa($kd_unit ,$this->cur_tahun,$nomor_trx_spm);

                                $subdata['tgl_spm_kpa'] = $this->rsa_tambah_tup_model->get_tgl_spm_kpa_by_spp($nomor_trx_spp);
                                
                                // $subdata['tgl_spm_verifikator'] = $this->rsa_tambah_tup_model->get_tgl_spm_verifikator($kd_unit ,$this->cur_tahun,$nomor_trx_spm);

                                $subdata['tgl_spm_verifikator'] = $this->rsa_tambah_tup_model->get_tgl_spm_verifikator_by_spp($nomor_trx_spp);
                                
                                // $subdata['tgl_spm_kbuu'] = $this->rsa_tambah_tup_model->get_tgl_spm_kbuu($kd_unit ,$this->cur_tahun,$nomor_trx_spm);

                                $subdata['tgl_spm_kbuu'] = $this->rsa_tambah_tup_model->get_tgl_spm_kbuu_by_spp($nomor_trx_spp);
                                
                                // $subdata['ket'] = $this->rsa_tambah_tup_model->lihat_ket($this->check_session->get_unit(),$this->cur_tahun);
                                // echo $this->rsa_tambah_tup_model->lihat_ket_by_nomor_trx($nomor_trx_spp); die ;
                                $subdata['ket'] = $this->rsa_tambah_tup_model->lihat_ket_by_nomor_trx($nomor_trx_spp);
...
//                                var_dump($subdata);die;
				...
				$data['main_menu']	= $this->load->view('main_menu','',TRUE);	
                                ...
                                $id_nomor = $this->rsa_tambah_tup_model->get_nomor_spp_urut_by_nomor_spp($str_nomor_trx_spp) ;
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
                                ...
                                //////////
                                    ...
                                    $nomor_trx_ = $this->rsa_tambah_tup_model->get_nomor_next_spm($this->check_session->get_unit(),$this->cur_tahun);
...
//                                    $subdata['detail_pic']  = $this->user_model->get_detail_rsa_user($this->check_session->get_unit(),'13');
                                    ...
                                    $subdata['detail_verifikator']  = $this->rsa_tambah_tup_model->get_verifikator(substr($this->check_session->get_unit(),0,2));
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
                                ...
                                $subdata['tgl_spm_kpa'] = $this->rsa_tambah_tup_model->get_tgl_spm_kpa($this->check_session->get_unit(),$this->cur_tahun,$nomor_trx_spm);
                                
                                $subdata['tgl_spm_verifikator'] = $this->rsa_tambah_tup_model->get_tgl_spm_verifikator($this->check_session->get_unit(),$this->cur_tahun,$nomor_trx_spm);
                                
                                $subdata['tgl_spm_kbuu'] = $this->rsa_tambah_tup_model->get_tgl_spm_kbuu($this->check_session->get_unit(),$this->cur_tahun,$nomor_trx_spm);
                ...
                function spm_tambah_tup_lanjut($url = ''){
                ...
                //$subdata_rsa_tambah_tup['result_rsa_tambah_tup']        = $this->rsa_tambah_tup_model->search_rsa_tambah_tup();
//              $subdata['detail_tambah_tup']            = array(
//                                                                                    'nom' => $this->setting_tambah_tup_model->get_setting_tambah_tup($this->check_session->get_unit(),$this->cur_tahun),
//                                                                                    'terbilang' => $this->convertion->terbilang($this->setting_tambah_tup_model->get_setting_tambah_tup($this->check_session->get_unit(),$this->cur_tahun)), 
//                                                                                    
//                                                                                );
                                ...
                                $dokumen = 'SPP-FINAL' ; // $this->rsa_tambah_tup_model->check_dokumen_tambah_tup($this->check_session->get_unit(),$this->cur_tahun,$id_nomor_tambah_tup);
...
//                                $subdata['detail_pic']  = $this->user_model->get_detail_rsa_user($this->check_session->get_unit(),'13');
                                ...
                                // $dokumen_tambah_tup = $this->rsa_tambah_tup_model->check_dokumen_tambah_tup($this->check_session->get_unit(),$this->cur_tahun);

                                
                                
//                                $subdata['tgl_spm'] = $this->rsa_tambah_tup_model->get_tgl_spm($this->check_session->get_unit(),$this->cur_tahun);
                                
                                // $nomor_trx_spp = $this->rsa_tambah_tup_model->get_nomor_spp($this->check_session->get_unit(),$this->cur_tahun); 
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
                ...
                function spm_tambah_tup_kpa($url = ''){
				...
				//$subdata_rsa_tambah_tup['result_rsa_tambah_tup'] 		= $this->rsa_tambah_tup_model->search_rsa_tambah_tup();
                                ...
                                // echo  $id_nomor_tambah_tup; die;
                                
                                $dokumen = 'SPM-DRAFT-PPK';//this->rsa_tambah_tup_model->check_dokumen_tambah_tup($this->check_session->get_unit(),$this->cur_tahun,$id_nomor_tambah_tup);
                                ...
                                // $dokumen_tambah_tup = $this->rsa_tambah_tup_model->check_dokumen_tambah_tup($this->check_session->get_unit(),$this->cur_tahun,$id_nomor_tambah_tup);
                                
                                $nomor_trx_spp = $str_nomor_trx_spp ; // $this->rsa_tambah_tup_model->get_nomor_spp_by_id($id_nomor_tambah_tup); 
...
//                            $subdata['unit_usul'] 		= $this->rsa_tambah_tup_model->get_tambah_tup_unit_usul_verifikator($user->id,$tahun);
                            $subdata['unit_usul'] 		= $this->rsa_tambah_tup_model->get_tambah_tup_unit_usul_verifikator($user->id,$tahun);
                            // echo '<pre>';var_dump($subdata['unit_usul']);echo '</pre>';die;
                            $subdata['subunit_usul']  		= $this->rsa_tambah_tup_model->get_tambah_tup_subunit_usul_verifikator($user->id,$tahun);
...
//                            $subdata['opt_sumber_dana'] 	= $this->option->sumber_dana();
                ...
                function daftar_unit_kbuu($tahun=''){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==11))){
                            $data['main_menu']              = $this->load->view('main_menu','',TRUE);
                            $subdata['unit_usul'] 		= $this->rsa_tambah_tup_model->get_tambah_tup_unit_usul($tahun);
                            // echo '<pre>';var_dump($subdata['unit_usul']);echo '</pre>';die;
                            $subdata['subunit_usul'] 		= $this->rsa_tambah_tup_model->get_tambah_tup_subunit_usul($tahun);
                            $subdata['cur_tahun'] =  $tahun;
                            $subdata['jenis'] =  'tambah_tup';
//                            $subdata['opt_sumber_dana'] 	= $this->option->sumber_dana();
    ...
    //			echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                ...
                function daftar_spm_kbuu($tahun="",$kode_unit_subunit=""){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==11))){
                            ...
                            $subdata['daftar_spm']          = $this->rsa_tambah_tup_model->get_daftar_spp($kode_unit_subunit,$tahun);
//                            echo '<pre>';var_dump($subdata['daftar_spp']);echo '</pre>';die;
    ...
    //          echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                ...
                function spm_tambah_tup_verifikator($url = ''){
                ...
                $data['main_menu']  = $this->load->view('main_menu','',TRUE); 
                                ...
                                $dokumen =  'SPM-DRAFT-KPA' ; //$this->rsa_tambah_tup_model->check_dokumen_tambah_tup_by_str_trx($url);
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
                                ...
                                $subdata['detail_verifikator']  = $this->rsa_tambah_tup_model->get_verifikator_by_spm($nomor_trx_spm);
                                ...
                                $subdata['ket'] = $this->rsa_tambah_tup_model->lihat_ket_by_str_trx($nomor_trx_spp);
                ...
                function spm_tambah_tup_kbuu($url = ''){
                ...
                $data['main_menu']  = $this->load->view('main_menu','',TRUE); 
                                ...
                                // $dokumen_tambah_tup = $this->rsa_tambah_tup_model->check_dokumen_tambah_tup_by_str_trx($url);

                              
                                $dokumen = 'SPM-FINAL-VERIFIKATOR';//$dokumen_tambah_tup;
...
//                        echo $h;
                        ...
                        $this->pdfgen->cetak($html,'SPP_tambah_tup_'.$unit.'_'.''.$tahun);
                    }
...
//                        echo $html;die;
                        $this->load->library('Pdfgen'); 
                        $this->pdfgen->cetak($html,'SPM_tambah_tup_');
                    }
                }
                
                function usulkan_spp_tambah_tup(){
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==13))){
                        if($this->input->post('proses')){
                            ...
                            $id_nomor_tambah_tup = $this->input->post('id_nomor_tambah_tup') ;
                            ...
                            $data = array(
                                ...
                                'bulan' => $bulan,
                                'tahun' => $tahun,
//                                'urut' => $this->rsa_tambah_tup_model->get_urut($kd_unit,$jenis,$tahun)
                            );
                           ...
                           // echo '<pre>'; var_dump($data_spp); die;


                            // $dokumen_tambah_tup = ''; //$this->rsa_tambah_tup_model->check_dokumen_tambah_tup($kd_unit,$tahun,$id_nomor_tambah_tup);

                            // if(($dokumen_tambah_tup == '')||($dokumen_tambah_tup == 'SPP-DITOLAK')||($dokumen_tambah_tup == 'SPM-DITOLAK-KPA')||($dokumen_tambah_tup == 'SPM-DITOLAK-VERIFIKATOR')||($dokumen_tambah_tup == 'SPM-DITOLAK-KBUU')||($dokumen_tambah_tup == 'SPM-FINAL-KBUU')){

        //                        var_dump($data_spp);die;

    //                            echo 'jos';die;

                                if($this->rsa_tambah_tup_model->proses_nomor_spp_tambah_tup($kd_unit,$data) ){
                                    
                                    $data_spp = array(
                                        'kode_unit_subunit' => $kd_unit,
                                        // 'nomor_trx_spp' => $this->rsa_tambah_tup_model->get_id_nomor_tambah_tup($jenis,$kd_unit,$this->cur_tahun),
                                        'nomor_trx_spp' => $this->rsa_tambah_tup_model->get_id_nomor_tambah_tup_by_nomor_trx($nomor_trx),
                                        'str_nomor_trx' => $nomor_trx,
                                    ...
                                    $data = array(
                                        ...
                                        'id_trx_nomor_tambah_tup' => $this->rsa_tambah_tup_model->get_id_nomor_tambah_tup_by_nomor_trx($nomor_trx),
                                        'ket' => $ket,
                                        'aktif' => '1',
                                        'tahun' => $tahun,
                                        'tgl_proses' => date("Y-m-d H:i:s")
                                   ...
                                   // var_dump($data);die;
                                    ...
                                    if($this->rsa_tambah_tup_model->proses_tambah_tup($kd_unit,$data,$id_nomor_tambah_tup)&& $this->rsa_tambah_tup_model->proses_data_spp($data_spp)){
                ...
                function usulkan_spm_tambah_tup(){
...
//                                'urut' => $this->rsa_tambah_tup_model->get_urut($kd_unit,$jenis,$tahun)
                           ...
                           // echo '<pre>'; var_dump($data); die;
                            ...
                            $dokumen_tambah_tup = 'SPP-FINAL';//$this->rsa_tambah_tup_model->check_dokumen_tambah_tup($kd_unit,$tahun,$id_nomor_tambah_tup);

                            // echo $dokumen_tambah_tup ; die;

                            // if($dokumen_tambah_tup == 'SPP-FINAL'){
    //                        $this->rsa_tambah_tup_model->proses_data_spm($data_spm);
    //                        var_dump($data_spm);die;

                                if($this->rsa_tambah_tup_model->proses_nomor_spm_tambah_tup($kd_unit,$data)){

                                    $id_trx_nomor_tambah_tup = $this->rsa_tambah_tup_model->get_id_nomor_tambah_tup_by_nomor_trx($nomor_trx_spp) ;
                                    $id_trx_nomor_tambah_tup_spm = $this->rsa_tambah_tup_model->get_id_nomor_tambah_tup_by_nomor_trx($nomor_trx) ;

                                    $data_spm = array(
                                        'kode_unit_subunit' => $kd_unit,
                                        // 'nomor_trx_spm' => $this->rsa_tambah_tup_model->get_id_nomor_tambah_tup($jenis,$kd_unit,$this->cur_tahun),
                                        'nomor_trx_spm' => $id_trx_nomor_tambah_tup_spm,
                                        'str_nomor_trx' => $nomor_trx,
                                        'jumlah_bayar' => $this->input->post('jumlah_bayar'),
                                        'terbilang' => $this->input->post('terbilang'),
                                        'untuk_bayar' => $this->input->post('untuk_bayar'),
                                    ...
                                    $data_spp_spm = array(
                                        'kode_unit_subunit' => $kd_unit,
                                        // 'nomor_trx_spp' => $this->rsa_tambah_tup_model->get_id_nomor_tambah_tup('SPP',$kd_unit,$this->cur_tahun),
                                        'nomor_trx_spp' => $id_trx_nomor_tambah_tup,
                                        'str_nomor_trx_spp' => $nomor_trx_spp,
                                        // 'nomor_trx_spm' => $this->rsa_tambah_tup_model->get_id_nomor_tambah_tup('SPM',$kd_unit,$this->cur_tahun),
                                        'nomor_trx_spm' => $id_trx_nomor_tambah_tup_spm,
                                        'str_nomor_trx_spm' =>$nomor_trx,
                                        'jenis_trx' => 'TAmBAH_TUP',
                                        'tahun' => $tahun,
                                    ...
                                    $data = array(
                                        ...
                                        'posisi' => $proses,
                                        // 'id_trx_nomor_tambah_tup' => $this->rsa_tambah_tup_model->get_id_nomor_tambah_tup($jenis,$kd_unit,$this->cur_tahun),
                                        'id_trx_nomor_tambah_tup' => $id_trx_nomor_tambah_tup,
                                        'id_trx_nomor_tambah_tup_spm' => $id_trx_nomor_tambah_tup_spm,
                                        'ket' => $ket,
                                        'aktif' => '1',
                                        'tahun' => $tahun,
                                        'tgl_proses' => date("Y-m-d H:i:s")
                                   ...
                                   // var_dump($data);die;
                                    ...
                                    if($this->rsa_tambah_tup_model->proses_tambah_tup($kd_unit,$data,$id_trx_nomor_tambah_tup) && $this->rsa_tambah_tup_model->proses_trx_spp_spm($data_spp_spm) && $this->rsa_tambah_tup_model->proses_data_spm($data_spm)){
                                        $this->session->set_flashdata('message', '<div class="alert alert-success" style="text-align:center"><span class="glyphicon glyphicon glyphicon-ok" aria-hidden="true"></span> SPP/SPM anda berhasil disubmit.</div>');
                                        echo "sukses";
                                    }else{
                                        echo "gagal";
                ...
                function proses_spp_tambah_tup(){
                    if($this->input->post('proses')){
                        $proses = $this->input->post('proses');
                        $nomor_trx = $this->input->post('nomor_trx');
                        $nomor_ = explode('/',$nomor_trx);
                        ...
                        //$dokumen = 'SPP-DRAFT'; //$this->rsa_tambah_tup_model->check_dokumen_tambah_tup($kd_unit,$tahun,$id_nomor_tambah_tup);
                        ...
                        if($ok){
                            ...
                            if($this->rsa_tambah_tup_model->proses_tambah_tup($kd_unit,$data,$id_nomor_tambah_tup)){
                                $this->session->set_flashdata('message', '<div class="alert alert-success" style="text-align:center"><span class="glyphicon glyphicon glyphicon-ok" aria-hidden="true"></span> SPP/SPM anda berhasil disubmit.</div>');
                                echo "sukses";
                            }else{
                                echo "gagal";
                ...
                function proses_spm_tambah_tup(){
                    if($this->input->post('proses')){
                        $proses = $this->input->post('proses');
                        $nomor_trx = $this->input->post('nomor_trx');
                        $nomor_ = explode('/',$nomor_trx);
                        ...
                        $id_nomor_tambah_tup = $this->input->post('id_nomor_tambah_tup') ;
                            ...
                            $data = array(
                                ...
                                'posisi' => $proses,
                                // 'id_trx_nomor_tambah_tup' => $this->rsa_tambah_tup_model->get_id_nomor_tambah_tup($jenis,$kd_unit,$this->cur_tahun),
                                'id_trx_nomor_tambah_tup' => $id_nomor_tambah_tup,
                                'id_trx_nomor_tambah_tup_spm' => $this->rsa_tambah_tup_model->get_id_nomor_tambah_tup_by_nomor_trx($nomor_trx),
                                'ket' => $ket,
                                'aktif' => '1',
                                'tahun' => $tahun,
                        ...
                        // $dokumen = $this->rsa_tambah_tup_model->check_dokumen_tambah_tup($kd_unit,$tahun,$id_nomor_tambah_tup);
                        ...
                        if($ok){
                            ...
                            $nomor_trx_spm = $this->rsa_tambah_tup_model->get_id_nomor_tambah_tup_by_nomor_trx($nomor_trx) ;
                            ...
                            if($this->rsa_tambah_tup_model->proses_tambah_tup($kd_unit,$data,$id_nomor_tambah_tup)){
                                if($this->check_session->get_level() == 3){
                                    ...
                                    $data_verifikator = array(
                                        'nomor_trx_spm' => $nomor_trx_spm ,//$this->rsa_tambah_tup_model->get_id_nomor_tambah_tup('SPM',$kd_unit,$tahun),//$nomor_[0],
                                        'str_nomor_trx_spm' => $nomor_trx,
                                        'kode_unit_subunit' => $kd_unit,
                                        'jenis_trx' => 'TAmBAH_TUP',
                                    ...
                                    if($this->rsa_tambah_tup_model->proses_verifikator_tambah_tup($data_verifikator)){
                                        $this->session->set_flashdata('message', '<div class="alert alert-success" style="text-align:center"><span class="glyphicon glyphicon glyphicon-ok" aria-hidden="true"></span> SPP/SPM anda berhasil disubmit.</div>');
                                        echo "sukses";
                                    }else{
                                        echo "gagal";
                ...
                function proses_final_tambah_tup(){
                    if($this->input->post('proses')){
                        $proses = $this->input->post('proses');
                        ...
                        $id_trx_nomor_tambah_tup = $this->input->post('id_nomor_tambah_tup') ;
                        $id_trx_nomor_tambah_tup_spm = $this->rsa_tambah_tup_model->get_id_nomor_tambah_tup_by_nomor_trx($nomor_trx_spm) ;

                        $nomor_trx_spp = $this->rsa_tambah_tup_model->get_spp_by_spm($nomor_trx_spm);
                        ...
                        // $dokumen_tambah_tup = $this->rsa_tambah_tup_model->check_dokumen_tambah_tup_by_str_trx($nomor_trx_spp);
                        
                        // if(($proses == 'SPM-FINAL-KBUU')&&($dokumen_tambah_tup == 'SPM-FINAL-VERIFIKATOR')){
                        //     $ok = TRUE ;
                        // }else{
                        //     $ok = FALSE;
                        // }
...
//                            echo $saldo_ben->saldo;die;
                            ...
                            // echo $kd_unit . ' ' . $id_trx_nomor_tambah_tup ; die;
                            
                            if($this->rsa_tambah_tup_model->proses_tambah_tup($kd_unit,$data,$id_trx_nomor_tambah_tup)){
                                ...
                                $saldo_penerima = $this->kas_bendahara_model->get_kas_bendahara_by_kd_akun_and_unit($kd_akun_kas_bendahara,$kd_unit,$this->cur_tahun);
                                ...
                                $data_spm_cair = array(
                                    'no_urut' => $this->rsa_tambah_tup_model->get_next_urut_spm_cair($this->input->post('tahun')),
//                                    'nomor_trx_spm' => $this->rsa_tambah_tup_model->get_id_nomor_tambah_tup('SPM',$kd_unit,$this->input->post('tahun')),//,$nomor,
    ...
    //                            var_dump($data_spm_cair);die;
                                ...
                                // $data_to_nihil = array(
                                //     'kode_unit_subunit' => $kd_unit,
                                //     'str_nomor_trx_spm_tambah_tup' => $nomor_trx_spm,
                                //     'tgl_proses_tambah_tup' => date('Y-m-d H:i:s'),
                                //     'tahun' => $this->input->post('tahun'),
                                //     'status' => '1',
                                // );

                                if($this->rsa_tambah_tup_model->final_tambah_tup($kd_unit,$data) && $this->kas_undip_model->isi_trx($data_kas) && $this->rsa_tambah_tup_model->spm_cair($data_spm_cair)){ //&& $this->rsa_tambah_tup_model->ks_to_nihil($data_ks_to_nihil)){

                                // if($this->kas_undip_model->isi_trx($data_kas) && $this->rsa_tambah_tup_model->spm_cair($data_spm_cair)){
		...
		function exec_add_rsa_tambah_tup(){
				...
				if($this->check_session->user_session() && $this->check_session->get_level()==2){
						...
						// $kode = strlen(($top_unit->kode_unit+1)+"")==1?"0".($top_unit->kode_unit+1):$top_unit->kode_unit+1;
                                        if($this->input->post()){
                                            ...
                                            $this->form_validation->set_rules('no_tambah_tup','no_tambah_tup','required|min_length[2]|callback_check_exist_rsa_tambah_tup');
                                            ...
                                            if ($this->form_validation->run()){
												...
												'no_tambah_tup' => form_prep($this->input->post('no_tambah_tup')),
							                    ...
							                    $this->rsa_tambah_tup_model->add_rsa_tambah_tup($data);
                                                echo "berhasil";
		...
		if($this->check_session->user_session() && $this->check_session->get_level()==100){
			if($this->uri->segment(3)){
				if($this->rsa_tambah_tup_model->delete_rsa_tambah_tup(array('no'=>$this->uri->segment(3)))){
					$data['class']	 = 'option box';
					$data['class_btn']	 = 'ya';
		...
		function get_row_rsa_tambah_tup(){
			if($this->check_session->user_session() && $this->check_session->get_level()==100){
				$data['result_rsa_tambah_tup'] = $this->rsa_tambah_tup_model->get_rsa_tambah_tup();
				$this->load->view('rsa_permintaan/row_rsa_tambah_tup',$data);
			}
			else{
				show_404('page');
			}
		...
		function filter_rsa_tambah_tup(){
			if($this->check_session->user_session() && $this->check_session->get_level()==100){
				$keyword = form_prep($this->input->post('keyword'));
				$data['result_rsa_tambah_tup'] = $this->rsa_tambah_tup_model->search_rsa_tambah_tup($keyword);
				$this->load->view('rsa_permintaan/row_rsa_tambah_tup',$data);
			}
			else{
				show_404('page');
               ...
               function check_exist_rsa_tambah_tup($no_tambah_tup){

                        $this->form_validation->set_message('check_exist_rsa_tambah_tup', 'Maaf, kode RSA tsb sudah terdaftar');

                        $result = $this->rsa_tambah_tup_model->get_rsa_tambah_tup($no_tambah_tup);
                ...
                function check_exist_rba_unit($kode_unit_rba){
                        ...
                        $result = $this->rsa_tambah_tup_model->get_rsa_tambah_tup($kode_unit_rba);
                ...
                function saldo($tahun=''){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==3)||($this->check_session->get_level()==11))){
                            $data['main_menu']              = $this->load->view('main_menu','',TRUE);
                            $subdata['unit_usul'] 		= $this->rsa_tambah_tup_model->get_tambah_tup_unit($tahun);
                            $subdata['cur_tahun'] =  $tahun;
//                            $subdata['opt_sumber_dana'] 	= $this->option->sumber_dana();
    ...
    //			echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                ...
                function daftar_spp($tahun="",$kode_unit_subunit=""){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==13))){
                            ...
                            $subdata['daftar_spp']          = $this->rsa_tambah_tup_model->get_daftar_spp($kode_unit_subunit,$tahun);
    ...
    //          echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                ...
                function get_status_nihil(){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==13))){
                           // echo '5' ; 
                        $status = $this->rsa_tambah_tup_model->get_status_nihil($this->check_session->get_unit(),$this->cur_tahun);
                ...
                function get_notif_approve(){
                    ...
                    if($this->check_session->user_session()){
                        ...
                        $notif = $this->rsa_tambah_tup_model->get_notif_approve($kode_unit_subunit,$level,$user->id);
                ...
                function get_data_untuk_pekerjaan(){
                    ...
                    $kode_unit_subunit = $this->check_session->get_unit();
                    $data = $this->rsa_tambah_tup_model->get_data_untuk_pekerjaan($d['untuk_bayar'],$kode_unit_subunit,$this->cur_tahun);
                    $json = [];
                ...
                function get_data_penerima(){
                    $q = $this->input->get('query');
                    $kode_unit_subunit = $this->check_session->get_unit();
                    $data = $this->rsa_tambah_tup_model->get_data_penerima($q,$kode_unit_subunit,$this->cur_tahun);
                    $json = [];
