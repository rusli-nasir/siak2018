<?php
	...
	class rsa_tambah_up extends CI_Controller{
/* -------------- Constructor ------------- */
	...
	public function __construct(){ 
		parent::__construct();
			...
			$this->load->model(array('rsa_tambah_up_model','setting_up_model'));
...
//                        $data['message']	= validation_errors();
		...
		function daftar_rsa_up(){
			if($this->check_session->user_session() && $this->check_session->get_level()==2){
				...
				$data['main_menu']	= $this->load->view('main_menu','',TRUE);		
				$subdata_rsa_up['result_rsa_up'] 		= $this->rsa_tambah_up_model->search_rsa_up();
		...
		function input_rsa_up(){
			if($this->check_session->user_session() && $this->check_session->get_level()==13){
				...
				//$subdata_rsa_up['result_rsa_up'] 		= $this->rsa_tambah_up_model->search_rsa_up();
                                ...
                                $dokumen_up = $this->rsa_tambah_up_model->check_dokumen_tambah_up($this->check_session->get_unit(),$this->cur_tahun);
//                                echo $dokumen_up; die;
...
//                                    var_dump($subdata['detail_pic']);die;
    ...
    //                                }
                                    ...
                                    $subdata['tgl_spp'] = $this->rsa_tambah_up_model->get_tgl_spp($this->check_session->get_unit(),$this->cur_tahun);

                                    $nomor_trx_ = $this->rsa_tambah_up_model->get_nomor_next_spp($this->check_session->get_unit(),$this->cur_tahun);
                                    setlocale(LC_ALL, 'id_ID.utf8');$bln = strftime("%h");  
                                    $nomor_trx = $nomor_trx_.'/'.$this->check_session->get_alias().'/'.'SPP-PUP'.'/'.strtoupper($bln).'/'.$this->cur_tahun;
                                
                                }else{
                                    $nomor_trx = $this->rsa_tambah_up_model->get_nomor_spp($this->check_session->get_unit(),$this->cur_tahun); 
                                    $data_spp = $this->rsa_tambah_up_model->get_data_spp($nomor_trx);
                                    $subdata['detail_up'] 	= array(
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
    ...
    //                                }
                                ...
                                $subdata['ket'] = $this->rsa_tambah_up_model->lihat_ket($this->check_session->get_unit(),$this->cur_tahun);
                                
//                                $urut_spp_pup = $this->rsa_tambah_up_model->get_urut($this->check_session->get_unit(),'SPP',$this->cur_tahun);
                                
				//$subdata['opt_unit_kepeg']		= $this->option->opt_unit_kepeg();
//                                var_dump($subdata['detail_pic']);die;
				$data['main_content'] 			= $this->load->view("rsa_tambah_up/spp_tambah_up",$subdata,TRUE);
				$this->load->view('main_template',$data);
			} 
			else{
...
//                                $subdata['tgl_spm'] = $this->rsa_tambah_up_model->get_tgl_spm($this->check_session->get_unit(),$this->cur_tahun);
                                
                                $nomor_trx_spp = $this->rsa_tambah_up_model->get_nomor_spp($this->check_session->get_unit(),$this->cur_tahun); 
...
//                                echo $nomor_trx_spp ;die;
                                ...
                                if(($dokumen_up == 'SPP-FINAL') || ($dokumen_up == 'SPP-DRAFT') || ($dokumen_up == 'SPM-DRAFT-PPK') || ($dokumen_up == 'SPM-DRAFT-KPA') || ($dokumen_up == 'SPM-FINAL-VERIFIKATOR')  || ($dokumen_up == 'SPM-FINAL-KBUU')){
                                    ...
                                    $data_spp = $this->rsa_tambah_up_model->get_data_spp($nomor_trx_spp);
...
//                                    echo $data_spp->tgl_spp; die
                                ...
                                if(($dokumen_up == 'SPM-DRAFT-PPK') || ($dokumen_up == 'SPM-DRAFT-KPA') || ($dokumen_up == 'SPM-FINAL-VERIFIKATOR')  || ($dokumen_up == 'SPM-FINAL-KBUU')){
                                    ...
                                    $nomor_trx_spm = $this->rsa_tambah_up_model->get_nomor_spm($this->check_session->get_unit(),$this->cur_tahun);  
                                    
                                    $data_spm = $this->rsa_tambah_up_model->get_data_spm($nomor_trx_spm);
                                    $subdata['detail_spm_up'] 	= array(
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
                                    ...
                                    $nomor_trx_ = $this->rsa_tambah_up_model->get_nomor_next_spm($this->check_session->get_unit(),$this->cur_tahun);
                                    setlocale(LC_ALL, 'id_ID.utf8');$bln = strftime("%h");
                                    $nomor_trx_spm = $nomor_trx_.'/'.$this->check_session->get_alias().'/'.'SPM-PUP'.'/'.strtoupper($bln).'/'.$this->cur_tahun;
...
//                                    $subdata['detail_pic']  = $this->user_model->get_detail_rsa_user($this->check_session->get_unit(),'13');
                                    ...
                                    $subdata['detail_verifikator']  = $this->rsa_tambah_up_model->get_verifikator(substr($this->check_session->get_unit(),0,2));
...
//                                    $subdata['tgl_spp'] = $data_spp->tgl_spp;
                                ...
                                $subdata['tgl_spm_kpa'] = $this->rsa_tambah_up_model->get_tgl_spm_kpa($this->check_session->get_unit(),$this->cur_tahun,$nomor_trx_spm);
                                
                                $subdata['tgl_spm_verifikator'] = $this->rsa_tambah_up_model->get_tgl_spm_verifikator($this->check_session->get_unit(),$this->cur_tahun,$nomor_trx_spm);
                                
                                $subdata['tgl_spm_kbuu'] = $this->rsa_tambah_up_model->get_tgl_spm_kbuu($this->check_session->get_unit(),$this->cur_tahun,$nomor_trx_spm);
                                
                                $subdata['ket'] = $this->rsa_tambah_up_model->lihat_ket($this->check_session->get_unit(),$this->cur_tahun);
                                
				//$subdata['opt_unit_kepeg']		= $this->option->opt_unit_kepeg();
//                                var_dump($subdata);die;
				$data['main_content'] 			= $this->load->view("rsa_tambah_up/spm_tambah_up",$subdata,TRUE);
				$this->load->view('main_template',$data);
			} 
			else{
				redirect('welcome','refresh');	// redirect ke halaman home
                ...
                function spm_tambah_up_lihat_99($url,$kd_unit,$tahun){
                    if($this->check_session->user_session() && (($this->check_session->get_level()==2)||($this->check_session->get_level()==100)||($this->check_session->get_level()==17)||($this->check_session->get_level()==11))){
                ...
                //$subdata_rsa_up['result_rsa_up']      = $this->rsa_tambah_up_model->search_rsa_up();
                                ...
                                $dokumen_up = $this->rsa_tambah_up_model->check_dokumen_tambah_up_by_str_trx($url);
                                ...
                                $nomor_trx_spp = $this->rsa_tambah_up_model->get_spp_by_spm($nomor_trx_spm);
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
                                ...
                                $subdata['tgl_spm_kpa'] = $this->rsa_tambah_up_model->get_tgl_spm_kpa($kd_unit,$tahun,$nomor_trx_spm);
                                ...
                                $subdata['tgl_spm_verifikator'] = $this->rsa_tambah_up_model->get_tgl_spm_verifikator($kd_unit,$tahun,$nomor_trx_spm);
                                
                                //$subdata['tgl_spm_kbuu'] = $this->rsa_gup_model->get_tgl_spm_kbuu($this->check_session->get_unit(),$this->cur_tahun,$nomor_trx_spm);
                                $subdata['tgl_spm_kbuu'] = $this->rsa_tambah_up_model->get_tgl_spm_kbuu($kd_unit,$tahun,$nomor_trx_spm);
                                
                                // $subdata['ket'] = $this->rsa_gup_model->lihat_ket($this->check_session->get_unit(),$this->cur_tahun);

                                $subdata['ket'] = $this->rsa_tambah_up_model->lihat_ket_by_str_trx($nomor_trx_spm);//$kd_unit,$tahun);
                                
                //$subdata['opt_unit_kepeg']        = $this->option->opt_unit_kepeg();
//                                var_dump($subdata);die;
                $data['main_content']           = $this->load->view("rsa_tambah_up/spm_tambah_up_lihat",$subdata,TRUE);
                $this->load->view('main_template',$data);
            } 
            else{
                redirect('welcome','refresh');  // redirect ke halaman home
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
				...
				//$subdata['opt_unit_kepeg']		= $this->option->opt_unit_kepeg();
//                                var_dump($subdata);die;
				$data['main_content'] 			= $this->load->view("rsa_tambah_up/spm_tambah_up_kpa",$subdata,TRUE);
				$this->load->view('main_template',$data);
			} 
			else{
				redirect('welcome','refresh');	// redirect ke halaman home
...
//                            $subdata['unit_usul'] 		= $this->rsa_tambah_up_model->get_tambah_up_unit_usul_verifikator($user->id,$tahun);
                            $subdata['unit_usul'] 		= $this->rsa_tambah_up_model->get_tambah_up_unit_usul_verifikator($user->id,$tahun);
                            $subdata['subunit_usul']  		= $this->rsa_tambah_up_model->get_tambah_up_subunit_usul_verifikator($user->id,$tahun);
                            $subdata['cur_tahun'] =  $tahun;
//                            $subdata['opt_sumber_dana'] 	= $this->option->sumber_dana();
                            $data['main_content'] 		= $this->load->view("rsa_tambah_up/daftar_unit",$subdata,TRUE);
                            /*	Load main template	*/
    //			echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                ...
                function daftar_unit_kbuu($tahun=''){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==11))){
                            $data['main_menu']              = $this->load->view('main_menu','',TRUE);
                            $subdata['unit_usul'] 		= $this->rsa_tambah_up_model->get_tambah_up_unit_usul($tahun);
                            $subdata['subunit_usul'] 		= $this->rsa_tambah_up_model->get_tambah_up_subunit_usul($tahun);
                            $subdata['cur_tahun'] =  $tahun;
//                            $subdata['opt_sumber_dana'] 	= $this->option->sumber_dana();
                            $data['main_content'] 		= $this->load->view("rsa_tambah_up/daftar_unit_kbuu",$subdata,TRUE);
                            /*	Load main template	*/
    //			echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                            $this->load->view('main_template',$data);
                    }else{
                ...
                function spm_tambah_up_verifikator($kd_unit,$tahun){
				...
				$data['main_menu']	= $this->load->view('main_menu','',TRUE);		
                                ...
                                $dokumen_up = $this->rsa_tambah_up_model->check_dokumen_tambah_up($kd_unit,$tahun);
                              
                                $subdata['doc_up'] = $dokumen_up;
                                
                                $nomor_trx_spp = $this->rsa_tambah_up_model->get_nomor_spp($kd_unit,$tahun); 
...
//                                $subdata['tgl_spm'] = $this->rsa_tambah_up_model->get_tgl_spm($kd_unit,$tahun);
                                
                                $nomor_trx_spm = '';
                                
                                if(($dokumen_up == 'SPM-DRAFT-PPK') || ($dokumen_up == 'SPM-DRAFT-KPA') || ($dokumen_up == 'SPM-FINAL-VERIFIKATOR')  || ($dokumen_up == 'SPM-FINAL-KBUU')){
                                    
                                    $nomor_trx_spm = $this->rsa_tambah_up_model->get_nomor_spm($kd_unit,$tahun);  
...
//                                $detail_verifikator  = $this->rsa_tambah_up_model->get_verifikator($kd_unit,$tahun,$nomor_trx_spm);
...
//                                $subdata['detail_verifikator']  = $detail_verifikator ;
                                ...
                                $subdata['ket'] = $this->rsa_tambah_up_model->lihat_ket($kd_unit,$tahun);
                                
				//$subdata['opt_unit_kepeg']		= $this->option->opt_unit_kepeg();
//                                var_dump($subdata);die;
				$data['main_content'] 			= $this->load->view("rsa_tambah_up/spm_tambah_up_verifikator",$subdata,TRUE);
				$this->load->view('main_template',$data);
			} 
			else{
				redirect('welcome','refresh');	// redirect ke halaman home
                ...
                function spm_tambah_up_kbuu($kd_unit,$tahun){
...
//                                $subdata['detail_verifikator']  = $this->rsa_tambah_up_model->get_verifikator($kd_unit,$tahun,$nomor_trx_spm);
...
//                                var_dump( $subdata['kas_undip']);die;
				...
				//$subdata['opt_unit_kepeg']		= $this->option->opt_unit_kepeg();
//                                var_dump($subdata);die;
				$data['main_content'] 			= $this->load->view("rsa_tambah_up/spm_tambah_up_kbuu",$subdata,TRUE);
				$this->load->view('main_template',$data);
			} 
			else{
				redirect('welcome','refresh');	// redirect ke halaman home
...
//                        echo $html;die;
                ...
                function usulkan_spp_tambah_up(){
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==13))){
                        if($this->input->post('proses')){
                            ...
                            $data = array(
                                ...
                                'bulan' => $bulan,
                                'tahun' => $tahun,
//                                'urut' => $this->rsa_tambah_up_model->get_urut($kd_unit,$jenis,$tahun)
                            );
...
//                            var_dump($data_spp);die;
                            ...
                            if(($dokumen_up == '')||($dokumen_up == 'SPP-DITOLAK')||($dokumen_up == 'SPM-DITOLAK-KPA')||($dokumen_up == 'SPM-DITOLAK-VERIFIKATOR')||($dokumen_up == 'SPM-DITOLAK-KBUU')||($dokumen_up == 'SPM-FINAL-KBUU')){

        //                        var_dump($data_spp);die;

    //                            echo 'jos';die;

                                if($this->rsa_tambah_up_model->proses_nomor_spp_tambah_up($kd_unit,$data) ){
                                    
                                    $data_spp = array(
                                        'kode_unit_subunit' => $kd_unit,
                                        'nomor_trx_spp' => $this->rsa_tambah_up_model->get_id_nomor_tambah_up($jenis,$kd_unit,$this->cur_tahun),
                                        'str_nomor_trx' => $nomor_trx,
                                        'jumlah_bayar' => $this->input->post('jumlah_bayar'),
                                        'terbilang' => $this->input->post('terbilang'),
                                        'untuk_bayar' => $this->input->post('untuk_bayar'),
                                    ...
                                    $data = array(
                                        'kode_unit_subunit' => $kd_unit,
                                        'posisi' => $proses,
                                        'id_trx_nomor_tambah_up' => $this->rsa_tambah_up_model->get_id_nomor_tambah_up($jenis,$kd_unit,$this->cur_tahun),
                                        'ket' => $ket,
                                        'aktif' => '1',
                                        'tahun' => $tahun,
                                        'tgl_proses' => date("Y-m-d H:i:s")
        ...
        //                            var_dump($data);die;
                ...
                function usulkan_spm_tambah_up(){
...
//                                'urut' => $this->rsa_tambah_up_model->get_urut($kd_unit,$jenis,$tahun)
    ...
    //                        $this->rsa_tambah_up_model->proses_data_spm($data_spm);
    //                        var_dump($data_spm);die;

                                if($this->rsa_tambah_up_model->proses_nomor_spm_tambah_up($kd_unit,$data)){
                                    $data_spm = array(
                                        'kode_unit_subunit' => $kd_unit,
                                        'nomor_trx_spm' => $this->rsa_tambah_up_model->get_id_nomor_tambah_up($jenis,$kd_unit,$this->cur_tahun),
                                        'str_nomor_trx' => $nomor_trx,
                                        'jumlah_bayar' => $this->input->post('jumlah_bayar'),
                                        'terbilang' => $this->input->post('terbilang'),
                                        'untuk_bayar' => $this->input->post('untuk_bayar'),
                                    ...
                                    $data_spp_spm = array(
                                        'kode_unit_subunit' => $kd_unit,
                                        'nomor_trx_spp' => $this->rsa_tambah_up_model->get_id_nomor_tambah_up('SPP',$kd_unit,$this->cur_tahun),
                                        'str_nomor_trx_spp' => $nomor_trx_spp,
                                        'nomor_trx_spm' => $this->rsa_tambah_up_model->get_id_nomor_tambah_up('SPM',$kd_unit,$this->cur_tahun),
                                        'str_nomor_trx_spm' =>$nomor_trx,
                                        'jenis_trx' => 'PUP',
                                        'tahun' => $tahun,
                                    );
...
//                                        'nomor_trx_spm' => $this->rsa_tambah_up_model->get_id_nomor_tambah_up('SPM',$kd_unit,$tahun),//$nomor_[0],
//                                        'str_nomor_trx_spm' => $nomor_trx,
//                                        'kode_unit_subunit' => $kd_unit,
//                                        'jenis_trx' => 'PUP',
...
//                            var_dump($data);die;
                            ...
                            if($this->rsa_tambah_up_model->proses_tambah_up($kd_unit,$data)){
                                if($this->check_session->get_level() == 3){
                                    $verifikator = $this->user_model->get_detail_rsa_user_by_username($this->check_session->get_username());
                                    $data_verifikator = array(
                                        'nomor_trx_spm' => $nomor_trx_spm ,//$this->rsa_tambah_up_model->get_id_nomor_tambah_up('SPM',$kd_unit,$tahun),//$nomor_[0],
                                        'str_nomor_trx_spm' => $nomor_trx,
                                        'kode_unit_subunit' => $kd_unit,
                                        'jenis_trx' => 'PUP',
                                        'id_rsa_user_verifikator' => $verifikator->id,
                ...
                function proses_final_tambah_up(){
                    if($this->input->post('proses')){
                        $proses = $this->input->post('proses');
                        ...
                        $data = array(
                            'kode_unit_subunit' => $kd_unit,
                            'id_trx_nomor_tambah_up' => $this->rsa_tambah_up_model->get_id_nomor_tambah_up('SPM',$kd_unit,$this->input->post('tahun')),
                            'posisi' => $proses,
                            'ket' => $ket,
                            'aktif' => '1',
                            'tahun' => $this->input->post('tahun'),
                        ...
                        $dokumen_up = $this->rsa_tambah_up_model->check_dokumen_tambah_up($kd_unit,$this->input->post('tahun'));
...
//                            echo 'jos';die;
                            ...
                            if($this->rsa_tambah_up_model->proses_tambah_up($kd_unit,$data)){
                                ...
                                $saldo_bendahara = $this->kas_bendahara_model->get_kas_saldo($kd_unit,$this->cur_tahun);
                                ...
                                $data_kas = array(
                                    ...
                                    'kd_unit' => $kd_unit,//'99',
                                    'deskripsi' => 'ISI PUP UNIT ' . $kd_unit,
                                    'no_spm' => $this->input->post('nomor_trx'),
                                    'debet' => '0',
                                    'kredit' => $nominal,
                                    'saldo' => $saldo,
                                ...
                                $data_spm_cair = array(
                                    'no_urut' => $this->rsa_tambah_up_model->get_next_urut_spm_cair($this->input->post('tahun')),
//                                    'nomor_trx_spm' => $this->rsa_tambah_up_model->get_id_nomor_tambah_up('SPM',$kd_unit,$tahun),//$nomor,
                                    'str_nomor_trx_spm' => $nomor_trx_spm,
                                    'str_nomor_trx_spp' => $this->rsa_tambah_up_model->get_spp_by_spm($nomor_trx_spm),
                                    'kode_unit_subunit' => $kd_unit,
                                    'jenis_trx' => 'PUP',
                                    'nominal' => $nominal,
                                    'tgl_proses' => date('Y-m-d H:i:s'),
    ...
    //                            var_dump($data_spm_cair);die;
						...
						// $kode = strlen(($top_unit->kode_unit+1)+"")==1?"0".($top_unit->kode_unit+1):$top_unit->kode_unit+1;
                                        if($this->input->post()){
                                            ...
                                            if ($this->form_validation->run()){
							                    ...
							                    $this->rsa_tambah_up_model->add_rsa_up($data);
                                                echo "berhasil";
		...
		if($this->check_session->user_session() && $this->check_session->get_level()==100){
			if($this->uri->segment(3)){
				if($this->rsa_tambah_up_model->delete_rsa_up(array('no'=>$this->uri->segment(3)))){
					$data['class']	 = 'option box';
					$data['class_btn']	 = 'ya';
		...
		function get_row_rsa_up(){
			if($this->check_session->user_session() && $this->check_session->get_level()==100){
				$data['result_rsa_up'] = $this->rsa_tambah_up_model->get_rsa_up();
		...
		function filter_rsa_up(){
			if($this->check_session->user_session() && $this->check_session->get_level()==100){
				...
				$data['result_rsa_up'] = $this->rsa_tambah_up_model->search_rsa_up($keyword);
				$this->load->view('rsa_up/row_rsa_up',$data);
			}
			else{
				show_404('page');
               ...
               function check_exist_rsa_up($no_up){
                        ...
                        $result = $this->rsa_tambah_up_model->get_rsa_up($no_up);
                ...
                function check_exist_rba_unit($kode_unit_rba){
                        ...
                        $result = $this->rsa_tambah_up_model->get_rsa_up($kode_unit_rba);
                ...
                function saldo($tahun=''){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==3)||($this->check_session->get_level()==11))){
                            $data['main_menu']              = $this->load->view('main_menu','',TRUE);
                            $subdata['unit_usul'] 		= $this->rsa_tambah_up_model->get_up_unit($tahun);
                            $subdata['cur_tahun'] =  $tahun;
//                            $subdata['opt_sumber_dana'] 	= $this->option->sumber_dana();
    ...
    //			echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                ...
                function daftar_spp($tahun="",$kode_unit_subunit=""){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==13))){
                            $data['main_menu']              = $this->load->view('main_menu','',TRUE);
                            $subdata['cur_tahun']           = $tahun;
                            $subdata['daftar_spp']          = $this->rsa_tambah_up_model->get_daftar_spp($kode_unit_subunit,$tahun);
