<?php
	...
	class rsa_spumk extends CI_Controller{
/* -------------- Constructor ------------- */
	...
	public function __construct(){ 
		parent::__construct();
			...
			$this->load->model(array('rsa_spumk_model'));//,'setting_up_model'));
...
//                            $subdata['opt_sumber_dana'] 	= $this->option->sumber_dana();
    ...
    //			echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                ...
                function spm_tambah_ks_verifikator($kd_unit,$tahun){
				...
				$data['main_menu']	= $this->load->view('main_menu','',TRUE);		
                                ...
                                $dokumen_tambah_ks = $this->rsa_tambah_ks_model->check_dokumen_tambah_ks($kd_unit,$tahun);
                              
                                $subdata['doc_tambah_ks'] = $dokumen_tambah_ks;
                                
                                $nomor_trx_spp = $this->rsa_tambah_ks_model->get_nomor_spp($kd_unit,$tahun); 
...
//                                $subdata['detail_verifikator']  = $detail_verifikator ;
                                ...
                                $subdata['tgl_spm_kpa'] = $this->rsa_tambah_ks_model->get_tgl_spm_kpa($kd_unit,$tahun,$nomor_trx_spm);
                                
                                
                                
                                $subdata['tgl_spm_verifikator'] = $this->rsa_tambah_ks_model->get_tgl_spm_verifikator($kd_unit,$tahun,$nomor_trx_spm);
                                
                                $subdata['tgl_spm_kbuu'] = $this->rsa_tambah_ks_model->get_tgl_spm_kbuu($kd_unit,$tahun,$nomor_trx_spm);
                                
                                $subdata['ket'] = $this->rsa_tambah_ks_model->lihat_ket($kd_unit,$tahun);
...
//                                var_dump($subdata);die;
                ...
                function spm_tambah_ks_kbuu($kd_unit,$tahun){
...
//                                $subdata['detail_verifikator']  = $this->rsa_tambah_ks_model->get_verifikator($kd_unit,$tahun,$nomor_trx_spm);
    ...
    //                        var_dump($data_spm);die;
                                ...
                                if($this->rsa_tambah_ks_model->proses_nomor_spm_tambah_ks($kd_unit,$data)){
                                    ...
                                    $data_spp_spm = array(
                                        ...
                                        'nomor_trx_spp' => $this->rsa_tambah_ks_model->get_id_nomor_tambah_ks_by_nomor_trx($nomor_trx_spp),
                                        'str_nomor_trx_spp' => $nomor_trx_spp,
                                   ...
                                   // var_dump($data);die;
                                    ...
                                    if($this->rsa_tambah_ks_model->proses_tambah_ks($kd_unit,$data,$id_nomor_tambah_ks) && $this->rsa_tambah_ks_model->proses_trx_spp_spm($data_spp_spm) && $this->rsa_tambah_ks_model->proses_data_spm($data_spm)){
                                        $this->session->set_flashdata('message', '<div class="alert alert-success" style="text-align:center"><span class="glyphicon glyphicon glyphicon-ok" aria-hidden="true"></span> SPP/SPM KS anda berhasil disubmit.</div>');
                                        echo "sukses";
                                    }else{
                                        echo "gagal";
...
//                            var_dump($data);die;
                ...
                function proses_final_tambah_ks(){
                    if($this->input->post('proses')){
                        ...
                        $data = array(
                            'kode_unit_subunit' => $kd_unit,
                            'id_trx_nomor_tambah_ks' => $this->rsa_tambah_ks_model->get_id_nomor_tambah_ks('SPM',$kd_unit,$this->input->post('tahun')),
                            'posisi' => $proses,
                            'ket' => $ket,
                            'aktif' => '1',
                            'tahun' => $this->input->post('tahun'),
                        ...
                        $dokumen_tambah_ks = $this->rsa_tambah_ks_model->check_dokumen_tambah_ks($kd_unit,$this->input->post('tahun'));
...
//                            echo 'jos';die;
                            ...
                            if($this->rsa_tambah_ks_model->proses_tambah_ks($kd_unit,$data)){
                                
                                $this->load->model('kas_bendahara_model');
                                $saldo_bendahara = $this->kas_bendahara_model->get_kas_saldo_tambah_ks($kd_unit,$this->cur_tahun);
...
//                                    'nomor_trx_spm' => $this->rsa_tambah_ks_model->get_id_nomor_tambah_ks('SPM',$kd_unit,$tahun),//$nomor,
    ...
    //                            var_dump($data_spm_cair);die;
                                ...
                                if($this->rsa_tambah_ks_model->final_tambah_ks($kd_unit,$data) && $this->kas_undip_model->isi_trx($data_kas) && $this->rsa_tambah_ks_model->spm_cair($data_spm_cair) && $this->rsa_tambah_ks_model->tup_to_nihil($data_tambah_ks_to_nihil)){
                                    $this->session->set_flashdata('message', '<div class="alert alert-success" style="text-align:center"><span class="glyphicon glyphicon glyphicon-ok" aria-hidden="true"></span> SPP/SPM KS anda berhasil disubmit.</div>');
                                    echo "sukses";
                                }else{
                                    echo "gagal";
    ...
    //			echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                ...
                function daftar_spumk($tahun="",$kode_unit_subunit=""){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==4))){
                            $data['main_menu']              = $this->load->view('main_menu','',TRUE);
                            $subdata['cur_tahun']           = $tahun;
                            $subdata['daftar_spp']          = $this->rsa_spumk_model->get_daftar_spumk($kode_unit_subunit,$tahun);

                            // echo '<pre>';var_dump($subdata['daftar_spp']);echo '</pre>';die;

                            $data['main_content']           = $this->load->view("rsa_spumk/daftar_spumk",$subdata,TRUE);
                            /*  Load main template  */
    //          echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                            $this->load->view('main_template',$data);
                    }else{
                ...
                function daftar_spp_ppk($tahun="",$kode_unit_subunit=""){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==14))){
                            ...
                            $data['main_content']           = $this->load->view("rsa_tambah_ks/daftar_spp_ppk",$subdata,TRUE);
                            /*  Load main template  */
    //          echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                            $this->load->view('main_template',$data);
                    }else{
                ...
                function daftar_spp_kpa($tahun="",$kode_unit_subunit=""){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==2))){
                            ...
                            $data['main_content']           = $this->load->view("rsa_tambah_ks/daftar_spp_kpa",$subdata,TRUE);
                            /*  Load main template  */
    //          echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                            $this->load->view('main_template',$data);
                    }else{
