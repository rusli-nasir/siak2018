<?php
	...
	class rsa_tambah_ks extends CI_Controller{
/* -------------- Constructor ------------- */
	...
	public function __construct(){ 
		parent::__construct();
			...
			$this->load->model(array('rsa_tambah_ks_model'));//,'setting_up_model'));
		...
		function index(){
			$data['cur_tahun'] = $this->cur_tahun ;
                        ...
                        $data['main_content']	= $this->load->view('rsa_tambah_ks/index','',TRUE);
...
//                        $data['message']	= validation_errors();
		...
		function daftar_rsa_tambah_ks(){
			if($this->check_session->user_session() && $this->check_session->get_level()==2){
				...
				$data['main_menu']	= $this->load->view('main_menu','',TRUE);		
				$subdata_rsa_tambah_ks['result_rsa_tambah_ks'] 		= $this->rsa_tambah_ks_model->search_rsa_tambah_ks();
				$subdata['opt_unit_kepeg']		= $this->option->opt_unit_kepeg();
				$subdata['row_rsa_tambah_ks'] 			= $this->load->view("rsa_tambah_ks/row_rsa_tambah_ks",$subdata_rsa_tambah_ks,TRUE);
				$data['main_content'] 			= $this->load->view("rsa_tambah_ks/daftar_rsa_tambah_ks",$subdata,TRUE);
				$this->load->view('main_template',$data);
			}
			else{
		...
		function input_rsa_tambah_ks(){
			if($this->check_session->user_session() && $this->check_session->get_level()==13){
				...
				//$subdata['row_rsa_tambah_ks'] 			= $this->load->view("rsa_tambah_ks/row_rsa_tambah_ks",$subdata_rsa_tambah_ks,TRUE);
				$subdata['opt_unit_kepeg']		= $this->option->opt_unit_kepeg();
				$data['main_content'] 			= $this->load->view("rsa_tambah_ks/input_rsa_tambah_ks",$subdata,TRUE);
				$this->load->view('main_template',$data);
			}
			else{
				redirect('home','refresh');	// redirect ke halaman home
                ...
                $id_max_nomor_tambah_ks = $this->rsa_tambah_ks_model->get_nomor_spp_urut($this->check_session->get_unit(),$this->cur_tahun) ;

                $id_max_nomor_tambah_ks = $id_max_nomor_tambah_ks + 1 ;

                // echo  $id_max_nomor_tambah_ks; die;
                                
                                $dokumen_tambah_ks = $this->rsa_tambah_ks_model->check_dokumen_tambah_ks($this->check_session->get_unit(),$this->cur_tahun,$id_max_nomor_tambah_ks);
                               
                               // echo $dokumen_tambah_ks ; die ;
                                ...
                                if(($dokumen_tambah_ks == '')||($dokumen_tambah_ks == 'SPP-DITOLAK')||($dokumen_tambah_ks == 'SPM-DITOLAK-KPA')||($dokumen_tambah_ks == 'SPM-DITOLAK-VERIFIKATOR')||($dokumen_tambah_ks == 'SPM-DITOLAK-KBUU')){
...
//                                    var_dump($subdata['detail_pic']);die;
    ...
    //                                if(($dokumen_tambah_ks == '') || ($dokumen_tambah_ks == 'SPP-DITOLAK') || ($dokumen_tambah_ks == 'SPM-DITOLAK')){
    //                                    $subdata['siap_spp'] = 'ok';
    //                                }else{
    //                                    $subdata['siap_spp'] = 'no_ok';
    //                                }

                                    $subdata['tgl_spp'] = $this->rsa_tambah_ks_model->get_tgl_spp($this->check_session->get_unit(),$this->cur_tahun);

                                    $nomor_trx_ = $this->rsa_tambah_ks_model->get_nomor_next_spp($this->check_session->get_unit(),$this->cur_tahun);
                                    ...
                                    $nomor_trx = $this->rsa_tambah_ks_model->get_nomor_spp($this->check_session->get_unit(),$this->cur_tahun); 
                                    $data_spp = $this->rsa_tambah_ks_model->get_data_spp($nomor_trx);
                                    $subdata['detail_tambah_ks'] 	= array(
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
    ...
    //                                }
                                ...
                                $subdata['id_nomor_tambah_ks'] = $id_max_nomor_tambah_ks ;
                                
                                $subdata['doc_tambah_ks'] = $dokumen_tambah_ks;
                                $subdata['nomor_spp'] = $nomor_trx;
                                $subdata['ket'] = $this->rsa_tambah_ks_model->lihat_ket($this->check_session->get_unit(),$this->cur_tahun);
                                
//                                $urut_spp_pup = $this->rsa_tambah_ks_model->get_urut($this->check_session->get_unit(),'SPP',$this->cur_tahun);
                                
				//$subdata['opt_unit_kepeg']		= $this->option->opt_unit_kepeg();
//                                var_dump($subdata['detail_pic']);die;
				$data['main_content'] 			= $this->load->view("rsa_tambah_ks/spp_tambah_ks",$subdata,TRUE);
				$this->load->view('main_template',$data);
			} 
			else{
...
//                                $urut_spp_pup = $this->rsa_tambah_ks_model->get_urut($this->check_session->get_unit(),'SPP',$this->cur_tahun);
                ...
                //$subdata['opt_unit_kepeg']        = $this->option->opt_unit_kepeg();
//                                var_dump($subdata['detail_pic']);die;
                $data['main_content']           = $this->load->view("rsa_tambah_ks/spumk_tambah_ks",$subdata,TRUE);
                $this->load->view('main_template',$data);
            } 
            else{
                redirect('welcome','refresh');  // redirect ke halaman home
                ...
                function spp_tambah_ks_lihat($url = ''){
                ...
                //$subdata_rsa_up['result_rsa_up']      = $this->rsa_up_model->search_rsa_up();
                                ...
                                // $dokumen_lsnk = $this->rsa_lsnk_model->check_dokumen_lsnk($this->check_session->get_unit(),$this->cur_tahun);


                                $nomor_trx_spp = $url ;
                                
                                
                                $dokumen_tambah_ks = $this->rsa_tambah_ks_model->check_dokumen_tambah_ks_by_str_trx($url);
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
    ...
    //                                }
                                ...
                                $subdata['id_nomor_tambah_ks'] = $this->rsa_tambah_ks_model->get_id_nomor_tambah_ks_by_nomor_trx($nomor_trx);

                                $subdata['doc_tambah_ks'] = $dokumen_tambah_ks;
                                $subdata['nomor_spp'] = $nomor_trx;
                                $subdata['detail_ppk']  = $this->user_model->get_detail_rsa_user($kd_unit,'14');
                                // $subdata['ket'] = $this->rsa_tambah_ks_model->lihat_ket($this->check_session->get_unit(),$this->cur_tahun);
                                $subdata['ket'] = $this->rsa_tambah_ks_model->lihat_ket_by_nomor_trx($nomor_trx);
...
//                                var_dump($subdata['detail_pic']);die;
                ...
                $data['main_content']           = $this->load->view("rsa_tambah_ks/spp_tambah_ks_lihat",$subdata,TRUE);
                $this->load->view('main_template',$data);
            } 
            else{
                redirect('welcome','refresh');  // redirect ke halaman home
                ...
                $data['main_menu']  = $this->load->view('main_menu','',TRUE);       
                                ...
                                $id_nomor_tambah_ks = $this->rsa_tambah_ks_model->get_nomor_spp_urut_by_nomor_spp($nomor_trx_spp) ;
...
//                                $subdata['tgl_spm'] = $this->rsa_lsnk_model->get_tgl_spm($this->check_session->get_unit(),$this->cur_tahun);
                                ...
                                $nomor_trx_spm = $this->rsa_tambah_ks_model->get_spm_by_spp($nomor_trx_spp);
...
//                                    echo $data_spp->tgl_spp; die
                                ...
                                // SPM //
                                    ...
                                    // $nomor_trx_spm = $this->rsa_tambah_ks_model->get_nomor_spm($this->check_session->get_unit(),$this->cur_tahun);  

                                     // $id_nomor_tambah_ks_spm = $this->rsa_tambah_ks_model->get_nomor_spm_urut_by_nomor_spp($nomor_trx_spp) ;
                                    
                                    // $nomor_trx_spm = $this->rsa_tambah_ks_model->get_nomor_spm_by_id($id_nomor_tambah_ks_spm);  
                                    
                                    $data_spm = $this->rsa_tambah_ks_model->get_data_spm($nomor_trx_spm);
                                    $subdata['detail_spm_tambah_ks']    = array(
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
                                ...
                                $subdata['id_nomor_tambah_ks'] = $id_nomor_tambah_ks ;
                                ...
                                // $subdata['tgl_spm_kpa'] = $this->rsa_tambah_ks_model->get_tgl_spm_kpa($kd_unit ,$this->cur_tahun,$nomor_trx_spm);

                                $subdata['tgl_spm_kpa'] = $this->rsa_tambah_ks_model->get_tgl_spm_kpa_by_spp($nomor_trx_spp);
                                
                                // $subdata['tgl_spm_verifikator'] = $this->rsa_tambah_ks_model->get_tgl_spm_verifikator($kd_unit ,$this->cur_tahun,$nomor_trx_spm);

                                $subdata['tgl_spm_verifikator'] = $this->rsa_tambah_ks_model->get_tgl_spm_verifikator_by_spp($nomor_trx_spp);
                                
                                // $subdata['tgl_spm_kbuu'] = $this->rsa_tambah_ks_model->get_tgl_spm_kbuu($kd_unit ,$this->cur_tahun,$nomor_trx_spm);

                                $subdata['tgl_spm_kbuu'] = $this->rsa_tambah_ks_model->get_tgl_spm_kbuu_by_spp($nomor_trx_spp);
                                
                                // $subdata['ket'] = $this->rsa_tambah_ks_model->lihat_ket($this->check_session->get_unit(),$this->cur_tahun);
                                // echo $this->rsa_tambah_ks_model->lihat_ket_by_nomor_trx($nomor_trx_spp); die ;
                                $subdata['ket'] = $this->rsa_tambah_ks_model->lihat_ket_by_nomor_trx($nomor_trx_spp);
...
//                                var_dump($subdata);die;
				...
				//$subdata_rsa_tambah_ks['result_rsa_tambah_ks'] 		= $this->rsa_tambah_ks_model->search_rsa_tambah_ks();
//				$subdata['detail_tambah_ks'] 			= array(
//                                                                                    'nom' => $this->setting_tambah_ks_model->get_setting_tambah_ks($this->check_session->get_unit(),$this->cur_tahun),
//                                                                                    'terbilang' => $this->convertion->terbilang($this->setting_tambah_ks_model->get_setting_tambah_ks($this->check_session->get_unit(),$this->cur_tahun)), 
//                                                                                    
//                                                                                );
                                ...
                                $id_nomor_tambah_ks = $this->rsa_tambah_ks_model->get_nomor_spp_urut_by_nomor_spp($str_nomor_trx_spp) ;

                                // echo  $id_nomor_tambah_ks; die;
                                
                                $dokumen_tambah_ks = $this->rsa_tambah_ks_model->check_dokumen_tambah_ks($this->check_session->get_unit(),$this->cur_tahun,$id_nomor_tambah_ks);
...
//                                $subdata['detail_pic']  = $this->user_model->get_detail_rsa_user($this->check_session->get_unit(),'13');
                                ...
                                // $dokumen_tambah_ks = $this->rsa_tambah_ks_model->check_dokumen_tambah_ks($this->check_session->get_unit(),$this->cur_tahun);

                                $subdata['doc_tambah_ks'] = $dokumen_tambah_ks;
                                
//                                $subdata['tgl_spm'] = $this->rsa_tambah_ks_model->get_tgl_spm($this->check_session->get_unit(),$this->cur_tahun);
                                
                                // $nomor_trx_spp = $this->rsa_tambah_ks_model->get_nomor_spp($this->check_session->get_unit(),$this->cur_tahun); 
                               ...
                               // echo $nomor_trx_spp ;die;
                                ...
                                if(($dokumen_tambah_ks == 'SPP-DITOLAK') || ($dokumen_tambah_ks == 'SPM-DITOLAK-KPA') || ($dokumen_tambah_ks == 'SPP-FINAL') || ($dokumen_tambah_ks == 'SPP-DRAFT') || ($dokumen_tambah_ks == 'SPM-DRAFT-PPK') || ($dokumen_tambah_ks == 'SPM-DRAFT-KPA') || ($dokumen_tambah_ks == 'SPM-FINAL-VERIFIKATOR')  || ($dokumen_tambah_ks == 'SPM-FINAL-KBUU')){
...
//                                    echo $data_spp->tgl_spp; die
                                ...
                                if(($dokumen_tambah_ks == 'SPM-DITOLAK-KPA') || ($dokumen_tambah_ks == 'SPM-DRAFT-PPK') || ($dokumen_tambah_ks == 'SPM-DRAFT-KPA') || ($dokumen_tambah_ks == 'SPM-FINAL-VERIFIKATOR')  || ($dokumen_tambah_ks == 'SPM-FINAL-KBUU')){
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
                                    ...
                                    $nomor_trx_ = $this->rsa_tambah_ks_model->get_nomor_next_spm($this->check_session->get_unit(),$this->cur_tahun);
                                    setlocale(LC_ALL, 'id_ID.utf8');$bln = strftime("%h");
...
//                                    $subdata['detail_pic']  = $this->user_model->get_detail_rsa_user($this->check_session->get_unit(),'13');
                                    ...
                                    $subdata['detail_verifikator']  = $this->rsa_tambah_ks_model->get_verifikator(substr($this->check_session->get_unit(),0,2));
...
//                                    $subdata['tgl_spp'] = $data_spp->tgl_spp;
                                ...
                                $subdata['tgl_spm_kpa'] = $this->rsa_tambah_ks_model->get_tgl_spm_kpa($this->check_session->get_unit(),$this->cur_tahun,$nomor_trx_spm);
                                
                                $subdata['tgl_spm_verifikator'] = $this->rsa_tambah_ks_model->get_tgl_spm_verifikator($this->check_session->get_unit(),$this->cur_tahun,$nomor_trx_spm);
                                
                                $subdata['tgl_spm_kbuu'] = $this->rsa_tambah_ks_model->get_tgl_spm_kbuu($this->check_session->get_unit(),$this->cur_tahun,$nomor_trx_spm);
				...
				//$subdata['opt_unit_kepeg']		= $this->option->opt_unit_kepeg();
//                                var_dump($subdata);die;
				$data['main_content'] 			= $this->load->view("rsa_tambah_ks/spm_tambah_ks",$subdata,TRUE);
				$this->load->view('main_template',$data);
			} 
			else{
				redirect('welcome','refresh');	// redirect ke halaman home
                ...
                function spm_tambah_ks_kpa($url = ''){
				...
				//$subdata_rsa_tambah_ks['result_rsa_tambah_ks'] 		= $this->rsa_tambah_ks_model->search_rsa_tambah_ks();
                                ...
                                $nomor_trx_spp = $str_nomor_trx_spp ; // $this->rsa_tambah_ks_model->get_nomor_spp_by_id($id_nomor_tambah_ks); 
...
//                                $subdata['tgl_spm'] = $this->rsa_tambah_ks_model->get_tgl_spm($this->check_session->get_unit(),$this->cur_tahun);
                                ...
                                if(($dokumen_tambah_ks == 'SPM-DITOLAK-KPA') || ($dokumen_tambah_ks == 'SPM-DRAFT-PPK') || ($dokumen_tambah_ks == 'SPM-DRAFT-KPA') || ($dokumen_tambah_ks == 'SPM-FINAL-VERIFIKATOR')  || ($dokumen_tambah_ks == 'SPM-FINAL-KBUU')){
                                    ...
                                    $data_spm = $this->rsa_tambah_ks_model->get_data_spm($nomor_trx_spm);
                                    $subdata['detail_tambah_ks_spm'] 	= array(
                                                                    'nom' => $data_spm->jumlah_bayar,
                                                                    'terbilang' => $data_spm->terbilang, 
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
				...
				//$subdata['opt_unit_kepeg']		= $this->option->opt_unit_kepeg();
//                                var_dump($subdata);die;
				$data['main_content'] 			= $this->load->view("rsa_tambah_ks/spm_tambah_ks_kpa",$subdata,TRUE);
				$this->load->view('main_template',$data);
			} 
			else{
				redirect('welcome','refresh');	// redirect ke halaman home
...
//                            $subdata['unit_usul'] 		= $this->rsa_tambah_ks_model->get_tambah_ks_unit_usul_verifikator($user->id,$tahun);
                            $subdata['unit_usul'] 		= $this->rsa_tambah_ks_model->get_tambah_ks_unit_usul_verifikator($user->id,$tahun);
                            // echo '<pre>';var_dump($subdata['unit_usul']);echo '</pre>';die;
                            $subdata['subunit_usul']  		= $this->rsa_tambah_ks_model->get_tambah_ks_subunit_usul_verifikator($user->id,$tahun);
                            $subdata['cur_tahun'] =  $tahun;
//                            $subdata['opt_sumber_dana'] 	= $this->option->sumber_dana();
                            $data['main_content'] 		= $this->load->view("rsa_tambah_ks/daftar_unit",$subdata,TRUE);
                            /*	Load main template	*/
    			// echo '<pre>';var_dump($subdata['unit_usul']);echo '</pre>';die;
                            $this->load->view('main_template',$data);
                    }else{
                ...
                function daftar_unit_kbuu($tahun=''){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==11))){
                            $data['main_menu']              = $this->load->view('main_menu','',TRUE);
                            $subdata['unit_usul'] 		= $this->rsa_tambah_ks_model->get_tambah_ks_unit_usul($tahun);
                            // echo '<pre>';var_dump($subdata['unit_usul']);echo '</pre>';die;
                            $subdata['subunit_usul'] 		= $this->rsa_tambah_ks_model->get_tambah_ks_subunit_usul($tahun);
                            $subdata['cur_tahun'] =  $tahun;
//                            $subdata['opt_sumber_dana'] 	= $this->option->sumber_dana();
                            $data['main_content'] 		= $this->load->view("rsa_tambah_ks/daftar_unit_kbuu",$subdata,TRUE);
                            /*	Load main template	*/
    //			echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                ...
                function daftar_spm_kbuu($tahun="",$kode_unit_subunit=""){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==11))){
                            ...
                            $subdata['daftar_spm']          = $this->rsa_tambah_ks_model->get_daftar_spp($kode_unit_subunit,$tahun);
//                            echo '<pre>';var_dump($subdata['daftar_spp']);echo '</pre>';die;
                            $data['main_content']           = $this->load->view("rsa_tambah_ks/daftar_spm_kbuu",$subdata,TRUE);
                            /*  Load main template  */
    //          echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                            $this->load->view('main_template',$data);
                    }else{
                ...
                function daftar_spm_verifikator($tahun="",$kode_unit_subunit=""){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==14)||($this->check_session->get_level()==2)||($this->check_session->get_level()==3))){
                           ...
                           // echo '<pre>';var_dump($subdata['daftar_spm']);echo '</pre>';die;
                            $data['main_content']           = $this->load->view("rsa_tambah_ks/daftar_spm_verifikator",$subdata,TRUE);
                            /*  Load main template  */
    //          echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                            $this->load->view('main_template',$data);
                    }else{
                ...
                function spm_tambah_ks_verifikator($url = ''){
...
//                                echo $nomor_trx_spp ; die;
                                ...
                                // if(($dokumen_tambah_ks == 'SPP-FINAL') || ($dokumen_tambah_ks == 'SPP-DRAFT') || ($dokumen_tambah_ks == 'SPM-DRAFT-PPK') || ($dokumen_tambah_ks == 'SPM-DRAFT-KPA') || ($dokumen_tambah_ks == 'SPM-FINAL-VERIFIKATOR')  || ($dokumen_tambah_ks == 'SPM-FINAL-KBUU')){
...
//                                $subdata['tgl_spm'] = $this->rsa_tambah_ks_model->get_tgl_spm($kd_unit,$tahun);
                                ...
                                // if(($dokumen_tambah_ks == 'SPM-DRAFT-PPK') || ($dokumen_tambah_ks == 'SPM-DRAFT-KPA') || ($dokumen_tambah_ks == 'SPM-FINAL-VERIFIKATOR')  || ($dokumen_tambah_ks == 'SPM-FINAL-KBUU')){
                                    
                                    // $nomor_trx_spm = $this->rsa_tambah_ks_model->get_nomor_spm($kd_unit,$tahun);  
...
//                                $detail_verifikator  = $this->rsa_tambah_ks_model->get_verifikator($kd_unit,$tahun,$nomor_trx_spm);
...
//                                
                               // $subdata['detail_verifikator']  = $detail_verifikator ;
                                ...
                                $subdata['detail_verifikator']  = $this->rsa_tambah_ks_model->get_verifikator_by_spm($nomor_trx_spm);
                                ...
                                $subdata['ket'] = $this->rsa_tambah_ks_model->lihat_ket_by_str_trx($nomor_trx_spp);
                                
				//$subdata['opt_unit_kepeg']		= $this->option->opt_unit_kepeg();
//                                var_dump($subdata);die;
				$data['main_content'] 			= $this->load->view("rsa_tambah_ks/spm_tambah_ks_verifikator",$subdata,TRUE);
				$this->load->view('main_template',$data);
			} 
			else{
				redirect('welcome','refresh');	// redirect ke halaman home
                ...
                function spm_tambah_ks_kbuu($url = ''){
...
//                                var_dump( $subdata['kas_undip']);die;
				...
				//$subdata['opt_unit_kepeg']		= $this->option->opt_unit_kepeg();
//                                var_dump($subdata);die;
				$data['main_content'] 			= $this->load->view("rsa_tambah_ks/spm_tambah_ks_kbuu",$subdata,TRUE);
				$this->load->view('main_template',$data);
			} 
			else{
				redirect('welcome','refresh');	// redirect ke halaman home
...
//                        echo $html;die;
//                        $h = $this->load->view("rsa_tambah_ks/cetak",array('html'=>$html),TRUE);
//                        echo $h;
                        $this->load->library('Pdfgen'); 
                        $this->pdfgen->cetak($html,'SPP_tambah_ks_'.$unit.'_'.''.$tahun);
                    }
...
//                        echo $html;die;
                        $this->load->library('Pdfgen'); 
                        $this->pdfgen->cetak($html,'SPM_tambah_ks_');
                    }
                }
                
                function usulkan_spp_tambah_ks(){
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==13))){
                        if($this->input->post('proses')){
                            ...
                            $id_nomor_tambah_ks = $this->input->post('id_nomor_tambah_ks') ;
                            ...
                            $data = array(
                                ...
                                'bulan' => $bulan,
                                'tahun' => $tahun,
//                                'urut' => $this->rsa_tambah_ks_model->get_urut($kd_unit,$jenis,$tahun)
                            );
                           ...
                           // var_dump($data_spp);die;
                            ...
                            $dokumen_tambah_ks = $this->rsa_tambah_ks_model->check_dokumen_tambah_ks($kd_unit,$tahun,$id_nomor_tambah_ks);

                            if(($dokumen_tambah_ks == '')||($dokumen_tambah_ks == 'SPP-DITOLAK')||($dokumen_tambah_ks == 'SPM-DITOLAK-KPA')||($dokumen_tambah_ks == 'SPM-DITOLAK-VERIFIKATOR')||($dokumen_tambah_ks == 'SPM-DITOLAK-KBUU')||($dokumen_tambah_ks == 'SPM-FINAL-KBUU')){

        //                        var_dump($data_spp);die;

    //                            echo 'jos';die;

                                if($this->rsa_tambah_ks_model->proses_nomor_spp_tambah_ks($kd_unit,$data) ){
                                    
                                    $data_spp = array(
                                        'kode_unit_subunit' => $kd_unit,
                                        // 'nomor_trx_spp' => $this->rsa_tambah_ks_model->get_id_nomor_tambah_ks($jenis,$kd_unit,$this->cur_tahun),
                                        'nomor_trx_spp' => $this->rsa_tambah_ks_model->get_id_nomor_tambah_ks_by_nomor_trx($nomor_trx),
                                        'str_nomor_trx' => $nomor_trx,
                                        'jumlah_bayar' => $this->input->post('jumlah_bayar'),
                                        'terbilang' => $this->input->post('terbilang'),
                                        'untuk_bayar' => $this->input->post('untuk_bayar'),
                                    ...
                                    $data = array(
                                        ...
                                        'id_trx_nomor_tambah_ks' => $this->rsa_tambah_ks_model->get_id_nomor_tambah_ks_by_nomor_trx($nomor_trx),
                                        'ket' => $ket,
                                        'aktif' => '1',
                                        'tahun' => $tahun,
                                        'tgl_proses' => date("Y-m-d H:i:s")
                                   ...
                                   // var_dump($data);die;
                                    ...
                                    if($this->rsa_tambah_ks_model->proses_tambah_ks($kd_unit,$data,$id_nomor_tambah_ks)&& $this->rsa_tambah_ks_model->proses_data_spp($data_spp)){
                ...
                function usulkan_spm_tambah_ks(){
...
//                                'urut' => $this->rsa_tambah_ks_model->get_urut($kd_unit,$jenis,$tahun)
                           ...
                           // var_dump($data);die;
                            ...
                            if($dokumen_tambah_ks == 'SPP-FINAL'){
    //                        $this->rsa_tambah_ks_model->proses_data_spm($data_spm);
    //                        var_dump($data_spm);die;
                                ...
                                if($this->rsa_tambah_ks_model->proses_nomor_spm_tambah_ks($kd_unit,$data)){
                                    ...
                                    $data_spp_spm = array(
                                        'kode_unit_subunit' => $kd_unit,
                                        // 'nomor_trx_spp' => $this->rsa_tambah_ks_model->get_id_nomor_tambah_ks('SPP',$kd_unit,$this->cur_tahun),
                                   ...
                                   // var_dump($data);die;
                                    ...
                                    if($this->rsa_tambah_ks_model->proses_tambah_ks($kd_unit,$data,$id_trx_nomor_tambah_ks) && $this->rsa_tambah_ks_model->proses_trx_spp_spm($data_spp_spm) && $this->rsa_tambah_ks_model->proses_data_spm($data_spm)){
                                        $this->session->set_flashdata('message', '<div class="alert alert-success" style="text-align:center"><span class="glyphicon glyphicon glyphicon-ok" aria-hidden="true"></span> SPP/SPM KS anda berhasil disubmit.</div>');
                                        echo "sukses";
                                    }else{
                                        echo "gagal";
                ...
                function proses_spp_tambah_ks(){
                    if($this->input->post('proses')){
                        ...
                        if(($proses == 'SPP-FINAL')&&($dokumen_tambah_ks == 'SPP-DRAFT')){
                            $ok = TRUE ;
                        }elseif(($proses == 'SPP-DITOLAK')&&($dokumen_tambah_ks == 'SPP-DRAFT')){
                            $ok = TRUE ;
                        }else{
                            $ok = FALSE;
                        }
                        ...
                        if($ok){
//                            echo 'jos'; die;
                            if($this->rsa_tambah_ks_model->proses_tambah_ks($kd_unit,$data,$id_nomor_tambah_ks)){
                                $this->session->set_flashdata('message', '<div class="alert alert-success" style="text-align:center"><span class="glyphicon glyphicon glyphicon-ok" aria-hidden="true"></span> SPP/SPM KS anda berhasil disubmit.</div>');
                                echo "sukses";
                            }else{
                                echo "gagal";
...
//                            var_dump($data);die;
                        ...
                        if(($proses == 'SPM-DRAFT-KPA')&&($dokumen_tambah_ks == 'SPM-DRAFT-PPK')){
                            $ok = TRUE ;
                        }elseif(($proses == 'SPM-DITOLAK-KPA')&&($dokumen_tambah_ks == 'SPM-DRAFT-PPK')){
                            $ok = TRUE ;
                        }elseif(($proses == 'SPM-FINAL-VERIFIKATOR')&&($dokumen_tambah_ks == 'SPM-DRAFT-KPA')){
                            $ok = TRUE ;
                        }elseif(($proses == 'SPM-DITOLAK-VERIFIKATOR')&&($dokumen_tambah_ks == 'SPM-DRAFT-KPA')){
                            $ok = TRUE ;
                        }elseif(($proses == 'SPM-FINAL-KBUU')&&($dokumen_tambah_ks == 'SPM-FINAL-VERIFIKATOR')){
                            $ok = TRUE ;
                        }elseif(($proses == 'SPM-DITOLAK-KBUU')&&($dokumen_tambah_ks == 'SPM-FINAL-VERIFIKATOR')){
                            $ok = TRUE ;
                        }elseif(($proses == 'SPM-FINAL-BUU')&&($dokumen_tambah_ks == 'SPM-FINAL-KBUU')){
                            $ok = TRUE ;
                        }elseif(($proses == 'SPM-DITOLAK-BUU')&&($dokumen_tambah_ks == 'SPM-FINAL-KBUU')){
                            $ok = TRUE ;
                        }else{
                            $ok = FALSE;
                        }
...
//                                        'nomor_trx_spm' => $this->rsa_tambah_ks_model->get_id_nomor_tambah_ks('SPM',$kd_unit,$tahun),//$nomor_[0],
//                                        'str_nomor_trx_spm' => $nomor_trx,
//                                        'kode_unit_subunit' => $kd_unit,
//                                        'jenis_trx' => 'PUP',
...
//                            var_dump($data);die;
                            ...
                            $nomor_trx_spm = $this->rsa_tambah_ks_model->get_id_nomor_tambah_ks_by_nomor_trx($nomor_trx) ;
                            ...
                            if($this->rsa_tambah_ks_model->proses_tambah_ks($kd_unit,$data,$id_nomor_tambah_ks)){
                                if($this->check_session->get_level() == 3){
                                    $verifikator = $this->user_model->get_detail_rsa_user_by_username($this->check_session->get_username());
                                    $data_verifikator = array(
                                        'nomor_trx_spm' => $nomor_trx_spm ,//$this->rsa_tambah_ks_model->get_id_nomor_tambah_ks('SPM',$kd_unit,$tahun),//$nomor_[0],
                                        'str_nomor_trx_spm' => $nomor_trx,
                                        'kode_unit_subunit' => $kd_unit,
                                        'jenis_trx' => 'KS',
                                        'id_rsa_user_verifikator' => $verifikator->id,
                                    ...
                                    if($this->rsa_tambah_ks_model->proses_verifikator_tambah_ks($data_verifikator)){
                                        $this->session->set_flashdata('message', '<div class="alert alert-success" style="text-align:center"><span class="glyphicon glyphicon glyphicon-ok" aria-hidden="true"></span> SPP/SPM KS anda berhasil disubmit.</div>');
                                        echo "sukses";
                                    }else{
                                        echo "gagal";
                ...
                function proses_final_tambah_ks(){
                    if($this->input->post('proses')){
                        $proses = $this->input->post('proses');
                        ...
                        $dokumen_tambah_ks = $this->rsa_tambah_ks_model->check_dokumen_tambah_ks_by_str_trx($nomor_trx_spp);

                        
                        
                        if(($proses == 'SPM-FINAL-KBUU')&&($dokumen_tambah_ks == 'SPM-FINAL-VERIFIKATOR')){
                            $ok = TRUE ;
                        }else{
                            $ok = FALSE;
                        }
...
//                            echo $saldo_ben->saldo;die;
                            ...
                            if($this->rsa_tambah_ks_model->proses_tambah_ks($kd_unit,$data,$id_trx_nomor_tambah_ks)){
                                ...
                                $saldo_pic_akhir =  $saldo_pic + $debet ;
                                ...
                                $data = array(
                                    ...
                                    'kd_akun_kas' => '131111',
                                    'kd_unit' => $kd_unit,
                                    'deskripsi' => 'KS UNIT ' . $kd_unit,//$this->input->post('deskripsi'),
                                    'jenis' => 'KS',
                                ...
                                $data_spm_cair = array(
                                    'no_urut' => $this->rsa_tambah_ks_model->get_next_urut_spm_cair($this->input->post('tahun')),
//                                    'nomor_trx_spm' => $this->rsa_up_model->get_id_nomor_up('SPM',$kd_unit,$this->input->post('tahun')),//,$nomor,
    ...
    //                            var_dump($data_spm_cair);die;
                                ...
                                $data_ks_to_nihil = array(
                                    'kode_unit_subunit' => $kd_unit,
                                    'str_nomor_trx_spm_tambah_ks' => $nomor_trx_spm,
                                    'tgl_proses_tambah_ks' => date('Y-m-d H:i:s'),
                                    'tahun' => $this->input->post('tahun'),
                                    'status' => '1',
                                );

                                if($this->rsa_tambah_ks_model->final_tambah_ks($kd_unit,$data) && $this->kas_undip_model->isi_trx($data_kas) && $this->rsa_tambah_ks_model->spm_cair($data_spm_cair) && $this->rsa_tambah_ks_model->ks_to_nihil($data_ks_to_nihil)){

                                // if($this->kas_undip_model->isi_trx($data_kas) && $this->rsa_tambah_ks_model->spm_cair($data_spm_cair)){
		...
		function exec_add_rsa_tambah_ks(){
				...
				if($this->check_session->user_session() && $this->check_session->get_level()==2){
						...
						// $kode = strlen(($top_unit->kode_unit+1)+"")==1?"0".($top_unit->kode_unit+1):$top_unit->kode_unit+1;
                                        if($this->input->post()){
                                            ...
                                            $this->form_validation->set_rules('no_tambah_ks','no_tambah_ks','required|min_length[2]|callback_check_exist_rsa_tambah_ks');
                                            ...
                                            if ($this->form_validation->run()){
												...
												'no_tambah_ks' => form_prep($this->input->post('no_tambah_ks')),
							                    ...
							                    $this->rsa_tambah_ks_model->add_rsa_tambah_ks($data);
                                                echo "berhasil";
		...
		function confirmation_delete(){
			if($this->check_session->user_session() && $this->check_session->get_level()==100){
				if($this->uri->segment(3)!='99'){ //jika bukan user pusat
					$data['url']		= site_url('rsa_tambah_ks/exec_delete/'.$this->uri->segment(3));
		...
		if($this->check_session->user_session() && $this->check_session->get_level()==100){
			if($this->uri->segment(3)){
				if($this->rsa_tambah_ks_model->delete_rsa_tambah_ks(array('no'=>$this->uri->segment(3)))){
					$data['class']	 = 'option box';
					$data['class_btn']	 = 'ya';
		...
		function get_row_rsa_tambah_ks(){
			if($this->check_session->user_session() && $this->check_session->get_level()==100){
				$data['result_rsa_tambah_ks'] = $this->rsa_tambah_ks_model->get_rsa_tambah_ks();
				$this->load->view('rsa_tambah_ks/row_rsa_tambah_ks',$data);
			}
			else{
				show_404('page');
			}
		...
		function filter_rsa_tambah_ks(){
			if($this->check_session->user_session() && $this->check_session->get_level()==100){
				$keyword = form_prep($this->input->post('keyword'));
				$data['result_rsa_tambah_ks'] = $this->rsa_tambah_ks_model->search_rsa_tambah_ks($keyword);
				$this->load->view('rsa_tambah_ks/row_rsa_tambah_ks',$data);
			}
			else{
				show_404('page');
               ...
               function check_exist_rsa_tambah_ks($no_tambah_ks){

                        $this->form_validation->set_message('check_exist_rsa_tambah_ks', 'Maaf, kode RSA tsb sudah terdaftar');

                        $result = $this->rsa_tambah_ks_model->get_rsa_tambah_ks($no_tambah_ks);
                ...
                function check_exist_rba_unit($kode_unit_rba){
                        ...
                        $result = $this->rsa_tambah_ks_model->get_rsa_tambah_ks($kode_unit_rba);
                ...
                function saldo($tahun=''){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==3)||($this->check_session->get_level()==11))){
                            $data['main_menu']              = $this->load->view('main_menu','',TRUE);
                            $subdata['unit_usul'] 		= $this->rsa_tambah_ks_model->get_tambah_ks_unit($tahun);
                            $subdata['cur_tahun'] =  $tahun;
//                            $subdata['opt_sumber_dana'] 	= $this->option->sumber_dana();
                            $data['main_content'] 		= $this->load->view("rsa_tambah_ks/saldo",$subdata,TRUE);
                            /*	Load main template	*/
    //			echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                            $this->load->view('main_template',$data);
                    }else{
                ...
                function daftar_spp($tahun="",$kode_unit_subunit=""){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==13))){
                            $data['main_menu']              = $this->load->view('main_menu','',TRUE);
                            $subdata['cur_tahun']           = $tahun;
                            $subdata['daftar_spp']          = $this->rsa_tambah_ks_model->get_daftar_spp($kode_unit_subunit,$tahun);

                            // echo '<pre>';var_dump($subdata['daftar_spp']);echo '</pre>';die;

                            $data['main_content']           = $this->load->view("rsa_tambah_ks/daftar_spp",$subdata,TRUE);
                            /*	Load main template	*/
    //			echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                            $this->load->view('main_template',$data);
                    }else{
                ...
                function daftar_spumk($tahun="",$kode_unit_subunit=""){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==4))){
                            ...
                            $data['main_content']           = $this->load->view("rsa_tambah_ks/daftar_spumk",$subdata,TRUE);
                            /*  Load main template  */
    //          echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                            $this->load->view('main_template',$data);
                    }else{
                ...
                function daftar_spm($tahun="",$kode_unit_subunit=""){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==14))){
                            ...
                            $data['main_content']           = $this->load->view("rsa_tambah_ks/daftar_spm",$subdata,TRUE);
                            /*  Load main template  */
    //          echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                            $this->load->view('main_template',$data);
                    }else{
                ...
                function daftar_spm_kpa($tahun="",$kode_unit_subunit=""){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==2))){
                            ...
                            $data['main_content']           = $this->load->view("rsa_tambah_ks/daftar_spm_kpa",$subdata,TRUE);
                            /*  Load main template  */
    //          echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                            $this->load->view('main_template',$data);
                    }else{
                ...
                function get_status_nihil(){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==13))){
                           // echo '5' ; 
                        $status = $this->rsa_tambah_ks_model->get_status_nihil($this->check_session->get_unit(),$this->cur_tahun);
                ...
                function get_notif_approve(){
                    ...
                    if($this->check_session->user_session()){
                        ...
                        $notif = $this->rsa_tambah_ks_model->get_notif_approve($kode_unit_subunit,$level,$user->id);
                ...
                function get_data_untuk_pekerjaan(){
                    ...
                    $kode_unit_subunit = $this->check_session->get_unit();
                    $data = $this->rsa_tambah_ks_model->get_data_untuk_pekerjaan($d['untuk_bayar'],$kode_unit_subunit,$this->cur_tahun);
                    $json = [];
                ...
                function get_data_penerima(){
                    $q = $this->input->get('query');
                    $kode_unit_subunit = $this->check_session->get_unit();
                    $data = $this->rsa_tambah_ks_model->get_data_penerima($q,$kode_unit_subunit,$this->cur_tahun);
                    $json = [];
                ...
                function get_notif_approve_all(){
                    ...
                    if($this->check_session->user_session()){
                        ...
                        $notif_tambah_ks = $this->rsa_tambah_ks_model->get_notif_approve($kode_unit_subunit,$level,$user->id);

                        echo $notif_tambah_ks ;
                    }
