...
/* -------------- Constructor ------------- */
	...
	public function __construct(){ 
		parent::__construct();
			...
			$this->load->model(array('rsa_tup_model','akun_model','kas_undip_model','kas_bendahara_model'));//,'setting_tup_model'));
...
//                        $data['message']	= validation_errors();
		...
		function input_rsa_tup(){
			if($this->check_session->user_session() && $this->check_session->get_level()==13){
				...
				$data['main_menu']	= $this->load->view('main_menu','',TRUE);		
				//$subdata_rsa_tup['result_rsa_tup'] 		= $this->rsa_tup_model->search_rsa_tup();
				//$subdata['row_rsa_tup'] 			= $this->load->view("rsa_permintaan/row_rsa_tup",$subdata_rsa_tup,TRUE);
				$subdata['opt_unit_kepeg']		= $this->option->opt_unit_kepeg();
				$data['main_content'] 			= $this->load->view("rsa_permintaan/input_rsa_tup",$subdata,TRUE);
				$this->load->view('main_template',$data);
			}
			else{
                ...
                $id_max_nomor = $this->rsa_tup_model->get_nomor_spp_urut($this->check_session->get_unit(),$this->cur_tahun) ;

                $id_max_nomor = $id_max_nomor + 1 ;

                // echo  $id_max_nomor_tup; die;
                                
                                $dokumen = '';//$this->rsa_tup_model->check_dokumen_tup($this->check_session->get_unit(),$this->cur_tahun,$id_max_nomor_tup);
...
//                                        'tgl_spp' => $rsa_user->tgl_spp,
                ...
                $id_max_nomor_tup = $this->rsa_tup_model->get_nomor_spp_urut($this->check_session->get_unit(),$this->cur_tahun) ;

                $id_max_nomor_tup = $id_max_nomor_tup + 1 ;

                // echo  $id_max_nomor_tup; die;
                                
                                $dokumen_tup = $this->rsa_tup_model->check_dokumen_tup($this->check_session->get_unit(),$this->cur_tahun,$id_max_nomor_tup);
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
    ...
    //                                }
                                ...
                                $subdata['id_nomor_tup'] = $id_max_nomor_tup ;
                                
                                $subdata['doc_tup'] = $dokumen_tup;
                                $subdata['nomor_spp'] = $nomor_trx;
                                $subdata['ket'] = $this->rsa_tup_model->lihat_ket($this->check_session->get_unit(),$this->cur_tahun);
                                
//                                $urut_spp_tup = $this->rsa_tup_model->get_urut($this->check_session->get_unit(),'SPP',$this->cur_tahun);
                                
                //$subdata['opt_unit_kepeg']        = $this->option->opt_unit_kepeg();
//                                var_dump($subdata['detail_pic']);die;
                $data['main_content']           = $this->load->view("rsa_permintaan/spumk_tup",$subdata,TRUE);
                $this->load->view('main_template',$data);
            } 
            else{
                redirect('welcome','refresh');  // redirect ke halaman home
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
                                ...
                                $subdata['id_nomor_tup'] = $this->rsa_tup_model->get_id_nomor_tup_by_nomor_trx($nomor_trx);

                                $subdata['doc'] = $dokumen;
                                $subdata['nomor_spp'] = $nomor_trx;
                                $subdata['detail_ppk']  = $this->user_model->get_detail_rsa_user($kd_unit,'14');

                                $subdata['ket'] = $this->rsa_tup_model->lihat_ket_by_nomor_trx($nomor_trx);
                ...
                function spm_tup_lihat_99($url,$kd_unit,$tahun,$id_kuitansi = null){
                ...
                $data['main_menu']  = $this->load->view('main_menu','',TRUE);       
                                ...
                                $nomor_trx_spm = $this->rsa_tup_model->get_spm_by_spp($nomor_trx_spp);
...
//                                    echo $data_spp->tgl_spp; die
                                ...
                                // SPM //
                                    ...
                                    // $nomor_trx_spm = $this->rsa_tup_model->get_nomor_spm($this->check_session->get_unit(),$this->cur_tahun);  
                                     ...
                                     // $id_nomor_tup_spm = $this->rsa_tup_model->get_nomor_spm_urut_by_nomor_spp($nomor_trx_spp) ;
                                    
                                    // $nomor_trx_spm = $this->rsa_tup_model->get_nomor_spm_by_id($id_nomor_tup_spm);  
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
                                ...
                                // $subdata['tgl_spm_kpa'] = $this->rsa_tup_model->get_tgl_spm_kpa($kd_unit ,$this->cur_tahun,$nomor_trx_spm);

                                $subdata['tgl_spm_kpa'] = $this->rsa_tup_model->get_tgl_spm_kpa_by_spp($nomor_trx_spp);
                                
                                // $subdata['tgl_spm_verifikator'] = $this->rsa_tup_model->get_tgl_spm_verifikator($kd_unit ,$this->cur_tahun,$nomor_trx_spm);

                                $subdata['tgl_spm_verifikator'] = $this->rsa_tup_model->get_tgl_spm_verifikator_by_spp($nomor_trx_spp);
                                
                                // $subdata['tgl_spm_kbuu'] = $this->rsa_tup_model->get_tgl_spm_kbuu($kd_unit ,$this->cur_tahun,$nomor_trx_spm);

                                $subdata['tgl_spm_kbuu'] = $this->rsa_tup_model->get_tgl_spm_kbuu_by_spp($nomor_trx_spp);
                                
                                // $subdata['ket'] = $this->rsa_tup_model->lihat_ket($this->check_session->get_unit(),$this->cur_tahun);
                                // echo $this->rsa_tup_model->lihat_ket_by_nomor_trx($nomor_trx_spp); die ;
                                $subdata['ket'] = $this->rsa_tup_model->lihat_ket_by_nomor_trx($nomor_trx_spp);
...
//                                var_dump($subdata);die;
               ...
               $this->load->view('akuntansi/content_template',$data);
				...
				$data['main_menu']	= $this->load->view('main_menu','',TRUE);	
                                ...
                                $id_nomor = $this->rsa_tup_model->get_nomor_spp_urut_by_nomor_spp($str_nomor_trx_spp) ;
...
//                                                                                );
                                ...
                                $dokumen = 'SPP-FINAL' ; // $this->rsa_tup_model->check_dokumen_tup($this->check_session->get_unit(),$this->cur_tahun,$id_nomor_tup);
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
                                ...
                                /////////
                                    ...
                                    $nomor_trx_ = $this->rsa_tup_model->get_nomor_next_spm($this->check_session->get_unit(),$this->cur_tahun);
                                    setlocale(LC_ALL, 'id_ID.utf8');$bln = strftime("%h");$thn = strftime("%Y");
                                    $nomor_trx_spm = $nomor_trx_.'/'.$this->check_session->get_alias().'/'.'SPM-TUP'.'/'.strtoupper($bln).'/'.$thn;
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
				...
				//$subdata_rsa_tup['result_rsa_tup'] 		= $this->rsa_tup_model->search_rsa_tup();
                                ...
                                // echo  $id_nomor_tup; die;
                                
                                $dokumen = 'SPM-DRAFT-PPK';//this->rsa_tup_model->check_dokumen_tup($this->check_session->get_unit(),$this->cur_tahun,$id_nomor_tup);
                                ...
                                // $dokumen_tup = $this->rsa_tup_model->check_dokumen_tup($this->check_session->get_unit(),$this->cur_tahun,$id_nomor_tup);
                                
                                $nomor_trx_spp = $str_nomor_trx_spp ; // $this->rsa_tup_model->get_nomor_spp_by_id($id_nomor_tup); 
    ...
    //			echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                ...
                function daftar_spm_kbuu($tahun="",$kode_unit_subunit=""){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==11))){
                            ...
                            $subdata['daftar_spm']          = $this->rsa_tup_model->get_daftar_spp($kode_unit_subunit,$tahun);
//                            echo '<pre>';var_dump($subdata['daftar_spp']);echo '</pre>';die;
    ...
    //          echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                ...
                function spm_tup_verifikator($url = ''){
                ...
                $data['main_menu']  = $this->load->view('main_menu','',TRUE); 
                                ...
                                $dokumen =  'SPM-DRAFT-KPA' ; //$this->rsa_tup_model->check_dokumen_tup_by_str_trx($url);
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
                                ...
                                $subdata['ket'] = $this->rsa_tup_model->lihat_ket_by_str_trx($nomor_trx_spp);
                ...
                $data['main_menu']  = $this->load->view('main_menu','',TRUE); 
                                ...
                                $dokumen = 'SPM-FINAL-VERIFIKATOR';//$dokumen_tup;
                ...
                function usulkan_spp_tup(){
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==13))){
                        if($this->input->post('proses')){
                            ...
                            $id_nomor_tup = $this->input->post('id_nomor_tup') ;
                            ...
                            $data = array(
                                ...
                                'bulan' => $bulan,
                                'tahun' => $tahun,
//                                'urut' => $this->rsa_tup_model->get_urut($kd_unit,$jenis,$tahun)
                            );
                            
                            $dokumen_tup = $this->rsa_tup_model->check_dokumen_tup_by_str_trx($nomor_trx);

                            $check_exist_tup = $this->rsa_tup_model->check_exist_tup($nomor_trx,$this->cur_tahun);

                            if((!$check_exist_tup)&&($dokumen_tup == '')){
                                ...
                                if($this->rsa_tup_model->proses_nomor_spp_tup($kd_unit,$data) ){
                                    ...
                                    $data_spp = array(
                                        ...
                                        'nomor_trx_spp' => $this->rsa_tup_model->get_id_nomor_tup_by_nomor_trx($nomor_trx),
                                        'str_nomor_trx' => $nomor_trx,
                                    ...
                                    $data = array(
                                        ...
                                        'id_trx_nomor_tup' => $this->rsa_tup_model->get_id_nomor_tup_by_nomor_trx($nomor_trx),
                                        'ket' => $ket,
                                        'aktif' => '1',
                                        'tahun' => $tahun,
                                        'tgl_proses' => date("Y-m-d H:i:s")
                                   ...
                                   // var_dump($data);die;
                                    ...
                                    if($this->rsa_tup_model->proses_tup($kd_unit,$data,$id_nomor_tup)&& $this->rsa_tup_model->proses_data_spp($data_spp)){
...
//                                'urut' => $this->rsa_tup_model->get_urut($kd_unit,$jenis,$tahun)
                            ...
                            $dokumen_tup = $this->rsa_tup_model->check_dokumen_tup_by_str_trx($nomor_trx_spp);

                            $check_exist_tup = $this->rsa_tup_model->check_exist_tup($nomor_trx,$this->cur_tahun);
                            
                            
                            if((!$check_exist_tup)&&($dokumen_tup == 'SPP-FINAL')){


                                if($this->rsa_tup_model->proses_nomor_spm_tup($kd_unit,$data)){

                                    $id_trx_nomor_tup = $this->rsa_tup_model->get_id_nomor_tup_by_nomor_trx($nomor_trx_spp) ;
                                    $id_trx_nomor_tup_spm = $this->rsa_tup_model->get_id_nomor_tup_by_nomor_trx($nomor_trx) ;

                                    $data_spm = array(
                                        'kode_unit_subunit' => $kd_unit,
                                        // 'nomor_trx_spm' => $this->rsa_tup_model->get_id_nomor_tup($jenis,$kd_unit,$this->cur_tahun),
                                        'nomor_trx_spm' => $id_trx_nomor_tup_spm,
                                        'str_nomor_trx' => $nomor_trx,
                                        'jumlah_bayar' => $this->input->post('jumlah_bayar'),
                                        'terbilang' => $this->input->post('terbilang'),
                                        'untuk_bayar' => $this->input->post('untuk_bayar'),
                                    ...
                                    $data_spp_spm = array(
                                        'kode_unit_subunit' => $kd_unit,
                                        // 'nomor_trx_spp' => $this->rsa_tup_model->get_id_nomor_tup('SPP',$kd_unit,$this->cur_tahun),
                                        'nomor_trx_spp' => $id_trx_nomor_tup,
                                        'str_nomor_trx_spp' => $nomor_trx_spp,
                                        // 'nomor_trx_spm' => $this->rsa_tup_model->get_id_nomor_tup('SPM',$kd_unit,$this->cur_tahun),
                                        'nomor_trx_spm' => $id_trx_nomor_tup_spm,
                                    ...
                                    $data = array(
                                        ...
                                        'posisi' => $proses,
                                        // 'id_trx_nomor_tup' => $this->rsa_tup_model->get_id_nomor_tup($jenis,$kd_unit,$this->cur_tahun),
                                        'id_trx_nomor_tup' => $id_trx_nomor_tup,
                                        'id_trx_nomor_tup_spm' => $id_trx_nomor_tup_spm,
                                        'ket' => $ket,
                                        'aktif' => '1',
                                        'tahun' => $tahun,
                                        'tgl_proses' => date("Y-m-d H:i:s")
                                   ...
                                   // var_dump($data);die;
                                    ...
                                    if($this->rsa_tup_model->proses_tup($kd_unit,$data,$id_trx_nomor_tup) && $this->rsa_tup_model->proses_trx_spp_spm($data_spp_spm) && $this->rsa_tup_model->proses_data_spm($data_spm)){
                                        $this->session->set_flashdata('message', '<div class="alert alert-success" style="text-align:center"><span class="glyphicon glyphicon glyphicon-ok" aria-hidden="true"></span> SPP/SPM anda berhasil disubmit.</div>');
                                        echo "sukses";
                                    }else{
                                        echo "gagal";
                ...
                function proses_spp_tup(){
                    if($this->input->post('proses')){
                        ...
                        $dokumen = $this->rsa_tup_model->check_dokumen_tup_by_str_trx($nomor_trx);
                        ...
                        if($ok){
                            ...
                            if($this->rsa_tup_model->proses_tup($kd_unit,$data,$id_nomor_tup)){
                                $this->session->set_flashdata('message', '<div class="alert alert-success" style="text-align:center"><span class="glyphicon glyphicon glyphicon-ok" aria-hidden="true"></span> SPP/SPM anda berhasil disubmit.</div>');
                                echo "sukses";
                            }else{
                                echo "gagal";
                ...
                function proses_spm_tup(){
                    if($this->input->post('proses')){
                        ...
                        $dokumen = $this->rsa_tup_model->check_dokumen_tup($kd_unit,$tahun,$id_nomor_tup);
                        ...
                        if($ok){
                            ...
                            $nomor_trx_spm = $this->rsa_tup_model->get_id_nomor_tup_by_nomor_trx($nomor_trx) ;
                            ...
                            if($this->rsa_tup_model->proses_tup($kd_unit,$data,$id_nomor_tup)){
                                if($this->check_session->get_level() == 3){
                                    ...
                                    $data_verifikator = array(
                                        'nomor_trx_spm' => $nomor_trx_spm ,//$this->rsa_tup_model->get_id_nomor_tup('SPM',$kd_unit,$tahun),//$nomor_[0],
                                        'str_nomor_trx_spm' => $nomor_trx,
                                        'kode_unit_subunit' => $kd_unit,
                                        'jenis_trx' => 'TUP',
                ...
                function proses_final_tup(){
                    if($this->input->post('proses')){
                        ...
                        $id_trx_nomor_tup = $this->input->post('id_nomor_tup') ;
                        $id_trx_nomor_tup_spm = $this->rsa_tup_model->get_id_nomor_tup_by_nomor_trx($nomor_trx_spm) ;
...
//                            echo $saldo_ben->saldo;die;
                            ...
                            // echo $kd_unit . ' ' . $id_trx_nomor_tup ; die;
                            
                            if($this->rsa_tup_model->proses_tup($kd_unit,$data,$id_trx_nomor_tup)){
                                ...
                                $saldo_penerima = $this->kas_bendahara_model->get_kas_bendahara_by_kd_akun_and_unit($kd_akun_kas_bendahara,$kd_unit,'TUP',$this->cur_tahun);
...
//                                    'nomor_trx_spm' => $this->rsa_tup_model->get_id_nomor_tup('SPM',$kd_unit,$this->input->post('tahun')),//,$nomor,
    ...
    //                            var_dump($data_spm_cair);die;
                                ...
                                if($this->rsa_tup_model->final_tup($kd_unit,$data) && $this->kas_undip_model->isi_trx($data_kas) && $this->rsa_tup_model->spm_cair($data_spm_cair)){// && $this->rsa_tup_model->data_tup_to_nihil($data_tup_to_nihil)){

                                // if($this->kas_undip_model->isi_trx($data_kas) && $this->rsa_tup_model->spm_cair($data_spm_cair)){
						...
						// $kode = strlen(($top_unit->kode_unit+1)+"")==1?"0".($top_unit->kode_unit+1):$top_unit->kode_unit+1;
                                        if($this->input->post()){
                                            ...
                                            if ($this->form_validation->run()){
							                    ...
							                    $this->rsa_tup_model->add_rsa_tup($data);
                                                echo "berhasil";
		...
		if($this->check_session->user_session() && $this->check_session->get_level()==100){
			if($this->uri->segment(3)){
				if($this->rsa_tup_model->delete_rsa_tup(array('no'=>$this->uri->segment(3)))){
					$data['class']	 = 'option box';
					$data['class_btn']	 = 'ya';
		...
		function get_row_rsa_tup(){
			if($this->check_session->user_session() && $this->check_session->get_level()==100){
				$data['result_rsa_tup'] = $this->rsa_tup_model->get_rsa_tup();
				$this->load->view('rsa_permintaan/row_rsa_tup',$data);
			}
			else{
				show_404('page');
			}
		...
		function filter_rsa_tup(){
			if($this->check_session->user_session() && $this->check_session->get_level()==100){
				...
				$data['result_rsa_tup'] = $this->rsa_tup_model->search_rsa_tup($keyword);
				$this->load->view('rsa_permintaan/row_rsa_tup',$data);
			}
			else{
				show_404('page');
               ...
               function check_exist_rsa_tup($no_tup){
                        ...
                        $result = $this->rsa_tup_model->get_rsa_tup($no_tup);
                ...
                function check_exist_rba_unit($kode_unit_rba){
                        ...
                        $result = $this->rsa_tup_model->get_rsa_tup($kode_unit_rba);
                ...
                function saldo($tahun=''){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==3)||($this->check_session->get_level()==11))){
                            $data['main_menu']              = $this->load->view('main_menu','',TRUE);
                            $subdata['unit_usul'] 		= $this->rsa_tup_model->get_tup_unit($tahun);
                            $subdata['cur_tahun'] =  $tahun;
//                            $subdata['opt_sumber_dana'] 	= $this->option->sumber_dana();
    ...
    //          echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                ...
                function get_status_nihil(){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==13))){
                           // echo '5' ; 
                        $status = $this->rsa_tup_model->get_status_nihil($this->check_session->get_unit(),$this->cur_tahun);
                ...
                function get_data_untuk_pekerjaan(){
                    ...
                    $kode_unit_subunit = $this->check_session->get_unit();
                    $data = $this->rsa_tup_model->get_data_untuk_pekerjaan($d['untuk_bayar'],$kode_unit_subunit,$this->cur_tahun);
                    $json = [];
                ...
                function get_data_penerima(){
                    $q = $this->input->get('query');
                    $kode_unit_subunit = $this->check_session->get_unit();
                    $data = $this->rsa_tup_model->get_data_penerima($q,$kode_unit_subunit,$this->cur_tahun);
                    $json = [];
