...
class Rsa_lsnk_model extends CI_Model {
/* -------------- Constructor ------------- */
	...
	//	print_r($query);die;
        ...
        function check_dokumen_lsnk($kode_unit_subunit,$tahun,$id_trx_nomor_lsnk = ""){
            $q = $this->db->query("SELECT posisi FROM trx_lsnk WHERE kode_unit_subunit = '{$kode_unit_subunit}' AND aktif = '1'  AND tahun = '{$tahun}' AND id_trx_nomor_lsnk = '{$id_trx_nomor_lsnk}' ");
//            var_dump($q->num_rows());die;
        ...
        function check_dokumen_lsnk_by_str_trx($no_str_trx){
            ...
            $query = "SELECT posisi "
                    ...
                    . "AND t1.id_trx_lsnk = ( 
SELECT MAX(t2.id_trx_lsnk) FROM trx_lsnk AS t2 WHERE t2.id_trx_nomor_lsnk = t1.id_trx_nomor_lsnk )" ;
...
//            var_dump($q->num_rows());die;
        ...
        function lihat_ket_by_str_trx($no_str_trx){
            ...
            $query = "SELECT ket "
                    ...
                    . "WHERE tt1.str_nomor_trx = '{$no_str_trx}' "
                    . "AND t1.id_trx_lsnk = ( "
                        . "SELECT MAX(t2.id_trx_lsnk) FROM trx_lsnk AS t2 "
...
//            var_dump($q->num_rows());die;
        ...
        function proses_nomor_spp_lsnk($kode_unit,$data){
            
            // $this->db->where('tahun', $data['tahun']);
            // $this->db->where('aktif', '1');
            // $this->db->where('jenis', 'SPP');
            // $this->db->where('kode_unit_subunit', $kode_unit);
            // $this->db->update('trx_nomor_lsnk', array('aktif'=>'0')); 
            
            return $this->db->insert('trx_nomor_lsnk',$data);
            
        }
               
        function proses_nomor_spm_lsnk($kode_unit,$data){
        ...
        function proses_lsnk($kode_unit,$data,$id_nomor_lsnk){
            ...
            $this->db->where('kode_unit_subunit', $kode_unit);
            $this->db->where('id_trx_nomor_lsnk', $id_nomor_lsnk);
            $this->db->update('trx_lsnk', array('aktif'=>'0')); 

            return $this->db->insert('trx_lsnk',$data);
            
        }
        
        function final_lsnk($kode_unit,$data){
...
//            echo "SELECT str_nomor_trx AS nt FROM trx_nomor_up WHERE kode_unit_subunit = '{$kode_unit_subunit}' AND jenis = 'SPP'  AND tahun = '{$tahun}' AND aktif = '1' " ; die;
            ...
            $q = $this->db->query("SELECT str_nomor_trx AS nt FROM trx_nomor_lsnk WHERE kode_unit_subunit = '{$kode_unit_subunit}' AND jenis = 'SPM'  AND tahun = '{$tahun}' AND aktif = '1' ");
        ...
        function get_nomor_next_spp($kode_unit_subunit,$tahun){
            $q = $this->db->query("SELECT IFNULL(MAX(nomor_trx),0) AS nt FROM trx_nomor_lsnk WHERE kode_unit_subunit = '{$kode_unit_subunit}' AND jenis = 'SPP'  AND tahun = '{$tahun}' ");
//            var_dump($q->num_rows());die;
//            if($q->num_rows() > 0){
//               return $q->row()->tgl_proses ;
//            }else{
...
//            } 
        ...
        function get_nomor_next_spm($kode_unit_subunit,$tahun){
            $q = $this->db->query("SELECT IFNULL(MAX(nomor_trx),0) AS nt FROM trx_nomor_lsnk WHERE kode_unit_subunit = '{$kode_unit_subunit}' AND jenis = 'SPM'  AND tahun = '{$tahun}' ");
//            var_dump($q->num_rows());die;
//            if($q->num_rows() > 0){
//               return $q->row()->tgl_proses ;
//            }else{
...
//            } 
        ...
        function get_id_nomor_lsnk($jenis,$kode_unit_subunit,$tahun){
//            echo "SELECT id_trx_nomor_up FROM trx_nomor_up WHERE kode_unit_subunit = '{$kode_unit_subunit}' AND jenis = '{$jenis}' AND tahun = '{$tahun}' AND aktif='1' "; die;
            $q = $this->db->query("SELECT id_trx_nomor_lsnk FROM trx_nomor_lsnk WHERE kode_unit_subunit = '{$kode_unit_subunit}' AND jenis = '{$jenis}' AND tahun = '{$tahun}' AND aktif='1' ");
//            var_dump($q->num_rows());die;
            if($q->num_rows() > 0){
               return $q->row()->id_trx_nomor_lsnk ;
            }else{
            
            }
        }

        function get_id_nomor_lsnk_by_nomor_trx($str_nomor_trx){
//            echo "SELECT id_trx_nomor_ks FROM trx_nomor_ks WHERE kode_unit_subunit = '{$kode_unit_subunit}' AND jenis = '{$jenis}' AND tahun = '{$tahun}' AND aktif='1' "; die;
            $q = $this->db->query("SELECT id_trx_nomor_lsnk FROM trx_nomor_lsnk WHERE str_nomor_trx = '{$str_nomor_trx}' ");
//            var_dump($q->num_rows());die;
            if($q->num_rows() > 0){
               return $q->row()->id_trx_nomor_lsnk ;
            }else{
...
//            var_dump($str);die;
    ...
    //            var_dump($q->num_rows());die;
        ...
        function get_tgl_spm_kpa_by_spm($nomor_trx_spm){
            ...
            $str = "SELECT trx_lsnk.tgl_proses FROM trx_nomor_lsnk "
                    . "JOIN trx_lsnk ON trx_nomor_lsnk.id_trx_nomor_lsnk = trx_lsnk.id_trx_nomor_lsnk "
                    . "WHERE trx_nomor_lsnk.str_nomor_trx = '{$nomor_trx_spm}' "
                    . "AND trx_lsnk.posisi = 'SPM-DRAFT-KPA'" ;
    ...
    //            var_dump($q->num_rows());die;
        ...
        function get_tgl_spm_kpa_by_spp($nomor_trx_spp){
            ...
            $str = "SELECT trx_lsnk.tgl_proses FROM trx_nomor_lsnk "
                    . "JOIN trx_lsnk ON trx_nomor_lsnk.id_trx_nomor_lsnk = trx_lsnk.id_trx_nomor_lsnk "
                    . "WHERE trx_nomor_lsnk.str_nomor_trx = '{$nomor_trx_spp}' "
                    . "AND trx_lsnk.posisi = 'SPM-DRAFT-KPA'" ;
    ...
    //            var_dump($q->num_rows());die;
        ...
        function get_tgl_spm_verifikator_by_spm($nomor_trx_spm){
            ...
            $str = "SELECT trx_lsnk.tgl_proses FROM trx_nomor_lsnk "
                    . "JOIN trx_lsnk ON trx_nomor_lsnk.id_trx_nomor_lsnk = trx_lsnk.id_trx_nomor_lsnk "
                    . "WHERE trx_nomor_lsnk.str_nomor_trx = '{$nomor_trx_spm}' "
                    . "AND trx_lsnk.posisi = 'SPM-FINAL-VERIFIKATOR'";
    ...
    //            var_dump($q->num_rows());die;
        ...
        function get_tgl_spm_kbuu_by_spm($nomor_trx_spm){
            ...
            $str = "SELECT trx_lsnk.tgl_proses FROM trx_nomor_lsnk "
                    . "JOIN trx_lsnk ON trx_nomor_lsnk.id_trx_nomor_lsnk = trx_lsnk.id_trx_nomor_lsnk "
                    . "WHERE trx_nomor_lsnk.str_nomor_trx = '{$nomor_trx_spm}' "
                    . "AND trx_lsnk.posisi = 'SPM-FINAL-KBUU'";
...
//            var_dump($str);die;
    ...
    //            var_dump($q->num_rows());die;
        ...
        function get_lsnk_unit_usul($tahun){
...
//                var_dump($result);die;
        ...
        function get_lsnk_subunit_usul($tahun){
...
//                var_dump($result);die;
        ...
        function get_lsnk_unit_usul_verifikator($id_user_verifikator,$tahun){
...
//                var_dump($result);die;
        ...
        function get_lsnk_subunit_usul_verifikator($id_user_verifikator,$tahun){
...
//        }
        ...
        function get_verifikator_by_spm($nomor_trx_spm){ 
            ...
            $str2 = "SELECT nmverifikator AS nm_lengkap,nipverifikator AS nomor_induk FROM trx_spm_lsnk_data "
...
//                var_dump($q->row());die;
        ...
        function proses_verifikator_lsnk($data){
		//print_r($data);die;
...
//         }
        ...
        function get_daftar_spp($kode_unit_subunit,$tahun){
            ...
            $query = "SELECT tt1.str_nomor_trx AS str_nomor_trx_spp,
                            t2.alias_spp,t3.alias_spm,
                            t3.str_nomor_trx AS str_nomor_trx_spm,
                            t2.tgl_spp AS tgl_proses,
                            t2.jumlah_bayar,
                            t1.posisi,
                            t2.untuk_bayar
                        FROM trx_nomor_lsnk AS tt1
                        JOIN trx_lsnk AS t1
                            ON t1.id_trx_nomor_lsnk = tt1.id_trx_nomor_lsnk
                        JOIN trx_spp_lsnk_data AS t2
                            ON t2.nomor_trx_spp = tt1.id_trx_nomor_lsnk
                        LEFT JOIN trx_spm_lsnk_data AS t3
                            ON t3.nomor_trx_spm = t1.id_trx_nomor_lsnk_spm
                        WHERE tt1.kode_unit_subunit = '{$kode_unit_subunit}'
                            AND jenis = 'SPP' 
                            AND tt1.tahun = '{$tahun}' 
                            AND t1.aktif = '1' 
                            AND t1.tgl_proses
                        GROUP BY tt1.id_trx_nomor_lsnk
                        ORDER BY tt1.id_trx_nomor_lsnk DESC" ;
...
//                var_dump($result);die;
        ...
        function get_daftar_spm($kode_unit_subunit,$tahun){
            ...
            $query2 = "SELECT *,t1.tgl_proses AS tgl_proses_status "
                    . "FROM trx_nomor_tup AS tt1 "
                    . "JOIN trx_tup AS t1 ON t1.id_trx_nomor_tup = tt1.id_trx_nomor_tup "
                    . "WHERE tt1.kode_unit_subunit = '{$kode_unit_subunit}' "
                    . "AND jenis = 'SPM' "
                    . "AND tt1.tahun = '{$tahun}' "
                    . "AND t1.id_trx_lsnk = ( "
                        . "SELECT MAX(t2.id_trx_lsnk) FROM trx_tup AS t2 "
                        . "WHERE t2.id_trx_nomor_tup = t1.id_trx_nomor_tup )" ;
...
//                var_dump($result);die;
        ...
        function proses_data_spp($data){
            return $this->db->insert("trx_spp_lsnk_data",$data);
        }
        
        function get_data_spp($str_nomor_trx){
            $this->db->where('str_nomor_trx',$str_nomor_trx);
            $query = $this->db->get("trx_spp_lsnk_data");
    //	print_r($query);die;
//            if($query->num_rows()>0){
                    return $query->row();
//            }else{
...
//            }
        ...
        function proses_data_spm($data){
            return $this->db->insert("trx_spm_lsnk_data",$data);
        }
        
        function get_data_spm($str_nomor_trx){
            $this->db->where('str_nomor_trx',$str_nomor_trx);
            $query = $this->db->get("trx_spm_lsnk_data");
    //	print_r($query);die;
//            if($query->num_rows()>0){
                    return $query->row();
//            }else{
...
//            } 
        ...
        function proses_lsnk_spp_rka($data){
    ...
    //                $this->db->update('rsa_kuitansi', array('str_nomor_trx'=>$data['str_nomor_trx']));
                        $query = "UPDATE rsa_detail_belanja_ "
                            ...
                            . "SET rsa_detail_belanja_.proses = '46' "
    ...
    //                echo $query ; die;
        ...
        function tolak_lsnk_spp_rka($data){
    ...
    //                $this->db->update('rsa_kuitansi', array('str_nomor_trx'=>$data['str_nomor_trx']));
                        $query = "UPDATE rsa_detail_belanja_ "
                            ...
                            . "AND rsa_kuitansi_detail.kode_akun_tambah = rsa_detail_belanja_.kode_akun_tambah "
                            . "JOIN rsa_kuitansi ON rsa_kuitansi.id_kuitansi = rsa_kuitansi_detail.id_kuitansi "
                            . "SET rsa_detail_belanja_.proses = '36' "
                            . "WHERE rsa_kuitansi.str_nomor_trx = '{$data['str_nomor_trx']}'" ; 
    //                echo $query ; die;
                    $this->db->query($query);
                // }
        ...
        function proses_lsnk_spm_rka($data){
    ...
    //                $this->db->update('rsa_kuitansi', array('str_nomor_trx'=>$data['str_nomor_trx']));
                        $query = "UPDATE rsa_detail_belanja_ "
                            ...
                            . "AND rsa_kuitansi_detail.kode_akun_tambah = rsa_detail_belanja_.kode_akun_tambah "
                            . "JOIN rsa_kuitansi ON rsa_kuitansi.id_kuitansi = rsa_kuitansi_detail.id_kuitansi "
                            . "SET rsa_detail_belanja_.proses = '56' "
    ...
    //                echo $query ; die;
        ...
        function proses_lsnk_cair_rka($data){
    ...
    //                $this->db->update('rsa_kuitansi', array('str_nomor_trx'=>$data['str_nomor_trx']));
                    // $nw = date('Y-m-d H:i:s');
                        $query = "UPDATE rsa_detail_belanja_ "
                            ...
                            . "AND rsa_kuitansi_detail.kode_akun_tambah = rsa_detail_belanja_.kode_akun_tambah "
                            . "JOIN rsa_kuitansi ON rsa_kuitansi.id_kuitansi = rsa_kuitansi_detail.id_kuitansi "
                            . "SET rsa_detail_belanja_.proses = '66', rsa_detail_belanja_.tanggal_transaksi = '{$data['tgl_proses']}' "
                            . "WHERE rsa_kuitansi.str_nomor_trx_spm = '{$data['str_nomor_trx_spm']}'" ; 
    //                echo $query ; die;
                    $this->db->query($query);
                // }
        ...
        function tolak_lsnk_spm_rka($data){
    ...
    //                echo $query ; die;
        ...
        function get_nomer_spm_cair_lalu($kode_unit_subunit,$tahun){
            $str = "SELECT t1.str_nomor_trx_spm FROM trx_urut_spm_cair AS t1 "
                    . "WHERE t1.kode_unit_subunit = '{$kode_unit_subunit}' AND t1.jenis_trx = 'LSNK' AND t1.tahun = '{$tahun}' "
                    . "AND id_trx_urut_spm_cair = ( SELECT MAX(id_trx_urut_spm_cair) FROM trx_urut_spm_cair AS t2 WHERE t2.kode_unit_subunit = '{$kode_unit_subunit}' AND t2.jenis_trx = 'LSNK' AND t2.tahun = '{$tahun}' ) " ;
...
//            var_dump($q->result());die;
    //            var_dump($q->num_rows());die;
        ...
        function get_notif_approve($kode_unit_subunit,$level,$id_user_verifikator){
                    ...
                    $query = '' ;
                        ...
                        if($level == '14'){ // PPK SUKPA
                           $query = "SELECT COUNT(posisi) AS jml FROM trx_lsnk WHERE ( posisi = 'SPP-DRAFT' OR posisi = 'SPP-FINAL' ) AND kode_unit_subunit = '{$kode_unit_subunit}' AND aktif = '1' " ; 

                           // echo $query; die;

                        }else if($level == '2'){ // KPA
                            $query = "SELECT COUNT(posisi) AS jml FROM trx_lsnk WHERE posisi = 'SPM-DRAFT-PPK' AND kode_unit_subunit = '{$kode_unit_subunit}' AND aktif = '1' " ; 
                            ...
                            $query = "SELECT COUNT(posisi) AS jml FROM trx_lsnk WHERE posisi = 'SPM-DRAFT-KPA' AND SUBSTR(kode_unit_subunit,1,2) IN ({$str_unit}) AND aktif = '1' " ; 

                           // echo $query ; die ;

                        }else if($level == '11'){ // KBUU
                            $query = "SELECT COUNT(posisi) AS jml FROM trx_lsnk WHERE posisi = 'SPM-FINAL-VERIFIKATOR' AND aktif = '1' GROUP BY  posisi " ;
        ...
        function get_nomor_spp_urut($unit,$tahun){
            ...
            $query = "SELECT MAX(id_trx_nomor_lsnk) AS id_max FROM  trx_nomor_lsnk WHERE kode_unit_subunit = '{$unit}' AND tahun = '{$tahun}' AND jenis = 'SPP' " ;
        ...
        function get_nomor_spp_urut_by_nomor_spp($str_nomor_trx_spp){
            ...
            $query = "SELECT id_trx_nomor_lsnk FROM  trx_nomor_lsnk WHERE str_nomor_trx = '{$str_nomor_trx_spp}' " ;
            ...
            $q = $this->db->query($query);
                    ...
                    if(!is_null($q->row()->id_trx_nomor_lsnk)){
                       return $q->row()->id_trx_nomor_lsnk;
                    }else{
                        return '0';
                    }
        ...
        function get_data_untuk_pekerjaan($q,$kode_unit_subunit,$tahun){
            ...
            $query = "SELECT DISTINCT(untuk_bayar) FROM  trx_spp_lsnk_data WHERE untuk_bayar LIKE '%{$q}%' AND kode_unit_subunit = '{$kode_unit_subunit}' AND tahun = '{$tahun}' " ;
        ...
        function get_data_penerima($q,$kode_unit_subunit,$tahun){
            ...
            $query = "SELECT DISTINCT(CONCAT(penerima,'|',alamat,'|',nmbank,'|',nmrekening,'|',rekening,'|',npwp)) AS str_penerima FROM  trx_spp_lsnk_data WHERE penerima LIKE '%{$q}%' AND kode_unit_subunit = '{$kode_unit_subunit}' AND tahun = '{$tahun}' " ;
        ...
        function get_data_json($data,$kode_unit_subunit,$tahun){
            ...
            $query = "SELECT DISTINCT({$key[0]}) FROM  trx_spp_lsnk_data WHERE {$key[0]} LIKE '%{$data[$key[0]]}%' AND kode_unit_subunit = '{$kode_unit_subunit}' AND tahun = '{$tahun}' " ;
        ...
        function check_exist_lsnk($nomor_trx,$tahun){
