...
/* -------------- Constructor ------------- */
	...
	public function __construct(){ 
		parent::__construct();
			...
			$this->load->model(array('rsa_tambah_tup_model'));//,'setting_up_model'));
...
//                        $data['message']	= validation_errors();
		...
		function daftar_rsa_tup(){
			if($this->check_session->user_session() && $this->check_session->get_level()==2){
				...
				$data['main_menu']	= $this->load->view('main_menu','',TRUE);		
				$subdata_rsa_tup['result_rsa_tup'] 		= $this->rsa_tambah_tup_model->search_rsa_tup();
				$subdata['opt_unit_kepeg']		= $this->option->opt_unit_kepeg();
				$subdata['row_rsa_tup'] 			= $this->load->view("rsa_tup/row_rsa_tup",$subdata_rsa_tup,TRUE);
				$data['main_content'] 			= $this->load->view("rsa_tup/daftar_rsa_tup",$subdata,TRUE);
				$this->load->view('main_template',$data);
			}
			else{
		...
		function input_rsa_tup(){
			if($this->check_session->user_session() && $this->check_session->get_level()==13){
				...
				//$subdata['row_rsa_tup'] 			= $this->load->view("rsa_tup/row_rsa_tup",$subdata_rsa_tup,TRUE);
				$subdata['opt_unit_kepeg']		= $this->option->opt_unit_kepeg();
				$data['main_content'] 			= $this->load->view("rsa_tup/input_rsa_tup",$subdata,TRUE);
				$this->load->view('main_template',$data);
			}
			else{
				redirect('home','refresh');	// redirect ke halaman home
				...
				//$subdata_rsa_tup['result_rsa_tup'] 		= $this->rsa_tambah_tup_model->search_rsa_tup();
                                ...
                                $dokumen_tup = $this->rsa_tambah_tup_model->check_dokumen_tambah_tup($this->check_session->get_unit(),$this->cur_tahun);
...
//                                $urut_spp_pup = $this->rsa_tambah_tup_model->get_urut($this->check_session->get_unit(),'SPP',$this->cur_tahun);
				...
				//$subdata['opt_unit_kepeg']		= $this->option->opt_unit_kepeg();
//                                var_dump($subdata['detail_pic']);die;
				$data['main_content'] 			= $this->load->view("rsa_tambah_tup/spp_tambah_tup",$subdata,TRUE);
				$this->load->view('main_template',$data);
			} 
			else{
				...
				//$subdata_rsa_tup['result_rsa_tup'] 		= $this->rsa_tambah_tup_model->search_rsa_tup();
//				$subdata['detail_tup'] 			= array(
//                                                                                    'nom' => $this->setting_tup_model->get_setting_tup($this->check_session->get_unit(),$this->cur_tahun),
//                                                                                    'terbilang' => $this->convertion->terbilang($this->setting_tup_model->get_setting_tup($this->check_session->get_unit(),$this->cur_tahun)), 
//                                                                                    
//                                                                                );
                                $subdata['cur_tahun'] = $this->cur_tahun;
...
//                                var_dump($subdata);die;
				$data['main_content'] 			= $this->load->view("rsa_tambah_tup/spm_tambah_tup",$subdata,TRUE);
				$this->load->view('main_template',$data);
			} 
			else{
				redirect('welcome','refresh');	// redirect ke halaman home
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
				...
				//$subdata['opt_unit_kepeg']		= $this->option->opt_unit_kepeg();
//                                var_dump($subdata);die;
				$data['main_content'] 			= $this->load->view("rsa_tambah_tup/spm_tambah_tup_kpa",$subdata,TRUE);
				$this->load->view('main_template',$data);
			} 
			else{
				redirect('welcome','refresh');	// redirect ke halaman home
                ...
                function spm_tambah_tup_lihat_99($url,$kd_unit,$tahun){
                ...
                //$subdata_rsa_tup['result_rsa_tup']        = $this->rsa_tambah_tup_model->search_rsa_tup();
                                ...
                                $dokumen_tup = $this->rsa_tambah_tup_model->check_dokumen_tambah_tup_by_str_trx($url);
...
//                                        'tgl_spp' => $data_spp->tgl_spp,
                                ...
                                $subdata['ket'] = $this->rsa_tambah_tup_model->lihat_ket_by_str_trx($nomor_trx_spm);//$kd_unit,$tahun);
                                
                //$subdata['opt_unit_kepeg']        = $this->option->opt_unit_kepeg();
//                                var_dump($subdata);die;
                $data['main_content']           = $this->load->view("rsa_tambah_tup/spm_tambah_tup_lihat",$subdata,TRUE);
                $this->load->view('main_template',$data);
            } 
            else{
                redirect('welcome','refresh');  // redirect ke halaman home
...
//                            $subdata['opt_sumber_dana'] 	= $this->option->sumber_dana();
                            $data['main_content'] 		= $this->load->view("rsa_tambah_tup/daftar_unit",$subdata,TRUE);
                            /*	Load main template	*/
    //			echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                ...
                function daftar_unit_kbuu($tahun=''){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==11))){
                            ...
                            $subdata['cur_tahun'] =  $tahun;
//                            $subdata['opt_sumber_dana'] 	= $this->option->sumber_dana();
                            $data['main_content'] 		= $this->load->view("rsa_tambah_tup/daftar_unit_kbuu",$subdata,TRUE);
                            /*	Load main template	*/
    //			echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                            $this->load->view('main_template',$data);
                    }else{
                ...
                function spm_tambah_tup_verifikator($kd_unit,$tahun){
...
//                                $subdata['tgl_spm'] = $this->rsa_tambah_tup_model->get_tgl_spm($kd_unit,$tahun);
...
//                                $detail_verifikator  = $this->rsa_tambah_tup_model->get_verifikator($kd_unit,$tahun,$nomor_trx_spm);
...
//                                $subdata['detail_verifikator']  = $detail_verifikator ;
				...
				//$subdata['opt_unit_kepeg']		= $this->option->opt_unit_kepeg();
//                                var_dump($subdata);die;
				$data['main_content'] 			= $this->load->view("rsa_tambah_tup/spm_tambah_tup_verifikator",$subdata,TRUE);
				$this->load->view('main_template',$data);
			} 
			else{
				redirect('welcome','refresh');	// redirect ke halaman home
                ...
                function spm_tambah_tup_kbuu($kd_unit,$tahun){
...
//                                $subdata['detail_verifikator']  = $this->rsa_tambah_tup_model->get_verifikator($kd_unit,$tahun,$nomor_trx_spm);
...
//                                var_dump( $subdata['kas_undip']);die;
				...
				//$subdata['opt_unit_kepeg']		= $this->option->opt_unit_kepeg();
//                                var_dump($subdata);die;
				$data['main_content'] 			= $this->load->view("rsa_tambah_tup/spm_tambah_tup_kbuu",$subdata,TRUE);
				$this->load->view('main_template',$data);
			} 
			else{
				redirect('welcome','refresh');	// redirect ke halaman home
...
//                        echo $html;die;
//                        $h = $this->load->view("rsa_tup/cetak",array('html'=>$html),TRUE);
//                        echo $h;
                        $this->load->library('Pdfgen'); 
                        $this->pdfgen->cetak($html,'SPP_tup_'.$unit.'_'.''.$tahun);
                    }
...
//                        echo $html;die;
                        $this->load->library('Pdfgen'); 
                        $this->pdfgen->cetak($html,'SPM_tup_');
                    }
                }
...
//                                'urut' => $this->rsa_tambah_tup_model->get_urut($kd_unit,$jenis,$tahun)
                           ...
                           // var_dump($data_spp);die;
                            ...
                            if(($dokumen_tup == '')||($dokumen_tup == 'SPP-DITOLAK')||($dokumen_tup == 'SPM-DITOLAK-KPA')||($dokumen_tup == 'SPM-DITOLAK-VERIFIKATOR')||($dokumen_tup == 'SPM-DITOLAK-KBUU')||($dokumen_tup == 'SPM-FINAL-KBUU')){
    ...
    //                            echo 'jos';die;
                                ...
                                if($this->rsa_tambah_tup_model->proses_nomor_spp_tambah_tup($kd_unit,$data) ){
                                   ...
                                   // var_dump($data);die;
                                    ...
                                    if($this->rsa_tambah_tup_model->proses_tambah_tup($kd_unit,$data)&& $this->rsa_tambah_tup_model->proses_data_spp($data_spp)){
...
//                                'urut' => $this->rsa_tambah_tup_model->get_urut($kd_unit,$jenis,$tahun)
    ...
    //                        var_dump($data_spm);die;
        ...
        //                            var_dump($data);die;
                                    ...
                                    if($this->rsa_tambah_tup_model->proses_tambah_tup($kd_unit,$data) && $this->rsa_tambah_tup_model->proses_trx_spp_spm($data_spp_spm) && $this->rsa_tambah_tup_model->proses_data_spm($data_spm)){
                                        $this->session->set_flashdata('message', '<div class="alert alert-success" style="text-align:center"><span class="glyphicon glyphicon glyphicon-ok" aria-hidden="true"></span> SPP/SPM TUP anda berhasil disubmit.</div>');
                                        echo "sukses";
                                    }else{
                                        echo "gagal";
                ...
                function proses_spp_tambah_tup(){
                    if($this->input->post('proses')){
                        ...
                        if($ok){
//                            echo 'jos'; die;
                            if($this->rsa_tambah_tup_model->proses_tambah_tup($kd_unit,$data)){
                                $this->session->set_flashdata('message', '<div class="alert alert-success" style="text-align:center"><span class="glyphicon glyphicon glyphicon-ok" aria-hidden="true"></span> SPP/SPM TUP anda berhasil disubmit.</div>');
                                echo "sukses";
                            }else{
                                echo "gagal";
...
//                                        'nomor_trx_spm' => $this->rsa_tambah_tup_model->get_id_nomor_tambah_tup('SPM',$kd_unit,$tahun),//$nomor_[0],
//                                        'str_nomor_trx_spm' => $nomor_trx,
//                                        'kode_unit_subunit' => $kd_unit,
//                                        'jenis_trx' => 'PUP',
...
//                            var_dump($data);die;
                ...
                function proses_final_tambah_tup(){
                    if($this->input->post('proses')){
                        ...
                        $dokumen_tup = $this->rsa_tambah_tup_model->check_dokumen_tambah_tup($kd_unit,$this->input->post('tahun'));
...
//                                    'nomor_trx_spm' => $this->rsa_tambah_tup_model->get_id_nomor_tambah_tup('SPM',$kd_unit,$tahun),//$nomor,
                                    'str_nomor_trx_spm' => $nomor_trx_spm,
                                    'str_nomor_trx_spp' => $this->rsa_tambah_tup_model->get_spp_by_spm($nomor_trx_spm),
                                    'kode_unit_subunit' => $kd_unit,
                                    'jenis_trx' => 'TUP',
                                    'nominal' => $nominal,
                                    'tgl_proses' => date('Y-m-d H:i:s'),
    ...
    //                            var_dump($data_spm_cair);die;
                                ...
                                if($this->rsa_tambah_tup_model->final_tambah_tup($kd_unit,$data) && $this->kas_undip_model->isi_trx($data_kas) && $this->rsa_tambah_tup_model->spm_cair($data_spm_cair) && $this->rsa_tambah_tup_model->tup_to_nihil($data_tup_to_nihil)){
                                    $this->session->set_flashdata('message', '<div class="alert alert-success" style="text-align:center"><span class="glyphicon glyphicon glyphicon-ok" aria-hidden="true"></span> SPP/SPM TUP anda berhasil disubmit.</div>');
                                    echo "sukses";
                                }else{
                                    echo "gagal";
				...
				if($this->check_session->user_session() && $this->check_session->get_level()==2){
						...
						// $kode = strlen(($top_unit->kode_unit+1)+"")==1?"0".($top_unit->kode_unit+1):$top_unit->kode_unit+1;
                                        if($this->input->post()){
                                            ...
                                            $this->form_validation->set_rules('no_tup','no_tup','required|min_length[2]|callback_check_exist_rsa_tup');
                                            ...
                                            if ($this->form_validation->run()){
												...
												'no_tup' => form_prep($this->input->post('no_tup')),
							                    ...
							                    $this->rsa_tambah_tup_model->add_rsa_tup($data);
                                                echo "berhasil";
		...
		function confirmation_delete(){
			if($this->check_session->user_session() && $this->check_session->get_level()==100){
				if($this->uri->segment(3)!='99'){ //jika bukan user pusat
					$data['url']		= site_url('rsa_tup/exec_delete/'.$this->uri->segment(3));
		...
		if($this->check_session->user_session() && $this->check_session->get_level()==100){
			if($this->uri->segment(3)){
				if($this->rsa_tambah_tup_model->delete_rsa_tup(array('no'=>$this->uri->segment(3)))){
					$data['class']	 = 'option box';
					$data['class_btn']	 = 'ya';
		...
		function get_row_rsa_tup(){
			if($this->check_session->user_session() && $this->check_session->get_level()==100){
				$data['result_rsa_tup'] = $this->rsa_tambah_tup_model->get_rsa_tup();
				$this->load->view('rsa_tup/row_rsa_tup',$data);
			}
			else{
				show_404('page');
			}
		...
		function filter_rsa_tup(){
			if($this->check_session->user_session() && $this->check_session->get_level()==100){
				$keyword = form_prep($this->input->post('keyword'));
				$data['result_rsa_tup'] = $this->rsa_tambah_tup_model->search_rsa_tup($keyword);
				$this->load->view('rsa_tup/row_rsa_tup',$data);
			}
			else{
				show_404('page');
               ...
               function check_exist_rsa_tup($no_tup){

                        $this->form_validation->set_message('check_exist_rsa_tup', 'Maaf, kode RSA tsb sudah terdaftar');

                        $result = $this->rsa_tambah_tup_model->get_rsa_tup($no_tup);
                ...
                function check_exist_rba_unit($kode_unit_rba){
                        ...
                        $result = $this->rsa_tambah_tup_model->get_rsa_tup($kode_unit_rba);
                ...
                function saldo($tahun=''){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==3)||($this->check_session->get_level()==11))){
                            $data['main_menu']              = $this->load->view('main_menu','',TRUE);
                            $subdata['unit_usul'] 		= $this->rsa_tambah_tup_model->get_tup_unit($tahun);
                            $subdata['cur_tahun'] =  $tahun;
//                            $subdata['opt_sumber_dana'] 	= $this->option->sumber_dana();
                            $data['main_content'] 		= $this->load->view("rsa_tup/saldo",$subdata,TRUE);
                            /*	Load main template	*/
    //			echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                            $this->load->view('main_template',$data);
                    }else{
    ...
    //			echo '<pre>';var_dump($subdata['unit_usul_impor']);echo '</pre>';die;
                ...
                function get_status_nihil(){
                    ...
                    if($this->check_session->user_session() && (($this->check_session->get_level()==100)||($this->check_session->get_level()==13))){
                        ...
                        $spp_aktif = $this->rsa_tambah_tup_model->get_aktif_spp($this->check_session->get_unit(),$this->cur_tahun) ;

                        if($spp_aktif !=''){
                            $spm_aktif = $this->rsa_tambah_tup_model->get_aktif_spm($this->check_session->get_unit(),$this->cur_tahun);
                            $spm_nihil = $this->rsa_tambah_tup_model->get_spm_tup_nihil_by_spm_tambah_tup($spm_aktif);
                            if($spm_nihil != ''){
                                echo 'y' ; 
                            }else{
                                echo 'MASIH ADA SPM TUP YANG BELUM DI SPJ-KAN' ;
                            }
                ...
                function get_data_tgl_spp(){

                    setlocale(LC_ALL, 'id_ID.utf8');$tgl = strftime("%d %B %Y");  
