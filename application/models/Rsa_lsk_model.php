        ...
        function check_dokumen_lsk_by_str_trx($no_str_trx){
            ...
            $query = "SELECT posisi "
                    ...
                    . "AND t1.tgl_proses IN ( "
                        . "SELECT MAX(t2.tgl_proses) FROM trx_lsk AS t2 "
    ...
    //                echo $query ; die;
        ...
        function get_nomer_spm_cair_lalu($kode_unit_subunit,$tahun){
            $str = "SELECT t1.str_nomor_trx_spm FROM trx_urut_spm_cair AS t1 "
                    ...
                    . "AND tgl_proses = ( SELECT MAX(tgl_proses) FROM trx_urut_spm_cair AS t2 WHERE t2.kode_unit_subunit = '{$kode_unit_subunit}' AND t2.jenis_trx = 'LSK' AND t2.tahun = '{$tahun}' ) " ;
