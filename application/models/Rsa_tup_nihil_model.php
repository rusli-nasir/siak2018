...
class Rsa_tup_nihil_model extends CI_Model {
/* -------------- Constructor ------------- */
        ...
        function check_dokumen_tup_nihil($kode_unit_subunit,$tahun,$id_trx_nomor_tup_nihil = ""){

            // echo "SELECT posisi FROM trx_tup_nihil WHERE kode_unit_subunit = '{$kode_unit_subunit}' AND aktif = '1'  AND tahun = '{$tahun}' AND id_trx_nomor_tup_nihil = '{$id_trx_nomor_tup_nihil}' " ; die;
            
            $q = $this->db->query("SELECT posisi FROM trx_tup_nihil WHERE kode_unit_subunit = '{$kode_unit_subunit}' AND aktif = '1'  AND tahun = '{$tahun}' AND id_trx_nomor_tup_nihil = '{$id_trx_nomor_tup_nihil}' ");
//            var_dump($q->num_rows());die;
        ...
        function check_dokumen_tup_nihil_by_str_trx($no_str_trx){

            $query = "SELECT posisi "
                    . "FROM trx_nomor_tup_nihil AS tt1 "
                    . "JOIN trx_tup_nihil AS t1 ON t1.id_trx_nomor_tup_nihil = tt1.id_trx_nomor_tup_nihil "
                    . "WHERE tt1.str_nomor_trx = '{$no_str_trx}' "
                    . "AND t1.id_trx_tup_nihil = ( 
SELECT MAX(t2.id_trx_tup_nihil) FROM trx_tup_nihil AS t2 WHERE t2.id_trx_nomor_tup_nihil = t1.id_trx_nomor_tup_nihil )" ;
...
//            var_dump($q->num_rows());die;
        ...
        function lihat_ket_by_str_trx($no_str_trx){
            ...
            $query = "SELECT ket "
                    ...
                    . "WHERE tt1.str_nomor_trx = '{$no_str_trx}' "
                    . "AND t1.id_trx_tup_nihil = ( "
                        . "SELECT MAX(t2.id_trx_tup_nihil) FROM trx_tup_nihil AS t2 "
                        . "WHERE t2.id_trx_nomor_tup_nihil = t1.id_trx_nomor_tup_nihil )" ;
...
//            var_dump($q->num_rows());die;
        ...
        function proses_nomor_spp_tup_nihil($kode_unit,$data){
            
            // $this->db->where('tahun', $data['tahun']);
            // $this->db->where('aktif', '1');
            // $this->db->where('jenis', 'SPP');
            // $this->db->where('kode_unit_subunit', $kode_unit);
            // $this->db->update('trx_nomor_tup_nihil', array('aktif'=>'0')); 
            
            return $this->db->insert('trx_nomor_tup_nihil',$data);
            
        }
               
        function proses_nomor_spm_tup_nihil($kode_unit,$data){
        ...
        function proses_tup_nihil($kode_unit,$data,$id_nomor_tup_nihil){
            ...
            $this->db->where('kode_unit_subunit', $kode_unit);
            $this->db->where('id_trx_nomor_tup_nihil', $id_nomor_tup_nihil);
            $this->db->update('trx_tup_nihil', array('aktif'=>'0')); 

            return $this->db->insert('trx_tup_nihil',$data);
            
        }
        
        function final_tup_nihil($kode_unit,$data){
...
//            echo "SELECT str_nomor_trx AS nt FROM trx_nomor_up WHERE kode_unit_subunit = '{$kode_unit_subunit}' AND jenis = 'SPP'  AND tahun = '{$tahun}' AND aktif = '1' " ; die;
            ...
            $q = $this->db->query("SELECT str_nomor_trx AS nt FROM trx_nomor_tup_nihil WHERE kode_unit_subunit = '{$kode_unit_subunit}' AND jenis = 'SPM'  AND tahun = '{$tahun}' AND aktif = '1' ");
        ...
        function get_nomor_next_spp($kode_unit_subunit,$tahun){
            $q = $this->db->query("SELECT IFNULL(MAX(nomor_trx),0) AS nt FROM trx_nomor_tup_nihil WHERE kode_unit_subunit = '{$kode_unit_subunit}' AND jenis = 'SPP'  AND tahun = '{$tahun}' ");
//            var_dump($q->num_rows());die;
//            if($q->num_rows() > 0){
//               return $q->row()->tgl_proses ;
//            }else{
...
//            } 
        ...
        function get_nomor_next_spm($kode_unit_subunit,$tahun){
            $q = $this->db->query("SELECT IFNULL(MAX(nomor_trx),0) AS nt FROM trx_nomor_tup_nihil WHERE kode_unit_subunit = '{$kode_unit_subunit}' AND jenis = 'SPM'  AND tahun = '{$tahun}' ");
//            var_dump($q->num_rows());die;
//            if($q->num_rows() > 0){
//               return $q->row()->tgl_proses ;
//            }else{
...
//            } 
        ...
        function get_id_nomor_tup_nihil($jenis,$kode_unit_subunit,$tahun){
//            echo "SELECT id_trx_nomor_up FROM trx_nomor_up WHERE kode_unit_subunit = '{$kode_unit_subunit}' AND jenis = '{$jenis}' AND tahun = '{$tahun}' AND aktif='1' "; die;
            $q = $this->db->query("SELECT id_trx_nomor_tup_nihil FROM trx_nomor_tup_nihil WHERE kode_unit_subunit = '{$kode_unit_subunit}' AND jenis = '{$jenis}' AND tahun = '{$tahun}' AND aktif='1' ");
//            var_dump($q->num_rows());die;
            if($q->num_rows() > 0){
               return $q->row()->id_trx_nomor_tup_nihil ;
            }else{
            
            }
        }

        function get_id_nomor_tup_nihil_by_nomor_trx($str_nomor_trx){
//            echo "SELECT id_trx_nomor_tup FROM trx_nomor_tup WHERE kode_unit_subunit = '{$kode_unit_subunit}' AND jenis = '{$jenis}' AND tahun = '{$tahun}' AND aktif='1' "; die;
            $q = $this->db->query("SELECT id_trx_nomor_tup_nihil FROM trx_nomor_tup_nihil WHERE str_nomor_trx = '{$str_nomor_trx}' ");
//            var_dump($q->num_rows());die;
            if($q->num_rows() > 0){
               return $q->row()->id_trx_nomor_tup_nihil ;
            }else{
...
//            var_dump($str);die;
    ...
    //            var_dump($q->num_rows());die;
        ...
        function get_tgl_spm_kpa_by_spm($nomor_trx_spm){
            ...
            $str = "SELECT trx_tup_nihil.tgl_proses FROM trx_nomor_tup_nihil "
                    . "JOIN trx_tup_nihil ON trx_nomor_tup_nihil.id_trx_nomor_tup_nihil = trx_tup_nihil.id_trx_nomor_tup_nihil "
                    . "WHERE trx_nomor_tup_nihil.str_nomor_trx = '{$nomor_trx_spm}' "
                    . "AND trx_tup_nihil.posisi = 'SPM-DRAFT-KPA'" ;
    ...
    //            var_dump($q->num_rows());die;
        ...
        function get_tgl_spm_kpa_by_spp($nomor_trx_spp){
            ...
            $str = "SELECT trx_tup_nihil.tgl_proses FROM trx_nomor_tup_nihil "
                    . "JOIN trx_tup_nihil ON trx_nomor_tup_nihil.id_trx_nomor_tup_nihil = trx_tup_nihil.id_trx_nomor_tup_nihil "
                    . "WHERE trx_nomor_tup_nihil.str_nomor_trx = '{$nomor_trx_spp}' "
                    . "AND trx_tup_nihil.posisi = 'SPM-DRAFT-KPA'" ;
    ...
    //            var_dump($q->num_rows());die;
        ...
        function get_tgl_spm_verifikator_by_spm($nomor_trx_spm){
            ...
            $str = "SELECT trx_tup_nihil.tgl_proses FROM trx_nomor_tup_nihil "
                    . "JOIN trx_tup_nihil ON trx_nomor_tup_nihil.id_trx_nomor_tup_nihil = trx_tup_nihil.id_trx_nomor_tup_nihil "
                    . "WHERE trx_nomor_tup_nihil.str_nomor_trx = '{$nomor_trx_spm}' "
                    . "AND trx_tup_nihil.posisi = 'SPM-FINAL-VERIFIKATOR'";
    ...
    //            var_dump($q->num_rows());die;
        ...
        function get_tgl_spm_kbuu_by_spm($nomor_trx_spm){
            ...
            $str = "SELECT trx_tup_nihil.tgl_proses FROM trx_nomor_tup_nihil "
                    . "JOIN trx_tup_nihil ON trx_nomor_tup_nihil.id_trx_nomor_tup_nihil = trx_tup_nihil.id_trx_nomor_tup_nihil "
                    . "WHERE trx_nomor_tup_nihil.str_nomor_trx = '{$nomor_trx_spm}' "
                    . "AND trx_tup_nihil.posisi = 'SPM-FINAL-KBUU'";
...
//            var_dump($str);die;
    ...
    //            var_dump($q->num_rows());die;
        ...
        function get_tup_nihil_unit_usul($tahun){
...
LEFT JOIN (
    ...
    FROM rsa_2018.trx_tup_nihil AS tr1 
...
//                var_dump($result);die;
        ...
        function get_tup_nihil_subunit_usul($tahun){
...
//                var_dump($result);die;
        ...
        function get_tup_nihil_unit_usul_verifikator($id_user_verifikator,$tahun){
...
//                var_dump($result);die;
        ...
        function get_tup_nihil_subunit_usul_verifikator($id_user_verifikator,$tahun){
...
//        }
        ...
        function get_verifikator_by_spm($nomor_trx_spm){ 
            ...
            $str2 = "SELECT nmverifikator AS nm_lengkap,nipverifikator AS nomor_induk FROM trx_spm_tup_nihil_data "
...
//                var_dump($q->row());die;
        ...
        function proses_verifikator_tup_nihil($data){
		//print_r($data);die;
...
//         }
        ...
        function get_daftar_spp($kode_unit_subunit,$tahun){
            ...
            $query2 = "SELECT *,t1.tgl_proses,t2.jumlah_bayar AS tgl_proses_status "
                    . "FROM trx_nomor_tup_nihil AS tt1 "
                    . "JOIN trx_tup_nihil AS t1 ON t1.id_trx_nomor_tup_nihil = tt1.id_trx_nomor_tup_nihil "
                    . "JOIN trx_spp_tup_nihil_data AS t2 ON t2.nomor_trx_spp = tt1.id_trx_nomor_tup_nihil "
                    . "WHERE tt1.kode_unit_subunit = '{$kode_unit_subunit}' "
                    . "AND jenis = 'SPP' "
                    . "AND tt1.tahun = '{$tahun}' "
                    . "AND t1.id_trx_tup_nihil = ( "
                        . "SELECT MAX(t2.id_trx_tup_nihil) FROM trx_tup_nihil AS t2 "
                        . "WHERE t2.id_trx_nomor_tup_nihil = t1.id_trx_nomor_tup_nihil ) " 
                    . "ORDER BY tt1.id_trx_nomor_tup_nihil " ;

            $query = "SELECT tt1.str_nomor_trx AS str_nomor_trx_spp,t2.alias_spp,t3.alias_spm,t3.str_nomor_trx AS str_nomor_trx_spm,t2.tgl_spp AS tgl_proses,t2.jumlah_bayar, t1.posisi, t2.untuk_bayar FROM trx_nomor_tup_nihil AS tt1 JOIN trx_tup_nihil AS t1 ON t1.id_trx_nomor_tup_nihil = tt1.id_trx_nomor_tup_nihil JOIN trx_spp_tup_nihil_data AS t2 ON t2.nomor_trx_spp = tt1.id_trx_nomor_tup_nihil LEFT JOIN trx_spm_tup_nihil_data AS t3 ON t3.nomor_trx_spm = t1.id_trx_nomor_tup_nihil_spm WHERE tt1.kode_unit_subunit = '{$kode_unit_subunit}' AND jenis = 'SPP' AND tt1.tahun = '{$tahun}' AND t1.aktif = '1' AND t1.tgl_proses GROUP BY tt1.id_trx_nomor_tup_nihil ORDER BY tt1.id_trx_nomor_tup_nihil DESC" ;
...
//                var_dump($result);die;
        ...
        function get_daftar_spm($kode_unit_subunit,$tahun){
            ...
            $query = "SELECT *,t1.tgl_proses AS tgl_proses_status "
                    ...
                    . "AND tt1.tahun = '{$tahun}' "
                    . "AND t1.id_trx_tup_nihil = ( "
                        . "SELECT MAX(t2.id_trx_tup_nihil) FROM trx_tup AS t2 "
                        . "WHERE t2.id_trx_nomor_tup = t1.id_trx_nomor_tup )" ;
...
//                var_dump($result);die;
        ...
        function proses_data_spp($data){
            return $this->db->insert("trx_spp_tup_nihil_data",$data);
        }
        
        function get_data_spp($str_nomor_trx){
            $this->db->where('str_nomor_trx',$str_nomor_trx);
            $query = $this->db->get("trx_spp_tup_nihil_data");
    //	print_r($query);die;
//            if($query->num_rows()>0){
                    return $query->row();
//            }else{
...
//            }
        ...
        function proses_data_spm($data){
            return $this->db->insert("trx_spm_tup_nihil_data",$data);
        }
        
        function get_data_spm($str_nomor_trx){
            $this->db->where('str_nomor_trx',$str_nomor_trx);
            $query = $this->db->get("trx_spm_tup_nihil_data");
    //	print_r($query);die;
//            if($query->num_rows()>0){
                    return $query->row();
//            }else{
...
//            } 
        ...
        function proses_tup_nihil_spp_rka($data){
    ...
    //                echo $query ; die;
        ...
        function tolak_tup_nihil_spp_rka($data){
    ...
    //                echo $query ; die;
        ...
        function proses_tup_nihil_spm_rka($data){
    ...
    //                echo $query ; die;
        ...
        function proses_tup_nihil_cair_rka($data){
    ...
    //                echo $query ; die;
        ...
        function tolak_tup_nihil_spm_rka($data){
...
//            var_dump($q->result());die;
    //            var_dump($q->num_rows());die;
        ...
        function get_notif_approve($kode_unit_subunit,$level,$id_user_verifikator){
                    ...
                    $query = '' ;
                        ...
                        if($level == '14'){ // PPK SUKPA
                           $query = "SELECT COUNT(posisi) AS jml FROM trx_tup_nihil WHERE ( posisi = 'SPP-DRAFT' OR posisi = 'SPP-FINAL' ) AND kode_unit_subunit = '{$kode_unit_subunit}' AND aktif = '1' " ; 

                           // echo $query; die;

                        }else if($level == '2'){ // KPA
                            $query = "SELECT COUNT(posisi) AS jml FROM trx_tup_nihil WHERE posisi = 'SPM-DRAFT-PPK' AND kode_unit_subunit = '{$kode_unit_subunit}' AND aktif = '1' " ; 
                            ...
                            $query = "SELECT COUNT(posisi) AS jml FROM trx_tup_nihil WHERE posisi = 'SPM-DRAFT-KPA' AND SUBSTR(kode_unit_subunit,1,2) IN ({$str_unit}) AND aktif = '1' " ; 

                           // echo $query ; die ;

                        }else if($level == '11'){ // KBUU
                            $query = "SELECT COUNT(posisi) AS jml FROM trx_tup_nihil WHERE posisi = 'SPM-FINAL-VERIFIKATOR' AND aktif = '1' GROUP BY  posisi " ;
        ...
        function insert_tup_to_nihil($ks_to_nihil){


                return $this->db->insert("trx_tup_to_nihil",$ks_to_nihil);
        ...
        function get_nomor_spp_urut($unit,$tahun){
            ...
            $query = "SELECT MAX(id_trx_nomor_tup_nihil) AS id_max FROM  trx_nomor_tup_nihil WHERE kode_unit_subunit = '{$unit}' AND tahun = '{$tahun}' AND jenis = 'SPP' " ;
        ...
        function get_nomor_spp_urut_by_nomor_spp($str_nomor_trx_spp){
            ...
            $query = "SELECT id_trx_nomor_tup_nihil FROM  trx_nomor_tup_nihil WHERE str_nomor_trx = '{$str_nomor_trx_spp}' " ;
            ...
            $q = $this->db->query($query);
                    ...
                    if(!is_null($q->row()->id_trx_nomor_tup_nihil)){
                       return $q->row()->id_trx_nomor_tup_nihil;
                    }else{
                        return '0';
                    }
        ...
        function get_data_untuk_pekerjaan($q,$kode_unit_subunit,$tahun){
            ...
            $query = "SELECT DISTINCT(untuk_bayar) FROM  trx_spp_tup_nihil_data WHERE untuk_bayar LIKE '%{$q}%' AND kode_unit_subunit = '{$kode_unit_subunit}' AND tahun = '{$tahun}' " ;
        ...
        function get_data_penerima($q,$kode_unit_subunit,$tahun){
            ...
            $query = "SELECT DISTINCT(CONCAT(penerima,'|',alamat,'|',nmbank,'|',nmrekening,'|',rekening,'|',npwp)) AS str_penerima FROM  trx_spp_tup_nihil_data WHERE penerima LIKE '%{$q}%' AND kode_unit_subunit = '{$kode_unit_subunit}' AND tahun = '{$tahun}' " ;
        ...
        function get_data_json($data,$kode_unit_subunit,$tahun){
            ...
            $query = "SELECT DISTINCT({$key[0]}) FROM  trx_spp_tup_nihil_data WHERE {$key[0]} LIKE '%{$data[$key[0]]}%' AND kode_unit_subunit = '{$kode_unit_subunit}' AND tahun = '{$tahun}' " ;
        ...
        function check_exist_tup_nihil($nomor_trx,$tahun){
            $this->db->where('str_nomor_trx',$nomor_trx);
            $this->db->where('tahun',$tahun);
            $query = $this->db->get('trx_nomor_tup_nihil');
            if ($query->num_rows()>0){
                return true;
            }else{
                return false;
        ...
        function get_trx_tup_to_nihil_by_spp_tup_nihil($str_nomor_trx_spp_tup_nihil){
            $query = "SELECT * FROM trx_tup_to_nihil WHERE str_nomor_trx_spp_tup_nihil = '{$str_nomor_trx_spp_tup_nihil}'" ;
        ...
        function get_status_spm_tup($str_nomor_trx_spm_tup){

            $query = "SELECT COUNT(aktif) AS stts FROM trx_tup_to_nihil WHERE str_nomor_trx_spm_tup = '{$str_nomor_trx_spm_tup}' AND aktif = '1'" ;
        ...
        function nonaktifkan_status_spp_tup($str_nomor_trx_spp_tup_nihil){

            $query = "UPDATE trx_tup_to_nihil SET aktif = '0' WHERE str_nomor_trx_spp_tup_nihil = '{$str_nomor_trx_spp_tup_nihil}' AND aktif = '1'" ;
        ...
        function proses_tup_to_nihil($data){

            $query = "UPDATE trx_tup_to_nihil SET str_nomor_trx_spm_tup_nihil = '{$data['str_nomor_trx_spm_tup_nihil']}',tgl_proses_tup_nihil = '{$data['tgl_proses_tup_nihil']}' WHERE str_nomor_trx_spp_tup_nihil = '{$data['str_nomor_trx_spp_tup_nihil']}' AND aktif = '1'" ;
        ...
        function check_tup_nihil_done($str_nomor_trx_spm_tup){
            $query = "SELECT COUNT(str_nomor_trx_spm_tup_nihil) AS stts FROM trx_tup_to_nihil WHERE str_nomor_trx_spm_tup = '{$str_nomor_trx_spm_tup}' AND aktif = '1'" ;
