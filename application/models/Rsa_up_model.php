...
//                var_dump($result);die;
        ...
        function get_up_subunit_usul($tahun){
            ...
            $query = "SELECT rba.subunit.nama_subunit,rba.subunit.kode_subunit,rsa.trx_up.posisi,rsa.trx_up.aktif,rsa.trx_up.tgl_proses,rsa.trx_up.tahun "
                    . "FROM rba.subunit LEFT JOIN rsa.trx_up ON rba.subunit.kode_subunit = rsa.trx_up.kode_unit_subunit "
                    . "WHERE ( rsa.trx_up.aktif = '1' OR rsa.trx_up.aktif IS NULL ) "
                    . "AND ( rsa.trx_up.tahun = '{$tahun}' OR rsa.trx_up.tahun IS NULL ) "
...
//                var_dump($result);die;
        ...
        function get_up_unit_usul_verifikator($id_user_verifikator,$tahun){
            ...
            $query = "SELECT rba.unit.nama_unit,rba.unit.kode_unit,rsa.trx_up.posisi,rsa.trx_up.aktif,rsa.trx_up.tgl_proses,rsa.trx_up.tahun "
                    ...
                    . "LEFT JOIN rsa.trx_up ON rba.unit.kode_unit = rsa.trx_up.kode_unit_subunit "
                    . "WHERE rsa_verifikator_unit.id_user_verifikator = '{$id_user_verifikator}' "
                    . "AND ( rsa.trx_up.aktif = '1' OR rsa.trx_up.aktif IS NULL ) "
                    . "AND ( rsa.trx_up.tahun = '{$tahun}' OR rsa.trx_up.tahun IS NULL ) "
                    . "GROUP BY rba.unit.kode_unit "
                    . "ORDER BY rba.unit.kode_unit ASC";
...
//                var_dump($result);die;
        ...
        function get_up_subunit_usul_verifikator($id_user_verifikator,$tahun){
            ...
            $query = "SELECT rba.subunit.nama_subunit,rba.subunit.kode_subunit,rsa.trx_up.posisi,rsa.trx_up.aktif,rsa.trx_up.tgl_proses,rsa.trx_up.tahun "
                    ...
                    . "LEFT JOIN rsa.trx_up ON rba.subunit.kode_subunit = rsa.trx_up.kode_unit_subunit "
                    . "WHERE rsa_verifikator_unit.id_user_verifikator = '{$id_user_verifikator}' "
                    . "AND ( rsa.trx_up.aktif = '1' OR rsa.trx_up.aktif IS NULL ) "
                    . "AND ( rsa.trx_up.tahun = '{$tahun}' OR rsa.trx_up.tahun IS NULL ) "
                    . "GROUP BY rba.subunit.kode_subunit "
...
//                var_dump($result);die;
        ...
        function get_up_subunit($tahun){
            
            $query = "SELECT rba.subunit.nama_subunit,rba.subunit.kode_subunit,rsa.kas_bendahara.saldo "
                    . "FROM rba.subunit "
                    . "LEFT JOIN rsa.kas_bendahara ON rba.subunit.kode_subunit = rsa.kas_bendahara.kd_unit "
                    . "WHERE ( rsa.kas_bendahara.aktif = '1' OR rsa.kas_bendahara.saldo IS NULL ) "
                    . "AND ( rsa.kas_bendahara.tahun = '{$tahun}' OR rsa.kas_bendahara.tahun IS NULL ) "
                    . "ORDER BY rba.subunit.kode_subunit ASC" ;
