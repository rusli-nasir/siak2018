        ...
        function check_dokumen_up($kode_unit_subunit,$tahun,$id_trx_nomor_up = ""){
            ...
            if($id_trx_nomor_up !=""){
                ...
                $q = $this->db->query("SELECT posisi FROM trx_up WHERE kode_unit_subunit = '{$kode_unit_subunit}' AND aktif = '1'  AND tahun = '{$tahun}' AND id_trx_nomor_up = '{$id_trx_nomor_up}' ");
                 ...
                 // echo "SELECT posisi FROM trx_up WHERE kode_unit_subunit = '{$kode_unit_subunit}' AND aktif = '1'  AND tahun = '{$tahun}' AND id_trx_nomor_up = '{$id_trx_nomor_up}' " ; die ;
            }
...
//        }
        ...
        function check_dokumen_up_by_str_trx($no_str_trx){
                ...
                // echo "SELECT trx_up.posisi FROM trx_up JOIN trx_nomor_up ON trx_up.id_trx_nomor_up = trx_nomor_up.nomor_trx WHERE trx_nomor_up.str_nomor_trx = '{$no_str_trx}'  " ;  die;

                $q = $this->db->query("SELECT trx_up.posisi FROM trx_up JOIN trx_nomor_up ON trx_up.id_trx_nomor_up = trx_nomor_up.id_trx_nomor_up WHERE trx_nomor_up.str_nomor_trx = '{$no_str_trx}' AND  trx_up.aktif = '1' ");
