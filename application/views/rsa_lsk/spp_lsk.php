...
$(document).ready(function(){
    ...
    //                        
        ...
        //   source: function(query, process) {
        //             return $.get("<?=site_url('rsa_lsk/get_data_json')?>", { query : query }, function (data) {
        //                 // console.log(data);
        //                 data = $.parseJSON(data);
        //                 return process(data);
        //             });
        ...
        $("#nama_pihak_ketiga").typeahead({
          source: function(query, process) {
                    return $.get("<?=site_url('rsa_lsk/get_data_penerima')?>", { query : query }, function (data) {
                        // console.log(item);
                        data = $.parseJSON(data);
                        return process(data);
...
//    var pj_p_nilai_all = [];
  ...
  // do something…
    ...
    <?php if(($doc_lsk == '')&&($detail_lsk['nom'] == '0')&&($detail_lsk['pengembalian'] == '0'))://if($detail_lsk['nom'] == '0'):?>
...
//    }).show();
        ...
        $('#myModalKonfirm').on('show.bs.modal', function (e) {
            // do something...
            // alert('te');
            var pengeluaran_m = <?=$detail_lsk['nom']?> ;
            var pengembalian_n = <?=$detail_lsk['pengembalian']?> ;
    ...
    $(document).on("click",'#btn-edit-rincian',function(){
        ...
        // if($("#simpan_rincian_spp").validationEngine("validate")){
            ...
            $('#nomor_kontrak_input').val($('#nomor_kontrak').text());
            $('#tgl_kontrak_input').val($('#tgl_kontrak').text());
            $('#nilai_kontrak_input').val($('#nilai_kontrak').text());
            $('#nilai_kontrak_terbayar_input').val($('#nilai_kontrak_terbayar').text());
            $('#termin_input').val($('#termin').text());
            $('#jenis_kegiatan_input').val($('#jenis_kegiatan').text());
            $('#nomor_bap_input').val($('#nomor_bap').text());
            $('#nomor_bast_input').val($('#nomor_bast').text());
    ...
    //                        $('#myModalKuitansi').modal('show');
                            if(data=='sukses'){
                                ...
                                window.location = "<?=site_url('rsa_lsk/daftar_spp')?>" ;
...
<div id="page-inner">
    ...
    <?php if((substr($doc_lsk,4,7)=='DITOLAK')&&($detail_lsk['nom'] > 0)){ $stts_bendahara = 'active'; ?>   
    ...
    <?php }elseif($doc_lsk == 'SPP-DRAFT'){ $stts_bendahara = 'done'; $stts_ppk = 'active'; ?>
        <div class="alert alert-info" style="border:1px solid #a94442;">SPP LSK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> menunggu persetujuan <b><span class="text-danger" >PPK </span></b> .</div>
    <?php }elseif($doc_lsk == 'SPP-DITOLAK'){ $stts_bendahara = 'active'; ?>
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPP LSK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >PPK </span></b> <b>[ <a href="javascript:void(0);" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    <?php }elseif($doc_lsk == 'SPP-FINAL'){ $stts_bendahara = 'done';  $stts_ppk = 'done'; ?>   
        <div class="alert alert-info" style="border:1px solid #a94442;">SPP LSK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah diterima oleh <b><span class="text-danger" >PPK </span></b> .</div>
    ...
    <?php }elseif($doc_lsk == 'SPM-DITOLAK-KPA'){ $stts_bendahara = 'active'; ?>   
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPM LSK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >KPA </span></b> <b>[ <a href="javascript:void(0);" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    ...
    <?php }elseif($doc_lsk == 'SPM-DITOLAK-VERIFIKATOR'){ $stts_bendahara = 'active'; ?>   
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPM LSK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >VERIFIKATOR </span></b> <b>[ <a href="javascript:void(0);" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    ...
    <?php }elseif($doc_lsk == 'SPM-DITOLAK-KBUU'){ $stts_bendahara = 'active'; ?>   
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPM LSK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >KUASA BUU </span></b> <b>[ <a href="javascript:void(0);" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    ...
    <?php }elseif($doc_lsk == 'SPM-DITOLAK-BUU'){ $stts_bendahara = 'active'; ?>   
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPM LSK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >BUU </span></b> <b>[ <a href="javascript:void(0);" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    <?php } ?>
		...
		<table id="table_spp" style="font-family:arial;font-size:12px; line-height: 21px;border-collapse: collapse;width: 900px;border: 1px solid #000;background-color: #FFF;" cellspacing="0" border="1" cellpadding="0" >
			<tbody>
                            ...
                            <tr style="">
                                ...
                                <tr style="border-top: none;">
                                    <td colspan="2" style="border-right: none;border-top:none;"><b>Tanggal	: <?php setlocale(LC_ALL, 'id_ID.utf8'); echo $tgl_spp==''?'':strftime("%d %B %Y", strtotime($tgl_spp)); ?><span id="tgl_spp_text" ></span></b></td>
				...
				<tr>
                                    <td colspan="5" style="line-height: 16px;border-bottom: none;border-top: none;">
                                        <ol style="list-style-type: lower-alpha;margin-top: 0px;margin-bottom: 0px;" >
                                            <li>Jumlah pembayaran yang diminta : Rp. <span id="jumlah_bayar" style='mso-number-format:"\@";'><?=number_format($detail_lsk['nom'], 0, ",", ".")?></span>,-<br>
                                                &nbsp;&nbsp;&nbsp;(Terbilang : <b><span id="terbilang"><?=ucwords($detail_lsk['terbilang'])?> <?php echo substr($detail_lsk['terbilang'],strlen($detail_lsk['terbilang'])-6,6) == 'Rupiah' ? '' : 'Rupiah' ; ?></span></b>)</li>
    ...
    <input type="text" name="dtahun" id="dtahun" value="<?=$cur_tahun?>" />
            ...
            <div class="alert alert-warning" style="text-align:center">
                <?php if($doc_lsk == ''){ ?>
                    ...
                    <a href="<?=site_url('kuitansi/daftar_kuitansi/LK')?>" class="btn btn-success" ><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Daftar Kuitansi</a>
                ...
                <?php }elseif(($doc_lsk == 'SPP-DITOLAK')||($doc_lsk == 'SPM-DITOLAK-KPA')||($doc_lsk == 'SPM-DITOLAK-VERIFIKATOR')||($doc_lsk == 'SPM-DITOLAK-KBUU')||($doc_lsk == 'SPM-DITOLAK-BUU')){ ?>
                    <?php if($detail_lsk['nom'] == '0'):?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>
            <div class="form-group">
                <blockquote class="">
                <p class="text-danger">Untuk membuat SPP LSK silahkan anda memulai dari daftar kuitansi yang akan diusulkan.</p>
              </blockquote>
            </div>
        </p>
      </div>
      ...
      <div class="modal-body">
          <form class="form-horizontal" id="simpan_rincian_spp">
            ...
            <div class="alert alert-danger" id="div-koreksi-kontrak" style="display:none">
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label">Untuk Pekerjaan</label>
                  <div class="col-sm-9">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control validate[required]" id="tgl_spp_dibuat" value="<?=date('Y-m-d')?>" readonly="readonly" placeholder="INI UNTUK TGL SPP YG DULU"> <!-- readonly="readonly" -->
                  </div>
                </div>
                <fieldset>
