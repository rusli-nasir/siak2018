...
$('#myModalKonfirm').on('hidden.bs.modal', function (e) {
   ...
   $(document).on("click",'#proses_spm_verifikator',function(){
                    ...
                    if(result != ''){
                        ...
                        if(confirm("Yakin ?")){
                            ...
                            if(confirm('Apakah anda yakin ?')){
                                var data = 'proses=' +'SPM-FINAL-VERIFIKATOR' + '&nomor_trx=' + $('#nomor_trx_spm').html() + '&jenis=' + 'SPM'  + '&kd_unit=' + '<?=$kd_unit?>' + '&tahun=' + '<?=$cur_tahun?>' + '&id_nomor_lsk=' + '<?=$id_nomor_lsk?>'  + '&tgl_proses=' + r ;
                                    $.ajax({
                                        type:"POST",
                        ...
                        //                        $('#myModalKuitansi').modal('show');
                                                if(data=='sukses'){
                                                    // location.reload();
                                                    window.location = '<?=site_url('rsa_lsk/daftar_spm_verifikator/').$cur_tahun.'/'.$kd_unit?>';
                                                }
                        //                        
                                        }
                                    });
    ...
    $(document).on("click",'#tolak_spm_verifikator',function(){
        if(confirm('Apakah anda yakin ?')){
            var data = 'proses=' + 'SPM-DITOLAK-VERIFIKATOR' + '&nomor_trx=' + $('#nomor_trx_spm').html() + '&jenis=' + 'SPM' + '&ket=' + $('#ket').val() + '&rel_kuitansi=' + encodeURIComponent('<?=$rel_kuitansi?>') + '&rel_kuitansi_pengembalian=' + encodeURIComponent('<?=$rel_kuitansi_pengembalian?>') + '&kd_unit=' + '<?=$kd_unit?>' + '&tahun=' + '<?=$cur_tahun?>' + '&id_nomor_lsk=' + '<?=$id_nomor_lsk?>' + '&tgl_proses=' + '<?=date("Y-m-d")?>' ;
            $.ajax({
                type:"POST",
                url :"<?=site_url('rsa_lsk/proses_spm_lsk')?>",
                data:data,
...
<form action="<?=site_url('rsa_up/cetak_spp')?>" id="form_spp" method="post" style="display: none"  >
    <input type="text" name="dtable" id="dtable" value="" />
            ...
            <div class="alert alert-warning" style="text-align:center">
                ...
                <?php if($doc_lsk == 'SPM-DRAFT-KPA'){ ?>
                    <a href="#" class="btn btn-warning" id="proses_spm_verifikator"><span class="glyphicon glyphicon-check" aria-hidden="true"></span> Setujui SPM</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" id="tolak_spm_verifikator">Submit</button>
