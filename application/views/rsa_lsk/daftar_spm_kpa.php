      ...
      $('#spm_tab a[href="' + hash + '"]').tab('show');
		...
		$(document).on("click","#pilih_tahun",function(){
                        ...
                        var type = window.location.hash.substr(1);
                            ...
                            window.location = "<?=site_url("rsa_lsk/daftar_spm_kpa")?>/" + $("#tahun").val() ; // + '#' + type;
        ...
        <?php var_dump($_SESSION); ?>
            */
            ...
            string = $(this).text() ,substring = "SPM-DRAFT-PPK";
            if(string.indexOf(substring) !== -1){
  ...
  <!-- Tab panes -->
	...
	?>
					<tr >
						...
						<?php elseif($value->posisi == 'SPM-DRAFT-PPK'):?>
						<td class="text-center"><b>[ <a href="<?=site_url('/rsa_lsk/spm_lsk_kpa/').urlencode(base64_encode($value->str_nomor_trx_spp))?>">lihat</a> ]</b></td>
						<?php else:?>
