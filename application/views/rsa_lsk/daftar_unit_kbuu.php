...
$(document).on("click","#show",function(){
    if($("#form_").validationEngine("validate")){
        window.location = "<?=site_url('rsa_lsk/daftar_unit_kbuu/')?>" + $('#tahun').val();
                                ...
                                <?php foreach($unit_usul as $i => $u){ ?>
                                    <?php if(($u->kode_unit == '41')||($u->kode_unit == '42')||($u->kode_unit == '43')||($u->kode_unit == '44')): ?>
                                        ...
                                        <tr rel="<?=$uu->kode_subunit?>" class="tr-unit warning" height="25px">
                                            ...
                                            <td align="center">
                                                ...
                                                <a href="<?=site_url("rsa_lsk/daftar_spm_kbuu/".$cur_tahun.'/'.$uu->kode_subunit)?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-share" aria-hidden="true"></span> Lihat</a>

                                                <?php else: ?>

                                                <a href="<?=site_url("rsa_lsk/daftar_spm_kbuu/".$cur_tahun.'/'.$uu->kode_subunit)?>" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-share" aria-hidden="true"></span> Lihat</a>
                                    ...
                                    <tr rel="<?=$u->kode_unit?>" class="tr-unit" height="25px">
                                        ...
                                        <td align="center">
                                            ...
                                            <a href="<?=site_url("rsa_lsk/daftar_spm_kbuu/".$cur_tahun.'/'.$u->kode_unit)?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-share" aria-hidden="true"></span> Lihat</a>

                                            <?php else: ?>

                                            <a href="<?=site_url("rsa_lsk/daftar_spm_kbuu/".$cur_tahun.'/'.$u->kode_unit)?>" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-share" aria-hidden="true"></span> Lihat</a>
