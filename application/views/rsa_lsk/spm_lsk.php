...
$(document).ready(function(){
    ...
    // bootbox.alert({
    //         title: "PESAN",
    //         message: "MAAF JANGAN DI SUBMIT DULU, SEDANG DIPERBAIKI. THX.",
    //     });

    
    $('#tgl_spm_dibuat').datepicker({
                format: 'yyyy-mm-dd'
            });


    <?php if($doc_lsk == 'SPP-FINAL'){ ?>
    ...
    $('#spm_tab a').click(function(e) {
        ...
        var type2 = window.location.hash.substr(1);
...
$('#myModalKonfirm').on('hidden.bs.modal', function (e) {
    ...
    $(document).on("click",'#proses_spp',function(){
        if(confirm('Apakah anda yakin ?')){
            var data = 'proses=' + 'SPP-FINAL' + '&nomor_trx=' + $('#nomor_trx').html() + '&jenis=' + 'SPP' + '&id_nomor_lsk=' + '<?=$id_nomor_lsk?>' ;
            $.ajax({
                type:"POST",
                url :"<?=site_url('rsa_lsk/proses_spp_lsk')?>",
                data:data,
...
//                        
    ...
    $(document).on("click",'#proses_spm',function(){
        ...
        // bootbox.prompt("Masukan tgl SPM :",function(result){
...
//                        $('#myModalKuitansi').modal('show');
                        if(data=='sukses'){
                            window.location = '<?=site_url('rsa_lsk/daftar_spm')?>';
                        }
//                        
                }
            });
    ...
    $(document).on("click",'#btn_simpan_rincian_spm',function(){

        if($("#simpan_rincian_spm").validationEngine("validate")){


            if($('#alias_spm').val()!='-'){
                $('#alias_spm_text').text('( '+ $('#alias_spm').val() +' )');
                $('#alias_spm_text').show();
            ...
            var a = moment($('#tgl_spm_dibuat').val());
                $('#tgl_spm_text').text(a.locale("id").format("D MMMM YYYY"));

            $('#myModalRincianSPM').modal('hide');
        }
    });
    
    $(document).on("click",'#tolak_spp_',function(){
        if(confirm('Apakah anda yakin ?')){
            var data = 'proses=' + 'SPP-DITOLAK' + '&nomor_trx=' + $('#nomor_trx').html() + '&jenis=' + 'SPP' + '&ket=' + $('#ket').val() + '&rel_kuitansi=' + encodeURIComponent('<?=$rel_kuitansi?>') + '&rel_kuitansi_pengembalian=' + encodeURIComponent('<?=$rel_kuitansi_pengembalian?>') + '&id_nomor_lsk=' + '<?=$id_nomor_lsk?>';
            $.ajax({
                type:"POST",
                url :"<?=site_url('rsa_lsk/proses_spp_lsk')?>",
                data:data,
...
<div id="page-inner">
    ...
    <?php if($doc_lsk == ''){ $stts_bendahara = 'active'; ?>
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPP LSK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> belum diusulkan oleh bendahara.</div>
    <?php }elseif($doc_lsk == 'SPP-DRAFT'){ $stts_bendahara = 'done'; $stts_ppk = 'active'; ?>
        <div class="alert alert-info" style="border:1px solid #a94442;">SPP LSK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> menunggu persetujuan <b><span class="text-danger" >PPK SUKPA</span></b> .</div>
    <?php }elseif($doc_lsk == 'SPP-DITOLAK'){ $stts_bendahara = 'active'; ?>
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPP LSK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >PPK SUKPA</span></b> <b>[ <a href="#" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    <?php }elseif($doc_lsk == 'SPP-FINAL'){ $stts_bendahara = 'done'; $stts_ppk = 'done'; ?>   
        <div class="alert alert-info" style="border:1px solid #a94442;">SPP LSK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah diterima oleh <b><span class="text-danger" >PPK SUKPA</span></b> .</div>
    <?php }elseif($doc_lsk == 'SPM-DRAFT-PPK'){ $stts_bendahara = 'done'; $stts_ppk = 'done'; $stts_kpa = 'active'; ?>   
        <div class="alert alert-info" style="border:1px solid #a94442;">SPM LSK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> menunggu persetujuan <b><span class="text-danger" >KPA </span></b> .</div>
    <?php }elseif($doc_lsk == 'SPM-DRAFT-KPA'){ $stts_bendahara = 'done'; $stts_ppk = 'done'; $stts_kpa = 'done' ; $stts_verifikator = 'active';  ?>   
        <div class="alert alert-info" style="border:1px solid #a94442;">SPM LSK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> menunggu persetujuan <b><span class="text-danger" >VERIFIKATOR </span></b> .</div>
    <?php }elseif($doc_lsk == 'SPM-DITOLAK-KPA'){ $stts_bendahara = 'active'; ?>   
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPM LSK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >KPA </span></b> <b>[ <a href="#" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    <?php }elseif($doc_lsk == 'SPM-FINAL-VERIFIKATOR'){ $stts_bendahara = 'done'; $stts_ppk = 'done'; $stts_kpa = 'done' ; $stts_verifikator = 'done'; $stts_kbuu = 'active' ?>   
        <div class="alert alert-success" style="border:1px solid #a94442;">SPM LSK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> menunggu persetujuan <b><span class="text-danger" >KUASA BUU </span></b> .</div>
    <?php }elseif($doc_lsk == 'SPM-DITOLAK-VERIFIKATOR'){ $stts_bendahara = 'active'; ?>   
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPM LSK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >VERIFIKATOR </span></b> <b>[ <a href="#" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    <?php }elseif($doc_lsk == 'SPM-FINAL-KBUU'){ $stts_bendahara = 'done'; $stts_ppk = 'done'; $stts_kpa = 'done' ; $stts_verifikator = 'done'; $stts_kbuu = 'done' ?>   
        <div class="alert alert-success" style="border:1px solid #a94442;">SPM LSK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah disetujui oleh <b><span class="text-danger" >KUASA BUU </span></b> .</div>
    <?php }elseif($doc_lsk == 'SPM-DITOLAK-KBUU'){ $stts_bendahara = 'active'; ?>   
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPM LSK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >KUASA BUU </span></b> <b>[ <a href="#" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    <?php }elseif($doc_lsk == 'SPM-FINAL-BUU'){ $stts_bendahara = 'done'; ?> 
        <div class="alert alert-success" style="border:1px solid #a94442;">SPM LSK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah difinalisasi oleh <b><span class="text-danger" >BUU </span></b> .</div>
    <?php }elseif($doc_lsk == 'SPM-DITOLAK-BUU'){ $stts_bendahara = 'active'; ?>   
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPM LSK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >BUU </span></b> <b>[ <a href="#" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    <?php } ?>
			...
			<tbody>
                            ...
                            <tr style="">
                                ...
                                <tr style="border-top: none;border-bottom: none;">
                                    ...
                                    <td style="border-left: none;border-top: none;border-bottom: none;"><b>JENIS : LS-KONTRAK</b></td>
                                </tr>
                                <tr style="border-top: none;">
				...
				<tr>
                                    <td colspan="5" style="line-height: 16px;border-bottom: none;border-top: none;">
                                        <ol style="list-style-type: lower-alpha;margin-top: 0px;margin-bottom: 0px;" >
                                            <li>Jumlah pembayaran yang diminta : Rp. <span id="jumlah_bayar_spp" style='mso-number-format:"\@";'><?php echo isset($detail_lsk['nom'])?number_format($detail_lsk['nom'], 0, ",", "."):''; ?></span>,-<br>
                                                &nbsp;&nbsp;&nbsp;(Terbilang : <b><span id="terbilang_spp"><?php echo isset($detail_lsk['terbilang'])?ucwords($detail_lsk['terbilang']):''; ?></span></b>)</li>
                ...
                <table id="table_f1a" class="table_lamp" style="font-family:arial;font-size:12px; line-height: 21px;border-collapse: collapse;width: 900px;border: 1px solid #000;background-color: #FFF;" cellspacing="0" border="1" cellpadding="0" >
                    <tbody>
                            ...
                            <td colspan="7" style="text-align: center;border-bottom: none;">
                                ...
                                <h5><b>RINCIAN SURAT PERMINTAAN PEMBAYARAN LS-KONTRAK</b></h5>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="5" style="border-left: none;border-top: none;">
                                <ol style="list-style: none;">
                                    <li>: <span id="nomor_kontrak"><?=$detail_kontrak->nomor_kontrak?></span> &nbsp; <span id="tgl_kontrak"><?=$detail_kontrak->tgl_kontrak?></span></li>
                                    <li>: <span id="nilai_kontrak"><?=number_format($detail_kontrak->nilai_kontrak, 0, ",", ".")?></span></li>
                                    <li>: <span id="nilai_kontrak_terbayar"><?=number_format($detail_kontrak->nilai_kontrak_terbayar, 0, ",", ".")?></span></li>
                                    <li>: <span id="termin"><?=$detail_kontrak->termin?></span></li>
                                    <li>: <span id="jenis_kegiatan"><?=$detail_kontrak->jenis_kegiatan?></span></li>
                                    <li>: <span id="nomor_bap"><?=$detail_kontrak->nomor_bap?></span></li>
                                    <li>: <span id="nomor_bast"><?=$detail_kontrak->nomor_bast?></span></li>
...
<div id="myCarouselSPM" class="carousel slide" data-ride="carousel" data-interval="false">
    <ol class="carousel-indicators">
        <li data-target="#myCarouselSPM" data-slide-to="0" class="active">1</li>
        <li data-target="#myCarouselSPM" data-slide-to="1">2</li>
      </ol>
<div class="carousel-inner" role="listbox">
<div class="item active" id="e">
<div id="div-cetak-2">
		<table id="table_spm" style="font-family:arial;font-size:12px; line-height: 21px;border-collapse: collapse;width: 900px;border: 1px solid #000;background-color: #FFF;" cellspacing="0" border="1" cellpadding="0" >
            <tbody>
                            <tr >
                            ...
                            <tr style="">
                                ...
                                <tr style="border-top: none;">
                                    <td colspan="2" style="border-right: none;border-top:none;"><b>Tanggal  : <?php setlocale(LC_ALL, 'id_ID.utf8'); echo $tgl_spm==''?'':strftime("%d %B %Y", strtotime($tgl_spm)); ?><span id="tgl_spm_text" ></span></b></td>
                                    <td style="text-align: center;border-left: none;border-right: none;border-top:none;" colspan="2" >&nbsp;</td>
                                                                                                                <td style="border-left: none;border-top:none;"><b>Nomor : <span id="nomor_trx_spm"><?=$nomor_spm?></span><br><span style="display:none" id="alias_spm_text">( <?=isset($alias_spm)?$alias_spm:''?> )</span></b></td>
                                </tr>
                                <tr >
                                    <td colspan="5"><b>Satuan Unit Kerja Pengguna Anggaran (SUKPA) : <?=$unit_kerja?></b></td>
                                </tr>
                ...
                <tr>
                                    <td colspan="5" style="line-height: 16px;border-bottom: none;border-top: none;">
                                        <ol style="list-style-type: lower-alpha;margin-top: 0px;margin-bottom: 0px;" >
                                            <li>Jumlah pembayaran yang diminta : Rp. <span id="jumlah_bayar" style='mso-number-format:"\@";'><?php echo isset($detail_lsk_spm['nom'])?number_format($detail_lsk_spm['nom'], 0, ",", "."):''; ?></span>,-<br>
                                                &nbsp;&nbsp;&nbsp;(Terbilang : <b><span id="terbilang"><?php echo isset($detail_lsk_spm['terbilang'])?ucwords($detail_lsk_spm['terbilang']):''; ?></span></b>)</li>
                            ...
                            <li>Kebenaran perhitungan dan isi tertuang dalam SPP ini menjadi tanggung jawab Bendahara Pengeluaran sepanjang sesuai dengan bukti-bukti pengeluaran yang telah ditandatangani oleh PPPK atau PPK</li>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" style="vertical-align: top;line-height: 16px;padding-left: 10px;">
                                        <?php if(isset($detail_lsk_spm['nom'])){ ?>
                                            <?php if($detail_lsk_spm['nom'] >= 100000000){ ?>
                                            Setuju dibayar : <br>
...
<div id="div-cetak-f1a-2">
                <table id="table_f2a" class="table_lamp" style="font-family:arial;font-size:12px; line-height: 21px;border-collapse: collapse;width: 900px;border: 1px solid #000;background-color: #FFF;" cellspacing="0" border="1" cellpadding="0" >
                    <tbody>
                            <tr >
                            ...
                            <td colspan="7" style="text-align: center;border-bottom: none;">
                                <h4><b>UNIVERSITAS DIPONEGORO</b></h4>
                                <h5><b>RINCIAN SURAT PERINTAH MEMBAYAR LS-KONTRAK</b></h5>
                            </td>
                        </tr>
                        <tr>
                            <td style="border-right: none;border-top: none;border-bottom: none;">&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td colspan="5" style="border-left: none;border-top: none;">
                                <ol style="list-style: none;">
                                    <li>: <?=$detail_spm_kontrak->nomor_kontrak?> &nbsp; <?=$detail_spm_kontrak->tgl_kontrak?></li>
                                    <li>: <?=number_format($detail_spm_kontrak->nilai_kontrak, 0, ",", ".")?></li>
                                    <li>: <?=number_format($detail_spm_kontrak->nilai_kontrak_terbayar, 0, ",", ".")?></li>
                                    <li>: <?=$detail_spm_kontrak->termin?></li>
                                    <li>: <?=$detail_spm_kontrak->jenis_kegiatan?></li>
                                    <li>: <?=$detail_spm_kontrak->nomor_bap?></li>
                                    <li>: <?=$detail_spm_kontrak->nomor_bast?></li>
                                    <li>:</li>
                                </ol>
                            </td>
                        </tr>
                    ...
                    <tbody>
                            ...
                            <tr >
                                <td colspan="6" class="text-center" style="text-align: center;border: none;">
                                    <h4><b>UNIVERSITAS DIPONEGORO</b></h4>
                                    <h5><b>SURAT PERTANGGUNGJAWABAN LS KONTRAK</b></h5>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">SPJ LSK s.d BULAN LALU<br>( Rp )</td>
                                <td class="text-center">SPJ LSK BULAN INI<br>( Rp )</td>
                                <td class="text-center">SPJ LSK s.d BULAN INI<br>( Rp )</td>
                            </tr>
                            <tr >
                                <td style="">&nbsp;</td>
                                <td style="">&nbsp;</td>
...
<!-- Modal -->
<div class="modal" id="myModalRincianSPM" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <!--<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>-->
        <h5 class="modal-title">ALIAS SPM</h5>
      </div>
      <div class="modal-body">
          <form class="form-horizontal" id="simpan_rincian_spm">
                <div class="form-group">
                  <label class="col-sm-3 control-label">Alias SPM</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control validate[required]" id="alias_spm" readonly="readonly" value="-" placeholder="INI UNTUK ALIAS SPM YG DULU"> 
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label">Tgl SPM</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control validate[required]" id="tgl_spm_dibuat" readonly="readonly" value="<?=date('Y-m-d')?>" placeholder="INI UNTUK TGL SPM YG DULU"> <!-- readonly="readonly" -->
                  </div>
                </div>
              </form>
      </div>
      <div class="modal-footer">
        <div class="col-sm-offset-2 col-sm-10">
                      <button type="button" class="btn btn-success" id="btn_simpan_rincian_spm"><span class="glyphicon glyphicon-ok"></span> Simpan</button>
                      <!-- <button type="button" class="btn btn-danger" data-dismiss="modal"><span class="glyphicon glyphicon-repeat"></span> Batal</button> -->
                      <a href="<?=site_url('rsa_lsk/daftar_spm')?>" class="btn btn-danger"><span class="glyphicon glyphicon-repeat"></span> Batal</a>
                  </div>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
