...
$('#myModalKonfirm').on('hidden.bs.modal', function (e) {
        ...
        //             if(result != ''){
                        ...
                        // if(confirm("Yakin ?")){
                            ...
                            if(confirm('Apakah anda yakin ?')){
                                var data = 'proses=' + 'SPM-DRAFT-KPA' + '&nomor_trx=' + $('#nomor_trx_spm').html() + '&jenis=' + 'SPM' + '&id_nomor_lsk=' + '<?=$id_nomor_lsk?>' + '&tgl_proses=' + r ;
                                $.ajax({
                                    type:"POST",
                    ...
                    //                        $('#myModalKuitansi').modal('show');
                                            if(data=='sukses'){
                                                window.location = '<?=site_url('rsa_lsk/daftar_spm_kpa')?>';
                                            }
                    //                        
                                    }
                                });
    ...
    $(document).on("click",'#tolak_spm_kpa',function(){
        if(confirm('Apakah anda yakin ?')){
            var data = 'proses=' + 'SPM-DITOLAK-KPA' + '&nomor_trx=' + $('#nomor_trx_spm').html() + '&jenis=' + 'SPM' + '&ket=' + $('#ket').val() + '&rel_kuitansi=' + encodeURIComponent('<?=$rel_kuitansi?>') + '&rel_kuitansi_pengembalian=' + encodeURIComponent('<?=$rel_kuitansi_pengembalian?>')  + '&id_nomor_lsk=' + '<?=$id_nomor_lsk?>' + '&tgl_proses=' + '<?=date("Y-m-d")?>' ;
            $.ajax({
                type:"POST",
                url :"<?=site_url('rsa_lsk/proses_spm_lsk')?>",
                data:data,
...
<div id="page-inner">
    ...
    <?php }elseif($doc_lsk == 'SPP-DITOLAK'){ $stts_bendahara = 'done'; ?>
    ...
    <?php }elseif($doc_lsk == 'SPM-DITOLAK-KPA'){ $stts_bendahara = 'done'; $stts_ppk = 'done'; ?>   
