...
//                            var sumber_dana = $('#sumber_dana').val();
                            window.location = "<?=site_url('rsa_'.$jenis.'/daftar_spm_kpa')?>/" + $("#tahun").val();
...
<div id="page-wrapper">
	...
	?>
					<tr>
						...
						<td class="text-center"><b>[ <a href="<?=site_url('/rsa_'.$jenis.'/spm_'.$jenis.'_kpa/').urlencode(base64_encode($value->str_nomor_trx_spp))?>#spm">lihat</a> ]</b></td>
						<?php else:?>
