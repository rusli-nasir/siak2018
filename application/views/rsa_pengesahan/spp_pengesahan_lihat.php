                ...
                <table id="table_rekappajak" class="table_lamppajak" style="font-family:arial;font-size:12px; line-height: 21px;border-collapse: collapse;width: 1300px;border: 1px solid #000;background-color: #FFF;" cellspacing="0" border="1" cellpadding="0" >
                    <tbody>
                            ...
                            <tr>
                                ...
                                <?php // $tot_bruto = $tot_bruto + (isset($data_rekap_bruto[$data_pajak][$i]->jml_bruto)?$data_rekap_bruto[$data_pajak][$i]->jml_bruto:0) ;?>
                            ...
                            <tr>
                                ...
                                <td class="text-right" style='padding-right: 10px;mso-number-format:"\@";'><b><?=number_format($tot_pajak_potongan, 0, ",", ".")?></b></td>
                                <td class="text-right" style='padding-right: 10px;mso-number-format:"\@";'><b><?=number_format($tot_pajak_tabungan, 0, ",", ".")?></b></td>
          ...
          <div class="modal-body" style="margin:0px;padding:15px;background-color: #EEE;">
            ...
            <tr>
                            <td colspan="7" style="vertical-align: top;">Setuju dibebankan pada mata anggaran berkenaan, <br />
                                ...
                                <?php else: ?>
                                Pejabat Pelaksana dan Pengendali Kegiatan (PPPKs)
                                <?php endif; ?>
                            </td>
