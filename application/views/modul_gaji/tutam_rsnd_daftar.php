<script type="text/javascript">
	$(function(){
		...
		$('#kriteria_tutam_lihat').on('hidden.bs.modal', function () {
				$('#form-tutam_lihat')[0].reset();
		});
...
?>
                <tr>
                  ...
                  <td><?php echo $v->nmbank; ?><br /><?php echo $v->norekening; ?></td>
    ...
    <div class="modal-content">
      <form id="form-tutam-lihat" action="<?php echo site_url('tutam_rsnd/tutam_proses'); ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-header">
          ...
          <h5 class="modal-title" id="myModalLabel"><i class="fa fa-spinner"></i>&nbsp;&nbsp;&nbsp;Cari Data Insentif Tugas Tambahan</h5>
        </div>
