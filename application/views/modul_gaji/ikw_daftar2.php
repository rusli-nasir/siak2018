	...
	<div id="page-inner">
        ...
        <div class="col-md-12" style="background-color:#ccc;padding:5px;">
        	<div class="text-right" style="position:fixed;top:55%;z-index:1;right:0;">
              ...
              <button type="button" class="btn btn-default btn-sm cetak" title="Cetak daftar ini"><i class="glyphicon glyphicon-print"></i>&nbsp;&nbsp;&nbsp;Cetak</button>
            </span>
            ...
            <div>
            	<ul class="nav nav-tabs" role="tablist" id="kentut_tab">
              	<li role="presentation" class="active"><a href="javascript:void();" role="tab" data-toggle="tab" aria-expanded="true" data-original-title="" title="Daftar Potongan IKW berdasarkan absensi" class="pot_ikw"><i class="glyphicon glyphicon-list"></i>Pot. IKW</a></li>
                <li role="presentation"><a href="javascript:void();" role="tab" data-toggle="tab" aria-expanded="true" data-original-title="" title="Daftar IKW hasil jadi" class="ikw_jadi"><i class="glyphicon glyphicon-list"></i>IKW Total</a></li>
              </ul>
            </div>
            <form id="sword_art_online">
            <input type="hidden" name="act" value="ikw_simpan_pot_ikw" />
            <table class="table table-bordered table-striped small">
                ...
                <tr>
                  ...
                  <th class="text-center">IKW</th>
                  <th class="text-center" width="80">Capaian Semester Sebelum</th>
                  <th class="text-center" width="80">Kinerja Wajib</th>
                  <th class="text-center">Kinerja Tidak Tercapai</th>
...
if(isset($dt) && is_array($dt) && count($dt)>0){
	$i=1;
	$total_bruto = 0; $total_pot_ikw = 0;
	foreach($dt as $k => $v){
?>
									<input type="hidden" name="id[]" value="<?php echo $v->id_trans; ?>" />
                  <input type="hidden" name="ikw[]" value="<?php echo $v->ikw; ?>" />
                  <input type="hidden" name="pajak[]" value="<?php echo $v->pajak; ?>" />
                  <input type="hidden" name="pot_lainnya[]" value="<?php echo $v->pot_lainnya; ?>" />
                  <tr id="tr_<?php echo $v->id_trans;?>">
                    ...
                    <td class="text-right"><?php echo $this->cantik_model->number($v->ikw); ?></td>
                    <td>
                    	<input type="text" name="capaian_smt_sblm[]" id="capaian_smt_sblm_<?php echo $v->id_trans; ?>" class="text-right form-control input-sm isian" value="<?php echo $v->capaian_smt_sblm; ?>"/>
                      <input type="hidden" name="capaian_smt_sblm_old[]" value="<?php echo $v->capaian_smt_sblm; ?>" />
                    </td>
                    <td>
                    	<input type="text" name="kinerja_wajib[]" id="kinerja_wajib_<?php echo $v->id_trans; ?>" class="text-right form-control input-sm isian" value="<?php echo $v->kinerja_wajib; ?>"/>
                      <input type="hidden" name="kinerja_wajib_old[]" value="<?php echo $v->kinerja_wajib; ?>" />
                    </td>
...
?>
                    ...
                    <th>&nbsp;</th>
                    <th>&nbsp;</th>
                    <th class="text-right"><?php echo $this->cantik_model->number($total_pot_ikw); ?></th>
                    <th>&nbsp;</th>
                  </tr>
<?php
}else{
