            ...
            $(document).on("click","#btn-deskripsi",function(){
                if($("#form_deskripsi").validationEngine("validate")){
                    ...
                    var str = '<tr id="tr_n_'+ n +'" class="tr_k_'+ n +'">' ;
                        str =  str + '<td colspan="3">'+ nomor + '.' + $('#deskripsi').val() +' <span id="tb_hapus_des_'+ nomor +'">[ <a href="#" rel="' + n + '" class="hapus_deskripsi" style="cursor:pointer">hapus</a> ]</span></td>';
                        str =  str + '<td class="text-center">'+ $('#kuantitas').val() +'</td>';
                        str =  str + '<td class="text-left">'+ $('#satuan').val() +'</td>';
                        str =  str + '<td class="text-right">'+ angka_to_string($('#jumlah').val()) +'</td>';
                    ...
                    $('.sum_tot_bruto').text(angka_to_string(tot_bruto));
                    $('.sum_tot_netto').text(angka_to_string(tot_bruto));
                    $('.text_tot').html(terbilang(tot_bruto));
	...
	<div id="page-inner">
		<!-- start content -->
                ...
                <div class="row">
                    ...
                    else if($jenis == 'LN'){echo 'LSNK' ;}
                    else if($jenis == 'LK'){echo 'lSK' ;}?></h2> 
                    </div>
                </div>
                <hr />
        ...
        <div class="modal-content">
          ...
          <div class="modal-body" style="margin:0px;padding:15px;background-color: #EEE;">
            ...
            <tr class="tr_up">
                <td colspan="3">Untuk Pembayaran</td>
                <td>: </td>
                                <td colspan="7"><span id="uraian_pengembalian" class="input_boot" style="cursor:pointer">- edit here -</span></td> <!--contenteditable="true" class="edit_here"-->
            </tr>
            <tr class="tr_up">
                <td colspan="3">Sub Kegiatan</td>
                <td>: </td>
