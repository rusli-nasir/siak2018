...
$(document).ready(function(){
	...
	$('#btn-spp2').on('click',function(e){
		$('#modalGedang').modal('show');
	});

	$('#modalGedang').on('hidden.bs.modal',function(e){
		//	
	});

	$('#isian_spp_langsung').on('submit',function(e){
		e.preventDefault();
		var data = $('#isian_spp_langsung').serialize();
		$.post('<?php echo site_url('rsa_lsphk3/proses_bypass_spp'); ?>',data,function(r){
			if(!$.isNumeric(r)){
	...
	$('.jadikan_spp').on('click',function(e){
		...
		$('#isian_spp_langsung #kode_akun_tambah').val(el.substr(24,3));
		$('#isian_spp_langsung #kode_usulan_belanja').val(el.substr(0,24));
		$('#isian_spp_langsung').submit();
	});
...
//            in_all = 0;
            ...
            $.ajax({
                type:"POST",
                url :"<?=site_url("kuitansi_lsphk3/get_next_id")?>",
                data:data,
                success:function(data){
...
//            el.prop('checked',true);
            ...
            if(aktv == '1'){
                ...
                $('#myModalKuitansi2 #kode_badge').text(badge_tmp);
				 $('#myModalKuitansi3 #kode_badge').text(badge_tmp);
            }else{
                $('#btn-dataspp').attr('rel','');
				        $('#btn-kuitansi2').attr('rel','');
                $('#btn-submit-kuitansi').attr('rel','');
                $('#btn-dataspp').attr('disabled','disabled');
				        $('#btn-kuitansi2').attr('disabled','disabled');
                // untuk spp ls created by dhanu
                $('#btn-spp2').attr('rel', '');
                $('#btn-spp2').attr('disabled','disabled');
                // end here
...
//            }
            ...
            if(aktv == '1'){
                ...
                $('#btn-dataspp').attr('disabled','disabled');
				$('#btn-kuitansi2').attr('rel','');
				$('#btn-submit-kuitansi3').attr('rel','');
                $('#btn-kuitansi2').attr('disabled','disabled');
				 $('#btn-kuitansi3').attr('disabled','disabled');
        ...
        $(document).on("click",'#btn-dataspp',function(){
            // PREPARE GLOBAL VAR
//            in_all = 0;
...
<tr class="">
	...
	<td>
            <span class="label badge-gup">&nbsp;</span> : LS-PIHAK-3 &nbsp;&nbsp;<span class="label badge-tup">&nbsp;</span> : TUP &nbsp;&nbsp;<span class="label badge-lp">&nbsp;</span> : LS-PEGAWAI &nbsp;&nbsp;<span class="label badge-l3">&nbsp;</span> : LS-PIHAK-3 &nbsp;&nbsp;<span class="label badge-ks">&nbsp;</span> : KERJA-SAMA        </td>
						...
						<?php /*	<button type="button" class="btn btn-warning" id="btn-spp2" rel="" disabled="disabled" ><span class="glyphicon glyphicon-duplicate" aria-hidden="true"></span> Buat SPP LSP3</button>*/ ?>
						...
						?>
<button type="button" class="btn btn-success" id="btn-dataspp" rel="" disabled="disabled" ><span class="glyphicon glyphicon-duplicate" aria-hidden="true"></span> Create Data SPP LS 3 NK</button>
							  <a href="<?=site_url('kuitansi_lsphk3/daftar_data_sppnk/')?><?php if($jenis=='1'){echo 'GP';}elseif($jenis=='2'){echo 'LP';}elseif($jenis=='4'){echo 'L3';}elseif($jenis=='3'){echo 'TP';}elseif($jenis=='5'){echo 'KS';}elseif($jenis=='6'){echo 'L3NK';}else{} ?>" class="btn btn-info"><span class="glyphicon glyphicon-equalizer" aria-hidden="true"></span> Daftar Data</a>						
						...
						<?php
                          ...
                          ?>
                            ...
                            <a href="<?=site_url('kuitansi_lsphk3/daftar_kuitansi/')?><?php if($jenis=='1'){echo 'GP';}elseif($jenis=='2'){echo 'LP';}elseif($jenis=='4'){echo 'L3';}elseif($jenis=='3'){echo 'TP';}elseif($jenis=='5'){echo 'KS';}else{} ?>" class="btn btn-info"><span class="glyphicon glyphicon-equalizer" aria-hidden="true"></span> Daftar Kuitansi</a>
                        <?php
								}
							}else{
						?>
                                            ...
                                            <tr id="tr_<?=$ul->kode_usulan_belanja?><?php echo $ul->kode_akun_tambah ;?>" height="25px">
												...
												<?php
													if(substr($ul->proses,1,1)==4){
                                                        $kode_kontrak = 0;
                                                        // $kode_kontrak = $kontrak[$ul->kode_usulan_belanja.$ul->kode_akun_tambah][0]->id;
                                                        if(isset($kontrak[$ul->kode_usulan_belanja.$ul->kode_akun_tambah][0]->id) && !empty($kontrak[$ul->kode_usulan_belanja.$ul->kode_akun_tambah][0]->id_kontrak)){
                                                            $kode_kontrak = $kontrak[$ul->kode_usulan_belanja.$ul->kode_akun_tambah][0]->id_kontrak;
                                                        }
														
												?>
													
														<input type="hidden" class="id_kontrak_<?php echo $ul->kode_usulan_belanja.$ul->kode_akun_tambah; ?>" value="<?php echo $kode_kontrak; ?>"/>
												<?php
														
													}
												?>
													
                                                    <?php if(substr($ul->proses,1,1)=='1'){echo '<span class="badge badge-gup" id="badge_id_'.$ul->kode_usulan_belanja.$ul->kode_akun_tambah.'">GP</span>';}elseif(substr($ul->proses,1,1)=='2'){echo '<span class="badge badge-lp" id="badge_id_'.$ul->kode_usulan_belanja.$ul->kode_akun_tambah.'">LP</span>';}elseif(substr($ul->proses,1,1)=='4'){echo '<span class="badge badge-l3" id="badge_id_'.$ul->kode_usulan_belanja.$ul->kode_akun_tambah.'">L3</span>';}elseif(substr($ul->proses,1,1)=='3'){echo '<span class="badge badge-tup" id="badge_id_'.$ul->kode_usulan_belanja.$ul->kode_akun_tambah.'">TP</span>';}elseif(substr($ul->proses,1,1)=='5'){echo '<span class="badge badge-ks" id="badge_id_'.$ul->kode_usulan_belanja.$ul->kode_akun_tambah.'">KS</span>';}elseif(substr($ul->proses,1,1)=='6'){echo '<span class="badge badge-lsphk3" id="badge_id_'.$ul->kode_usulan_belanja.$ul->kode_akun_tambah.'">L3NK</span>';}else{} ?> <?=$ul->kode_akun_tambah?>
                                                </td>
                                                <td ><?=$ul->deskripsi?></td>
                                                <td ><?=$ul->volume?></td>
                                                <td ><?=$ul->satuan?></td>
...
<!--                                                    <div class="btn-group">
                                                ...
                                                <td align="center">
                                                  ...
                                                  <?php if( is_null($ul->id_kuitansi) ): ?>
														<button type="button" class="btn btn-danger btn-sm btn_batal" rel="<?=$ul->kode_usulan_belanja?><?=$ul->kode_akun_tambah?>" title="Batalin DPA ini!"><i class="glyphicon glyphicon-remove"></i></button>
                                                  <?php else: ?>
                                                            <?php if( $ul->aktif == '1' ) : ?>
                                                                <button type="button" class="btn btn-danger btn-sm" disabled="disabled" rel=""><i class="glyphicon glyphicon-remove"></i></button>
                                                            <?php else: ?>
														<button type="button" class="btn btn-danger btn-sm btn_batal" rel="<?=$ul->kode_usulan_belanja?><?=$ul->kode_akun_tambah?>" title="Batalin DPA ini!"><i class="glyphicon glyphicon-remove"></i></button>
                                                            <?php endif; ?>
                                                  <?php endif; ?>
                                                ...
                                                <td align="center">
                                                    <?php if(!is_null($ul->str_nomor_trx_spm)):?>
                                                    <button type="button" class="btn btn-success btn-sm btn_proses" onclick="bootbox.alert('Telah diajukan SPM : <?=$ul->str_nomor_trx_spm?> <br> dan SPP : <?=$ul->str_nomor_trx?>')" rel="<?php // echo $value->id_kuitansi; ?>" title="Diajukan SPM"><i class="glyphicon glyphicon-file"></i></button>
                                                    <?php else: ?>
                                                        <?php if(!is_null($ul->str_nomor_trx)):?>
                                                        <button type="button" class="btn btn-success btn-sm btn_proses" onclick="bootbox.alert('Telah diajukan SPP : <?=$ul->str_nomor_trx?>')" rel="<?php // echo $value->id_kuitansi; ?>" title="Diajukan SPP"><i class="glyphicon glyphicon-file"></i></button>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                ...
                                                <td align="center">
                                                    <?php if(!is_null($ul->str_nomor_trx_spm)):?>
                                                    <button type="button" class="btn btn-info btn-sm btn_proses" onclick="bootbox.alert('Telah diajukan SPM : <?=$ul->str_nomor_trx_spm?> <br> dan SPP : <?=$ul->str_nomor_trx?>')" rel="<?php // echo $value->id_kuitansi; ?>" title="Diajukan SPM"><i class="glyphicon glyphicon-file"></i></button>
                                                    <?php else: ?>
                                                        <?php if(!is_null($ul->str_nomor_trx)):?>
                                                        <button type="button" class="btn btn-info btn-sm btn_proses" onclick="bootbox.alert('Telah diajukan SPP : <?=$ul->str_nomor_trx?>')" rel="<?php // echo $value->id_kuitansi; ?>" title="Diajukan SPP"><i class="glyphicon glyphicon-file"></i></button>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
          <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel">DATA UNTUK SPP : <span id="kode_badge">-</span></h4>
          </div>
          <div class="modal-body" style="margin:0px;padding:15px;background-color: #EEE;">
			...
			<tr class="tr_up">
                ...
                <td colspan="8"><?=$tahun?></td>
			</tr>
			
			<tr class="tr_up">
				<td colspan="3">Anggaran</td>
                <td colspan="8" id="txt_akun">-</td>
			</tr>
			<tr class="tr_up">
				<td colspan="3">No_Bukti</td>
                <td colspan="8" id="no_bukti">-</td>
			</tr>
			
			<tr class="tr_up">
				<td colspan="3">Unit</td>
                <td colspan="8"><?=$nm_unit?></td>
			</tr>
			<tr class="tr_up">
				<td colspan="3">Jumlah Uang</td>
                <td colspan="8"><b>Rp. <span class="sum_tot_bruto">0</span>,-</b></td>
			</tr>
			<tr class="tr_up">
				<td colspan="3">Terbilang</td>
          <td colspan="8"><b><span class="text_tot">-</span></b></td>
			</tr>
			<tr class="tr_up">
				<td colspan="3">Untuk Pekerjaan</td>
               <td colspan="8"><span class="edit_here" contenteditable="true" placeheld="yes" id="uraian">- edit here -</span></td>
			</tr>
			<tr class="tr_up">
				<td colspan="3">Nama Pihak ketiga</td>
                <td colspan="8"><span class="edit_here" contenteditable="true" placeheld="yes" id="nmphk3">- edit here -</span></td>
			</tr>
			<tr class="tr_up">
			...
			<tr class="tr_up">
                ...
                <td colspan="8"><span class="edit_here" contenteditable="true" placeheld="yes" id="npwp">- edit here -</span></td>
			</tr>
			<tr class="tr_up">
			...
			<tr class="tr_up">
			  ...
			  <tr>
				<td colspan="3">BENDAHARA PENGELUARAN</td>
								...
								<span id="nmbendahara"><?=$pic_kuitansi['bendahara_nm_lengkap']?></span><br>
                                 NIP. <span id="nipbendahara"><?=$pic_kuitansi['bendahara_nip']?></span>
								<?php else: ?>
								<span id="nmbendahara"><?=$pic_kuitansi['bendahara_nm_lengkap']?></span><br>
                                 NIP. <span id="nipbendahara"><?=$pic_kuitansi['bendahara_nip']?></span>
								 <span id="nmpumk"><?php echo isset($pumk->nm_lengkap)?$pumk->nm_lengkap:''; ?></span><br>
          ...
          <div class="modal-body" style="margin:0px;padding:15px;background-color: #EEE;">
			...
			<tr>
                        ...
                        <tr >
                            ...
                            <td colspan="3">Lunas dibayar tgl :<br>
                                Pemegang Uang Kerja
                            </td>
                            <?php endif; ?>
                        </tr>
                        <tr>
                         ...
                         <tr>
                            ...
                            <?php else: ?>
                            <td colspan="8"><span id="nmbendahara"><?=$pic_kuitansi['bendahara_nm_lengkap']?></span><br>
                                 NIP. <span id="nipbendahara"><?=$pic_kuitansi['bendahara_nip']?></span>
                            </td>
                            <td colspan="3"><span id="nmpumk"><?php echo isset($pumk->nm_lengkap)?$pumk->nm_lengkap:''; ?></span><br>
                                    NIP. <span id="nippumk"><?php echo isset($pumk->nomor_induk)?$pumk->nomor_induk:''; ?></span>
                            </td>
                            <?php endif; ?>
