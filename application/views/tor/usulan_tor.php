                            ...
                            <tbody id="row_space">
                                ...
                                <?php foreach($detail_akun_rba as $u){ ?>
                                    ...
                                    <tr id="form_add_detail_<?=$u->kode_usulan_belanja?>" class="alert alert-success">
                                            <td >
                                                <input name="revisi" id="revisi_<?=$u->kode_usulan_belanja?>" type="hidden" value="<?=$revisi?>" />
				...
				<div class="col-lg-6">
                  <div class="input-group">
                    <span class="input-group-addon">
                      ...
                      <input type="text" class="form-control" aria-label="" value="LS-PIHAK-3-NON-KONTRAK " readonly="readonly">
                  </div><!-- /input-group -->
                </div><!-- /.col-lg-6 -->
            </div>
            </div>
