...
?>
	...
	<td align="center" >
        ...
        <td>
                    <button type="button" class="btn btn-success btn-sm" disabled="disabled" rel="" id="" aria-label="Center Align"><span class="glyphicon glyphicon-export" aria-hidden="true"></span> Pilih</button>
                </td>