...
?>
	...
	<td ><input name="volume_edit" rel="<?=$value->kode_usulan_belanja?>" class="validate[required,custom[integer],min[1]] calculate form-control xnumber" id="volume_edit" type="text" value="<?php echo $value->volume; ?>" /></td>
	...
	<td align="center" >
		<div class="btn-group">
				<button type="button" style="padding-left:5px;padding-right:5px;" class="btn btn-default btn-sm" onclick="submitedit('<?php echo $value->id_rsa_detail; ?>','<?php echo $value->kode_usulan_belanja; ?>')" id="btn-edit" aria-label="Left Align"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></button>
        ...
        <td>
                    <button type="button" class="btn btn-success btn-sm" disabled="disabled" rel="" id="" aria-label="Center Align"><span class="glyphicon glyphicon-export" aria-hidden="true"></span> Proses</button>
                </td>