                                                                ...
                                                                <?php foreach ($value6digit['data'] as $keydetail => $valdetail): ?>
                                                                    <tr  id="<?php echo $valdetail['id_rsa_detail'] ;?>">
                                                                        ...
                                                                        <?php if($valdetail['proses'] == 0) : ?>
                                                                            ...
                                                                            <td>
                                                                                <button type="button" class="btn btn-success btn-sm" disabled="disabled" rel="" id="proses_" aria-label="Center Align" data-kode-usulan=""><span class="glyphicon glyphicon-export" aria-hidden="true"></span> Pilih </button>
                                                                            </td>
