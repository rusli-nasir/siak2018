...
//          message: "Penambahan fitur kolom <b>Potongan Pajak</b> dan <b>Tabungan Pajak</b> sudah aktif. Jika terdapat masalah segera hub programmer. Terimakasih. <br/><img src='<?php echo base_url().'assets/img/tabungan_potongan_pajak.jpg'; ?>' alt='new_pajak' style='width:100%;' />",
//          animate: false,
//      });
...
$(document).ready(function(){
    ...
    // $(document).ready(function(){
        ...
        //     title: "PESAN",
        //     animate: false,
        //     message: "MOHON MAAF KEMAREN ADA KESALAHAN PADA SUBMIT KUITANSI, MOHON SEKIRANYA DI PERIKSA APABILA ADA <u>DPA</u> YANG <u>DUPLIKAT KUITANSI</u> DAPAT MENGHUBUNGI PROGRAMMER.<br>THX.",
        // });
...
//                console.log('v');
        ...
        $(document).on('change', '[class^="all_ck_"]', function(){
            var str = $(this).attr('rel'); //070402110101010101513511
            var badge_ = $('[id^="badge_id_'+ str +'"]').html(); //GP
           // console.log(badge_);
            var badge = '';
            ...
            if(el.is(':enabled')){
                if(el.is(':checked')){
                    $('[class^="ck_'+ str +'"]').each(function(){
                        ...
                        $('[class^="data_akun5d_'+ str +'"]').collapse('show');
                        $('[class^="data_akun6d_'+ str +'"]').collapse('show');
                        // $('[class^="data_rsa_detail_'+ str +'"]').collapse('show');
                        $('[class^="data_akun6d_'+ str +'"]').on('shown.bs.collapse', function () {
                          // do something…
                          $('[class^="data_rsa_detail_'+ str +'"]').collapse('show');
                        });
                    });
...
//            in_all = 0;
            ...
            $('#tr_new_').replaceWith('<tr id="tr_isi"><td colspan="8" style="border:1px solid #000;">tr_isi</td></tr>');
            ...
            // alert(kd_usulan.substr(18,4));
            var nm_akun = $('#nm_akun_' + kd_usulan.substr(18,4)).html();
...
//                    console.log(l_td);
                    $('#tr_' + el + ' > td').each(function(ii){
                        if(ii == 1){
                            str_isi = str_isi + '<td colspan="3" style="border:1px solid #000;">' + (i+1) + '. ' + $(this).html() + '</td>' ; // + ' [ <a data-toggle="modal" rel="'+ i + '_' + el +'" id="isi_uraian_'+ el +'" href="#myModalUraian" >uraian</a> ]</td>' ;
                        }
                        else if(ii == 2){
                            str_isi = str_isi + '<td style="text-align:center;border:1px solid #000;">' + $(this).html() + '</td>' ;
                        }
                        else if(ii == 3){
                            str_isi = str_isi + '<td style="padding: 0 5px 0 5px;border:1px solid #000;">' + $(this).html() + '</td>' ;
                        }
                        else if(ii == 4){
                            str_isi = str_isi + '<td style="text-align:right;padding: 0 5px 0 5px;border:1px solid #000;">' + $(this).html() + '</td>' ;
                        }
                        else if(ii == 5){
                            str_isi = str_isi + '<td style="text-align:right;padding: 0 5px 0 5px;border:1px solid #000;" class="sub_tot_bruto_'+ el +'">' + $(this).html() + '</td>\n\
                                        <td class="row_pajak_'+ el +'" style="padding: 0 5px 0 5px;border:1px solid #000;">[ <a data-toggle="modal" rel="'+ i + '_' + el +'" id="pilih_pajak_'+ el +'" href="#myModalPajak">edit</a> ]</td>\n\
                                        <td style="text-align:right;padding: 0 5px 0 5px;border:1px solid #000;" class="row_pajak_nom_'+ el +'">0</td>\n\
                                        <td style="border:1px solid #000;border-right:none;"><span style="margin-left:10px;margin-right:10px;">=</span><span style="margin-left:10px;margin-right:10px;">Rp.</span></td>\n\
                                        <td style="text-align:right;border:1px solid #000;border-left:none;" rel="'+ el +'" class="sub_tot_netto_'+ el +'">0</td>';
                        }
//                        else if(ii == 5){
...
//        });
        ...
        $(document).on('change', '[id^="pj_p_"]', function(){
            ...
            // alert(rel_a);
            var rel = rel_a[0]; //52,51
            var rel_1 = rel_a[1]; //pphps21
                ...
                if(($(this).val() == '98')||($(this).val() == '97')||($(this).val() == '96')||($(this).val() == '95')||($(this).val() == '94')||($(this).val() == '89')){
                    ...
                    if($(this).is(':checked')){
                        ...
                        $('.pj_p_' + rel_1 ).each(function(){
                            ...
                            $('.pj_dpp_' + rel__1).attr('disabled','disabled'); /// POSISI DI UN COMMENT IDRIS PD TGL : 23/2/2018
                            $('.pj_dpp_' + rel__1).prop('checked',false); /// POSISI DI UN COMMENT IDRIS PD TGL : 23/2/2018
                            $('.pj_nilai_' + rel__1).val('');

                            if (rel == 51) { //added by Arief 27/03/2018
                                $('#pj_dpp_52').prop('checked',false);
                                $('#pj_dpp_52').attr('disabled','disabled');
                                $('#pj_nilai_52').val('');
                                $('#pj_nilai_52').attr('disabled','disabled');
                            }else if(rel == 52){
                                $('#pj_dpp_51').prop('checked',false);
                                $('#pj_dpp_51').attr('disabled','disabled');
                                $('#pj_nilai_51').val('');
                                $('#pj_nilai_51').attr('disabled','disabled');
                            }
                        });
...
//                $('#pj_dpp_' + rel).attr('disabled','disabled');
        ...
        $(document).on('focusout', '#pj_nilai_52', function(){
            get_total_pajak();
        });
        ...
        $(document).on('click', '#btn-submit-pajak', function(){
            ...
            if ($('#pj_p_52').is(':checked')) {
                if(!$('#pj_nilai_52').validationEngine("validate")){
                ...
                if(($(this).val() == '98')||($(this).val() == '97')||($(this).val() == '96')||($(this).val() == '95')||($(this).val() == '94')||($(this).val() == '89')){
                    ...
                    if($(this).is(':checked')){
                        ...
                        $('.edit_pj_p_' + rel_1 ).each(function(){
                            ...
                            $('.edit_pj_dpp_' + rel__1).attr('disabled','disabled'); /// POSISI DI UN COMMENT IDRIS PD TGL : 23/2/2018
                            $('.edit_pj_dpp_' + rel__1).prop('checked',false); /// POSISI DI UN COMMENT IDRIS PD TGL : 23/2/2018
                            $('.edit_pj_nilai_' + rel__1).val('');

                            if (rel == 51) { //added by Arief 27/03/2018
                                $('#edit_pj_dpp_52').prop('checked',false);
                                $('#edit_pj_dpp_52').attr('disabled','disabled');
                                $('#edit_pj_nilai_52').val('');
                                $('#edit_pj_nilai_52').attr('disabled','disabled');
                            }else if(rel == 52){
                                $('#edit_pj_dpp_51').prop('checked',false);
                                $('#edit_pj_dpp_51').attr('disabled','disabled');
                                $('#edit_pj_nilai_51').val('');
                                $('#edit_pj_nilai_51').attr('disabled','disabled');
                            }
                        });
...
//                $('#pj_dpp_' + rel).attr('disabled','disabled');
        ...
        $(document).on('focusout', '#edit_pj_nilai_52', function(){
            get_total_pajak_edit();
        });
        ...
        $(document).on('click', '#btn-edit-pajak', function(){
            ...
            if ($('#edit_pj_p_52').is(':checked')) {
                if(!$('#edit_pj_nilai_52').validationEngine("validate")){
...
//            console.log(JSON.stringify(pj_p_nilai_all));
                ...
                $.ajax({
                    ...
                    success:function(data){
//                        console.log(data)
                            localStorage.setItem("row_expand_sub_subunit", ".data_akun4d_"+pj_p_kode_usulan_all[pj_p_kode_usulan_all.length-1].substr(0, 6));
                            localStorage.setItem("row_expand_akun4d", ".data_akun5d_"+pj_p_kode_usulan_all[pj_p_kode_usulan_all.length-1].substr(0, 22));
                            localStorage.setItem("row_expand_akun5d", ".data_akun6d_"+pj_p_kode_usulan_all[pj_p_kode_usulan_all.length-1].substr(0, 23));
                            localStorage.setItem("row_expand_akun6d", ".data_rsa_detail_"+pj_p_kode_usulan_all[pj_p_kode_usulan_all.length-1].substr(0, 24));
                            localStorage.setItem("row_focus", "#tr_"+pj_p_kode_usulan_all[pj_p_kode_usulan_all.length-1].substr(0, 27));
                            location.reload();
...
//                alert('Silahkan diperiksa isiannya dahulu !');
        ...
        $(document).on("click",".input_boot",function(){
            ...
            dialog.init(function(){
                ...
                if((id_name == 'PENERIMA_UANG')||(id_name == 'PENERIMA_BARANG')){
                    $(".bootbox-input-textarea").typeahead({
                          source: function(query, process) {
                                    return $.get("<?=site_url('kuitansi/get_data_penerima')?>", { query : query }, function (data) {
                                        // console.log(item);
                                        data = $.parseJSON(data);
                                        return process(data);
                                        // var results = data.map(function(item) {
...
function re_notif(rka){
    var notif_subunit = parseInt($('#notif_subunit_' + rka.substr(0,4)).html());
    var notif_sub_subunit = parseInt($('#notif_sub_subunit_' + rka.substr(0,6)).html());
    var notif4d = parseInt($('#notif4d_' + rka.substr(0,22)).html());
    var notif5d = parseInt($('#notif5d_' + rka.substr(0,23)).html());
    var notif6d = parseInt($('#notif6d_' + rka.substr(0,24)).html());

    notif_subunit = notif_subunit - 1;
    notif_sub_subunit = notif_sub_subunit - 1;
    notif4d = notif4d - 1;
    notif5d = notif5d - 1;
    notif6d = notif6d - 1;

    if (notif_subunit < 1) {
        $('#notif_subunit_' + rka.substr(0,4)).hide();
    }else{
        $('#notif_subunit_' + rka.substr(0,4)).html(notif_subunit);
    }
    if (notif_sub_subunit < 1) {
        $('#notif_sub_subunit_' + rka.substr(0,6)).hide();
    }else{
        $('#notif_sub_subunit_' + rka.substr(0,6)).html(notif_sub_subunit);
    }
    if (notif4d < 1) {
        $('#notif4d_' + rka.substr(0,22)).hide();
    }else{
        $('#notif4d_' + rka.substr(0,22)).html(notif4d);
    }
    if (notif5d < 1) {
        $('#notif5d_' + rka.substr(0,23)).hide();
    }else{
        $('#notif5d_' + rka.substr(0,23)).html(notif5d);
    }
    if (notif6d < 1) {
        $('#notif6d_' + rka.substr(0,24)).hide();
    }else{
        $('#notif6d_' + rka.substr(0,24)).html(notif6d);
    }
}
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="alert alert-warning col-sm-8">
                    ...
                    if($jenis!=2){
                    ?>
                        <button type="button" class="btn btn-warning btn-kuitansi" rel="" disabled="disabled" >
                ...
                <div id="o-table" class="col-md-12">
                    ...
                    <div class="alert tb-data" data-toggle="collapse" data-target=".data_sub_subunit_<?php echo $key_subunit ?>" style="border-radius:0px;border:1px solid #fff;background-color: #006064;color: #fff;margin: 10px 0px 0px 0px;padding: 5px;cursor: pointer;">
                        ...
                        <div class="data_sub_subunit_<?php echo $key_subunit ?> tb-data collapse in">
                            ...
                            <?php foreach ($value_sub_subunit['data'] as $key4digit => $value4digit): ?>
                                <div class="data_akun4d_<?php echo $key_sub_subunit ?> collapse">
                                    <div class="alert " data-toggle="collapse" data-target=".data_akun5d_<?php echo $value4digit['kode_usulan_belanja_22'] ?>" style="border-radius:0px;border:1px solid #ddd;border-bottom:0px;background-color: #00695c61;color: #04483f;margin: 0px;padding: 5px;cursor: pointer;">
                                        <span>
                                            <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $key4digit ?> : <span id="nm_akun_<?=$key4digit?>"><?php echo $value4digit['nama_akun4digit'] ?></span></b>
                                        </span>
                                    ...
                                    <div class="alert data_akun5d_<?php echo $value4digit['kode_usulan_belanja_22'] ?> collapse" style="margin: 0px;padding: 0px;text-align: center;">
                                        <span class="text-center" style="font-size: 14px;background-color: #f9ff83;">
                                            <b>Pilih Semua di akun <?php echo $key4digit ?> : <span id="nm_akun_<?=$key4digit?>"><?php echo $value4digit['nama_akun4digit'] ?></span></b>
                                            <input type="checkbox" aria-label="" rel="<?=$value4digit['kode_usulan_belanja_22']?>" class="all_ck_<?=$value4digit['kode_usulan_belanja_22']?>">
                                        </span>
                                    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="checkbox">
                                    <label>
                                      <input rel="52_pphps21" id="pj_p_52" name="pajak[42][0]" type="checkbox" class="pj_p_pphps21" value="98" />
                                      Potongan Pajak
                                    </label>
                                  </div>
                            </td>
                            <td>
                                <div class="checkbox" style="display: none">
                                    <label>
                                      <input rel="52" id="pj_dpp_52" disabled="disabled" class="pj_dpp_pphps21" name="pajak[42][1]" type="checkbox" value="1" />
                                    </label>
                                  </div>
                            </td>
                            <td>
                                <input id="pj_nilai_52" class="form-control input-sm pj_nilai_pphps21 xnumber validate[required]" disabled="disabled" name="pajak[42][2]" type="text" />
                            </td>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="checkbox">
                                    <label>
                                        <input rel="52_pphps21" id="edit_pj_p_52" name="pajak[42][0]" type="checkbox" class="edit_pj_p_pphps21" value="98" />
                                        Potongan Pajak
                                    </label>
                                </div>
                            </td>
                            <td>
                                <div class="checkbox" style="display: none">
                                    <label>
                                        <input rel="52" id="edit_pj_dpp_52" disabled="disabled" class="edit_pj_dpp_pphps21" name="pajak[42][1]" type="checkbox" value="1" />
                                    </label>
                                </div>
                            </td>
                            <td>
                                <input id="edit_pj_nilai_52" class="form-control input-sm edit_pj_nilai_pphps21 xnumber validate[required]" disabled="disabled" name="pajak[42][2]" type="text" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3" class="alert-warning"><b>PPh Ps 22</b></td>
            ...
            <form id="form_kriteria" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Tabungan Pajak (keseluruhan):</label>
                                <div class="input-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon">Rp.</span>
                                    <input type="text" class="form-control input-sm kepeg_numeric" name="potongan_pajak" required="required" placeholder="0" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row">
                            <div class="col-md-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <?php if (!empty($statusKepegOption)) {
                                         echo $statusKepegOption;
                                        } ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    foreach ($stt as $k => $v) {
                                      ...
                                      // echo $this->cantik2_model->opsiStatusKepeg($_SESSION['ovr']['status']); muted by Arief (error)

                                      if (!empty($this->cantik2_model->getStatusList($_SESSION['ovr']['status']))) { //added by Arief
                                          echo $this->cantik2_model->getStatusList($_SESSION['ovr']['status']);
                                          // vdebug($this->cantik_model->getStatusKepeg($_SESSION['ovr']['status']));
                                      }
                                    ?>
                                </div>
                            </div>
