                                        ...
                                        <?php if(( $ul->kode_usulan_belanja == $u->kode_usulan_belanja) && (substr($ul->proses,1,1) == $jenis) ): ?>
                                            <tr id="tr_<?=$ul->kode_usulan_belanja?><?php echo $ul->kode_akun_tambah ;?>" height="25px">
                                                ...
                                                <!--
                                                  ...
                                                  <?php else: ?>
                                                            <?php if( $ul->aktif == '1' ) : ?>
                                                            	<button type="button" class="btn btn-primary btn-sm btn_proses" onclick="bootbox.alert('STATUS : KUITANSI <br>KUITANSI : <?=$ul->no_bukti?>')" rel="<?php // echo $value->id_kuitansi; ?>" title="STATUS : KUITANSI"><i class="glyphicon glyphicon-file"></i></button>
                                                ...
                                                <td align="center">
                                                    ...
                                                    <button type="button" class="btn btn-warning btn-sm btn_proses" onclick="bootbox.alert('STATUS : SPP <br>KUITANSI : <?=$ul->no_bukti?><br>SPP : <?=$ul->str_nomor_trx?><br>SPM : <?=$ul->str_nomor_trx_spm?> ')" rel="<?php // echo $value->id_kuitansi; ?>" title="STATUS : SPP"><i class="glyphicon glyphicon-file"></i></button>
                                                    <?php else: ?>
                                                        <?php if(!is_null($ul->str_nomor_trx)):?>
                                                        <button type="button" class="btn btn-warning btn-sm btn_proses" onclick="bootbox.alert('STATUS : SPP <br>KUITANSI : <?=$ul->no_bukti?><br>SPP : <?=$ul->str_nomor_trx?>')" rel="<?php // echo $value->id_kuitansi; ?>" title="STATUS : SPP"><i class="glyphicon glyphicon-file"></i></button>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                ...
                                                <!--
                                                    <?php if(!is_null($ul->str_nomor_trx_spm)):?>
                                                    <button type="button" class="btn btn-success btn-sm btn_proses" onclick="bootbox.alert('STATUS : SPM <br>KUITANSI : <?=$ul->no_bukti?><br>SPP : <?=$ul->str_nomor_trx?><br>SPM : <?=$ul->str_nomor_trx_spm?>')" rel="<?php // echo $value->id_kuitansi; ?>" title="STATUS : SPM"><i class="glyphicon glyphicon-file"></i></button>
                                                    <?php else: ?>
                                                        <?php if(!is_null($ul->str_nomor_trx)):?>
                                                        <button type="button" class="btn btn-success btn-sm btn_proses" onclick="bootbox.alert('STATUS : SPM <br>KUITANSI : <?=$ul->no_bukti?><br>SPP : <?=$ul->str_nomor_trx?>')" rel="<?php // echo $value->id_kuitansi; ?>" title="STATUS : SPP"><i class="glyphicon glyphicon-file"></i></button>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                -->
                                                ...
                                                <!--
                                                    <?php // if(!is_null($ul->str_nomor_trx_spm)):?>
                                                    <button type="button" class="btn btn-info btn-sm btn_proses" onclick="bootbox.alert('STATUS : CAIR <br>KUITANSI : <?=$ul->no_bukti?><br>SPP : <?=$ul->str_nomor_trx?><br>SPM : <?=$ul->str_nomor_trx_spm?> ')" rel="<?php // echo $value->id_kuitansi; ?>" title="STATUS : CAIR"><i class="glyphicon glyphicon-file"></i></button>
                                                    <?php // else: ?>
                                                        <?php // if(!is_null($ul->str_nomor_trx)):?>
