...
//            console.log(nominal + ' ' + saldo_kas);
            ...
            if(parseInt(saldo_kas) < parseInt(jumlah_bayar)){
                ...
                if(confirm('Apakah anda yakin ?')){
                    ...
                    var data = 'proses=' + 'SPM-FINAL-KBUU' + '&nomor_trx=' + $('#nomor_trx_spm').html() + '&jenis=' + 'SPM' + '&tahun=' + '<?=$cur_tahun?>' +'&kd_unit=' + '<?=$kd_unit?>' + '&kd_akun_kas=' + kd_akun_kas + '&kredit=' + '<?php echo isset($detail_up['nom'])?$detail_up['nom']:''?>' + '&deskripsi=' + 'PUP <?=$alias?>' + '&nominal=' + jumlah_bayar ;
                    $.ajax({
                        type:"POST",
                        url :"<?=site_url('rsa_tambah_up/proses_final_tambah_up')?>",
                        data:data,
    ...
    $(document).on("click",'#proses_spm_kpa',function(){
        if(confirm('Apakah anda yakin ?')){
            ...
            $.ajax({
                type:"POST",
                url :"<?=site_url('rsa_tambah_up/proses_spm_tambah_up')?>",
                data:data,
                success:function(data){
//                        console.log(data)
//                        $('#no_bukti').html(data);
