...
$(document).ready(function(){
    ...
    <?php elseif(($doc_up == 'SPP-DITOLAK')||($doc_up == 'SPM-DITOLAK-KPA')||($doc_up == 'SPM-DITOLAK-VERIFIKATOR')||($doc_up == 'SPM-DITOLAK-KBUU')||($doc_up == 'SPM-DITOLAK-BUU')):?>
    ...
    <?php elseif($doc_up == 'SPM-FINAL-KBUU'):?>
...
//            console.log($('#jml_penyesuaian').val());
            ...
            $.ajax({
                type:"POST",
                url :"<?=site_url('rsa_tambah_up/get_next_nomor_spp')?>",
                data:'' ,
...
//                        
    ...
    $(document).on("click",'#edit-pup',function(){
        $('#myModalTambahUP').modal({
                backdrop: 'static',
                keyboard: true
              });
    ...
    $(document).on("click",'#proses_spp',function(){
        if(confirm('Apakah anda yakin ?')){
            ...
            $.ajax({
                type:"POST",
                url :"<?=site_url('rsa_tambah_up/usulkan_spp_tambah_up')?>",
                data:data,
                success:function(data){
//                        console.log(data)
//                        $('#no_bukti').html(data);
...
<div id="page-inner">
    ...
    <?php if($doc_up == ''){ $stts_bendahara = 'active'; ?>
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPP PUP Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> belum diusulkan oleh bendahara.</div>
    <?php }elseif($doc_up == 'SPP-DRAFT'){ $stts_bendahara = 'done'; $stts_ppk = 'active'; ?>
        <div class="alert alert-info" style="border:1px solid #a94442;">SPP PUP Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> menunggu persetujuan <b><span class="text-danger" >PPK SUKPA</span></b> .</div>
    <?php }elseif($doc_up == 'SPP-DITOLAK'){ $stts_bendahara = 'active'; ?>
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPP PUP Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >PPK SUKPA</span></b> <b>[ <a href="#" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    <?php }elseif($doc_up == 'SPP-FINAL'){ $stts_bendahara = 'done';  $stts_ppk = 'done'; ?>   
        <div class="alert alert-info" style="border:1px solid #a94442;">SPP PUP Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah diterima oleh <b><span class="text-danger" >PPK SUKPA</span></b> .</div>
    <?php }elseif($doc_up == 'SPM-DRAFT-PPK'){ $stts_bendahara = 'done'; $stts_ppk = 'done';  $stts_kpa = 'active'; ?>   
        <div class="alert alert-info" style="border:1px solid #a94442;">SPM PUP Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> menunggu persetujuan <b><span class="text-danger" >KPA </span></b> .</div>
    <?php }elseif($doc_up == 'SPM-DRAFT-KPA'){ $stts_bendahara = 'done'; $stts_ppk = 'done'; $stts_kpa = 'done' ; $stts_verifikator = 'active';  ?>   
        <div class="alert alert-info" style="border:1px solid #a94442;">SPM PUP Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> menunggu persetujuan <b><span class="text-danger" >VERIFIKATOR </span></b> .</div>
    <?php }elseif($doc_up == 'SPM-DITOLAK-KPA'){ $stts_bendahara = 'active'; ?>   
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPM PUP Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >KPA </span></b> <b>[ <a href="#" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    <?php }elseif($doc_up == 'SPM-FINAL-VERIFIKATOR'){ $stts_bendahara = 'done'; $stts_ppk = 'done'; $stts_kpa = 'done' ; $stts_verifikator = 'done'; $stts_kbuu = 'active' ?>   
        <div class="alert alert-success" style="border:1px solid #a94442;">SPM PUP Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> menunggu persetujuan <b><span class="text-danger" >KUASA BUU </span></b> .</div>
    <?php }elseif($doc_up == 'SPM-DITOLAK-VERIFIKATOR'){ $stts_bendahara = 'active'; ?>   
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPM PUP Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >VERIFIKATOR </span></b> <b>[ <a href="#" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    <?php }elseif($doc_up == 'SPM-FINAL-KBUU'){ $stts_bendahara = 'done'; $stts_ppk = 'done'; $stts_kpa = 'done' ; $stts_verifikator = 'done'; $stts_kbuu = 'done' ?>   
        <div class="alert alert-success" style="border:1px solid #a94442;">SPM PUP Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah disetujui oleh <b><span class="text-danger" >KUASA BUU </span></b> .</div>
    <?php }elseif($doc_up == 'SPM-DITOLAK-KBUU'){ $stts_bendahara = 'active'; ?>   
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPM PUP Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >KUASA BUU </span></b> <b>[ <a href="#" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    <?php }elseif($doc_up == 'SPM-FINAL-BUU'){ $stts_bendahara = 'done'; ?> 
        <div class="alert alert-success" style="border:1px solid #a94442;">SPM PUP Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah difinalisasi oleh <b><span class="text-danger" >BUU </span></b> .</div>
    <?php }elseif($doc_up == 'SPM-DITOLAK-BUU'){ $stts_bendahara = 'active'; ?>   
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPM PUP Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >BUU </span></b> <b>[ <a href="#" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    <?php } ?>
                                    ...
                                    <td colspan="5" style="line-height: 16px;border-bottom: none;border-top: none;">
                                        <ol style="list-style-type: lower-alpha;margin-top: 0px;margin-bottom: 0px;" >
                                            <li>Jumlah pembayaran yang diminta : Rp. <span id="jumlah_bayar"><?=number_format($detail_up['nom'], 0, ",", ".")?></span>,-<br>
                                                ...
                                                <li>Untuk keperluan : <span id="untuk_bayar"><?=isset($detail_pic->untuk_bayar)?$detail_pic->untuk_bayar:'Penyesuaian uang persediaan'?></span></li>
								...
								<td  style="text-align: center;">
									12111
                                                                ...
                                                                <td style="text-align: right;padding-right: 10px;">
                                                                    Rp. <span class="jumlah_bayar"><?=number_format($detail_up['nom'], 0, ",", ".")?></span>
								</td>
    ...
    <input type="text" name="dtahun" id="dtahun" value="<?=$cur_tahun?>" />
            ...
            <div class="alert alert-warning" style="text-align:center">
                <?php if(($doc_up == '')||($doc_up == 'SPP-DITOLAK')||($doc_up == 'SPM-DITOLAK-KPA')||($doc_up == 'SPM-DITOLAK-VERIFIKATOR')||($doc_up == 'SPM-DITOLAK-KBUU')||($doc_up == 'SPM-DITOLAK-BUU')){ ?>
                    ...
                    <button type="button" class="btn btn-success" id="edit-pup" disabled="disabled" rel=""><span class="glyphicon glyphicon-repeat" aria-hidden="true"></span> Edit</button>
                ...
                <?php }else{ ?>
                    ...
                    <button type="button" class="btn btn-success" disabled="disabled" id="" ><span class="glyphicon glyphicon-ok-sign" aria-hidden="true"></span> Buat Lagi</button>
                    <button type="button" class="btn btn-success" disabled="disabled" id="" rel=""><span class="glyphicon glyphicon-repeat" aria-hidden="true"></span> Edit</button>
                    <button type="button" class="btn btn-info" id="cetak" rel=""><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Cetak</button>
                    <!--<a href="#" class="btn btn-success" id="down"><span class="glyphicon glyphicon-save-file" aria-hidden="true"></span></span> Download</a>-->
                <?php } ?>
...
<div class="modal" id="myModalTambahUP" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Penyesuaian UP</h4>
      </div>
    <div class="modal-body">
        <p>
            <div class="form-group">
      ...
      <div class="modal-footer">
        ...
        <a href="<?php echo site_url('rsa_up');?>" class="btn btn-danger" id="btn_batal_1"><span class="glyphicon glyphicon-repeat" aria-hidden="true"></span> Batal</a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
          <div class="alert alert-warning text-center">
              <button type="button" class="btn btn-success" id="btn_buat_lagi" ><span class="glyphicon glyphicon-ok-sign" aria-hidden="true"></span> Buat Lagi</button>
              <!--<a href="<?php echo site_url('rsa_up');?>" class="btn btn-danger"><span class="glyphicon glyphicon-remove-sign" aria-hidden="true"></span> Tidak</a>-->
