		...
		<table class="table table-striped">
			...
			<tbody style="font-size:12pt;">
				...
				<tr>
					...
					<td>						
						<a href="<?php echo site_url('akuntansi/rsa_ks/spm_ks_lihat/'.urlencode(base64_encode($result->no_spp))).'/'.$this->session->userdata('kode_unit').'/'.$tahun?>" target="_blank"><button type="button" class="btn btn-sm btn-primary">Bukti</button></a>
