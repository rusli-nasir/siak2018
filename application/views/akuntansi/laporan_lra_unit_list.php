...
<div class="container-fluid">
    <?php echo form_open('akuntansi/laporan/lra_unit',array("class"=>"form-horizontal","id" => "form_pop")); ?>
	<!-- Text input-->
    ...
    <div id="vue_unit">
      <div class="form-group">
        ...
        <div class="col-md-6">
            <select v-model="jenis_laporan" id="jenis_laporan" name="jenis_laporan" class="form-control" required="" readonly>
              <option value="Realisasi Anggaran" selected="selected">Realisasi Anggaran</option>
            </select>
        </div>
      </div>
