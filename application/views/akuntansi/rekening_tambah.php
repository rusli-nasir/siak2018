...
<div class="row">
	<div class="col-sm-8">
		<?php
		if($this->input->get('balasan')==2){
			echo '<div class="alert alert-danger">Gagal memasukan data</div>';
		}
		?>
		<form class="form-horizontal" action="<?php echo site_url('akuntansi/rekening/tambah_proses'); ?>" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" name="kode_rekening" maxlength="50" class="form-control" placeholder="111101" required>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-3">Uraian</label>
				<div class="col-sm-9">
					<input type="text" name="uraian" maxlength="255" class="form-control" placeholder="Kas Bank Mandiri Operasional BLU No Rek. 1360020080005" required>
				</div>
			</div>
			<div class="form-group">
