...
<ul class="nav nav-tabs">
  ...
  <li role="presentation" class="<?php if(isset($tab2)){ if($tab2==true) echo 'active'; } ?>"><a href="<?php echo site_url('akuntansi/kuitansi/jadi_ls'); ?>">LS3</a></li>
</ul>
<div class="row">
	<div class="col-sm-9">
				...
				<tr>
					...
					<td>						
						...
						<?php if($this->session->userdata('level')==1){ ?>
							<a href="<?php echo site_url('akuntansi/kuitansi/lihat/'.$result->id_kuitansi); ?>"><button type="button" class="btn btn-sm btn-danger">Lihat</button></a>
