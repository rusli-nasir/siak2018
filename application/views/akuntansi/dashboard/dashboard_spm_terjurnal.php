...
<div id="app">
  <div class="container-fluid">
    ...
    <div style="font-size:20pt;margin-bottom:20px;">
      <span class="glyphicon glyphicon-dashboard"></span> SPM Telah diproses siak <div style="font-size:12pt;margin-left:35px;"></div>
    </div>
    <div class="row">
      <div class="col-sm-8">
    ...
    <div class="row">
      <div class="col-sm-12"> 
        ...
        <span v-for="entry_rekap in rekap">
          <button class="btn btn-primary" type="button"  v-on:click="selected=entry_rekap.real_jenis " v-bind:class="{ disabled: selected==entry_rekap.real_jenis }">{{entry_rekap.jenis}} ({{entry_rekap.jumlah}})</button>
          &nbsp;
        </span>
      </div>
    </div>
          ...
          <table class="table" id="tabel_spm">
            ...
            <tbody>
              <tr v-for="(entry_spm,nomor) in selected_spm">
                ...
                <td>{{entry_spm.tanggal_spm}}</td>
                <td>{{entry_spm.tanggal_jurnal}}</td>
                <td>{{entry_spm.jumlah}}</td>
              </tr>
            </tbody>
          </table>
        </div>
...
<script type="text/javascript">
  $('#download_excel').click(function(){
    // var printed = jQuery.extend(true,{}, $('#printed_table'))
      ...
      this.href = result;
      this.download = "rekap_spm_terjurnal_siak.xls";
