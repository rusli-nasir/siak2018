...
<ul class="nav nav-tabs">
  ...
  <li role="presentation" class="<?php if(isset($tab_em)){ if($tab_em==true) echo 'active'; } ?>"><a href="<?php echo site_url('akuntansi/kuitansi/index_em'); ?>">E Money&nbsp;&nbsp;<span class="badge <?= $jumlah_notifikasi->em ? "badge-notify" : ""; ?> right"><?= $jumlah_notifikasi->em; ?></span></a></li>
  <li role="presentation" class="<?php if(isset($tab_ks)){ if($tab_ks==true) echo 'active'; } ?>"><a href="<?php echo site_url('akuntansi/kuitansi/index_ks'); ?>">KS&nbsp;&nbsp;<span class="badge <?= $jumlah_notifikasi->ks ? "badge-notify" : ""; ?> right"><?= $jumlah_notifikasi->ks; ?></span></a></li>
</ul>
<div class="row">
	<div class="col-sm-9">
		...
		<table class="table table-striped">
			...
			<tbody style="font-size:12pt;">
				...
				<tr>
					...
					<td>						
                        <?php if(isset($tab1)){ ?>
							<a href="<?php echo site_url('akuntansi/rsa_up/jurnal/'.urlencode($result->str_nomor_trx));?>" target="_blank"><button type="button" class="btn btn-sm btn-primary">Bukti</button></a>
                        <?php }elseif(isset($tab4)){ ?>
                        <!-- <a href="<?php echo site_url('akuntansi/rsa_gup/spm_gup_lihat_99/'.$result->kode_unit_subunit.'/'.explode('/', $result->str_nomor_trx)[4]);?>" target="_blank"><button type="button" class="btn btn-sm btn-primary">Bukti</button></a> -->
                        <a href="<?php echo site_url('akuntansi/rsa_up/spm_up_lihat_99/'.urlencode(base64_encode(get_no_spp($result->str_nomor_trx,'trx_nomor_up'))).'/'.$this->session->userdata('kode_unit').'/'.$tahun);?>" target="_blank"><button type="button" class="btn btn-sm btn-primary">Bukti</button></a>
