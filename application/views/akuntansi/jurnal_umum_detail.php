...
<div class="form-group">
  ...
  <div class="col-md-4">
    <select id="tipe" name="tipe" class="form-control" required="">
      ...
      <option <?php if ($tipe == "memorial"): ?> selected <?php endif ?> value="memorial" >Memorial</option>
      <option <?php if ($tipe == "jurnal-apbn"): ?> selected <?php endif ?> value="jurnal-apbn">Jurnal APBN</option>
    </select>
  </div>
</div>
