...
<div id="page-inner">
    ...
    <?php }elseif($doc_lsk == 'SPP-DITOLAK'){ $stts_bendahara = 'done'; $stts_ppk = 'tolak'; ?>
    ...
    <?php }elseif($doc_lsk == 'SPM-DITOLAK-KPA'){ $stts_bendahara = 'done'; $stts_ppk = 'done'; $stts_kpa = 'tolak' ; ?>   
    ...
    <?php }elseif($doc_lsk == 'SPM-DITOLAK-VERIFIKATOR'){ $stts_bendahara = 'done'; $stts_ppk = 'done'; $stts_kpa = 'done' ; $stts_verifikator = 'tolak'; ?>   
    ...
    <?php }elseif($doc_lsk == 'SPM-DITOLAK-KBUU'){ $stts_bendahara = 'done'; $stts_ppk = 'done'; $stts_kpa = 'done' ; $stts_verifikator = 'done'; $stts_kbuu = 'tolak'; ?>   
    ...
    <?php }elseif($doc_lsk == 'SPM-FINAL-BUU'){$stts_bendahara = 'done'; $stts_ppk = 'done'; $stts_kpa = 'done' ; $stts_verifikator = 'done'; $stts_kbuu = 'done'; $stts_buu = 'done';  ?> 
    ...
    <?php }elseif($doc_lsk == 'SPM-DITOLAK-BUU'){ $stts_bendahara = 'done'; $stts_ppk = 'done'; $stts_kpa = 'done' ; $stts_verifikator = 'done'; $stts_kbuu = 'done'; $stts_buu = 'tolak'; ?>   
        ...
        <div class="modal-content">
          ...
          <div class="modal-body" style="margin:0px;padding:15px;background-color: #EEE;">
            ...
            <tr >
              ...
              <!-- <form action="<?=site_url('akuntansi/bridge_kuitansi/cetak_kuitansi')?>" id="form_kuitansi_showpengembalian" method="post" style="display: none"  >
                    <input type="text" name="dtable" id="dtable" value="" />
