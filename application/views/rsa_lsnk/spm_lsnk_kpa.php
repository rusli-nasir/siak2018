...
$('#myModalKonfirm').on('hidden.bs.modal', function (e) {
    ...
    $(document).on("click",'#proses_spm_kpa',function(){
        ...
        //                 if(confirm("Yakin ?")){
                            ...
                            var data = 'proses=' + 'SPM-DRAFT-KPA' + '&nomor_trx=' + $('#nomor_trx_spm').html() + '&jenis=' + 'SPM' + '&id_nomor_lsnk=' + '<?=$id_nomor_lsnk?>' + '&tgl_proses=' + r ;
                ...
                //                        $('#myModalKuitansi').modal('show');
                                        if(data=='sukses'){
                                            window.location = '<?=site_url('rsa_lsnk/daftar_spm_kpa')?>';
                                        }
                //                        
                                }
                            });
    ...
    $(document).on("click",'#tolak_spm_kpa',function(){
        if(confirm('Apakah anda yakin ?')){
            var data = 'proses=' + 'SPM-DITOLAK-KPA' + '&nomor_trx=' + $('#nomor_trx_spm').html() + '&jenis=' + 'SPM' + '&ket=' + $('#ket').val() + '&rel_kuitansi=' + encodeURIComponent('<?=$rel_kuitansi?>') + '&rel_kuitansi_pengembalian=' + encodeURIComponent('<?=$rel_kuitansi_pengembalian?>')  + '&id_nomor_lsnk=' + '<?=$id_nomor_lsnk?>' + '&tgl_proses=' + '<?=date("Y-m-d")?>' ;
            $.ajax({
                type:"POST",
                url :"<?=site_url('rsa_lsnk/proses_spm_lsnk')?>",
                data:data,
...
<div id="page-inner">
    ...
    <?php }elseif($doc_lsnk == 'SPP-DITOLAK'){ $stts_bendahara = 'done'; ?>
    ...
    <?php }elseif($doc_lsnk == 'SPM-DITOLAK-KPA'){ $stts_bendahara = 'done'; $stts_ppk = 'done'; ?>   
