...
$(document).ready(function(){
        ...
        $("#untuk_pekerjaan").typeahead({
          source: function(query, process) {
                    return $.get("<?=site_url('rsa_lsnk/get_data_untuk_pekerjaan')?>", { query : query }, function (data) {
                        // console.log(data);
                        data = $.parseJSON(data);
                        return process(data);
                    });
        ...
        $("#nama_pihak_ketiga").typeahead({
          source: function(query, process) {
                    return $.get("<?=site_url('rsa_lsnk/get_data_penerima')?>", { query : query }, function (data) {
                        // console.log(item);
                        data = $.parseJSON(data);
                        return process(data);
...
//    var pj_p_nilai_all = [];
  ...
  // do something…
    ...
    <?php if(($doc_lsnk == '')&&($detail_lsnk['nom'] == '0')&&($detail_lsnk['pengembalian'] == '0'))://if($detail_lsnk['nom'] == '0'):?>
...
//    }).show();
        ...
        $('#myModalKonfirm').on('show.bs.modal', function (e) {
            // do something...
            // alert('te');
            var pengeluaran_m = <?=$detail_lsnk['nom']?> ;
            var pengembalian_n = <?=$detail_lsnk['pengembalian']?> ;
    ...
    //                        $('#myModalKuitansi').modal('show');
                            if(data=='sukses'){
                                ...
                                window.location = "<?=site_url('rsa_lsnk/daftar_spp')?>" ;
...
<div id="page-inner">
    ...
    <?php if((substr($doc_lsnk,4,7)=='DITOLAK')&&($detail_lsnk['nom'] > 0)){ $stts_bendahara = 'active'; ?>   
    ...
    <?php }elseif($doc_lsnk == 'SPP-DRAFT'){ $stts_bendahara = 'done'; $stts_ppk = 'active'; ?>
        <div class="alert alert-info" style="border:1px solid #a94442;">SPP LSNK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> menunggu persetujuan <b><span class="text-danger" >PPK </span></b> .</div>
    <?php }elseif($doc_lsnk == 'SPP-DITOLAK'){ $stts_bendahara = 'active'; ?>
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPP LSNK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >PPK </span></b> <b>[ <a href="javascript:void(0);" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    <?php }elseif($doc_lsnk == 'SPP-FINAL'){ $stts_bendahara = 'done';  $stts_ppk = 'done'; ?>   
        <div class="alert alert-info" style="border:1px solid #a94442;">SPP LSNK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah diterima oleh <b><span class="text-danger" >PPK </span></b> .</div>
    ...
    <?php }elseif($doc_lsnk == 'SPM-DITOLAK-KPA'){ $stts_bendahara = 'active'; ?>   
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPM LSNK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >KPA </span></b> <b>[ <a href="javascript:void(0);" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    ...
    <?php }elseif($doc_lsnk == 'SPM-DITOLAK-VERIFIKATOR'){ $stts_bendahara = 'active'; ?>   
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPM LSNK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >VERIFIKATOR </span></b> <b>[ <a href="javascript:void(0);" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    ...
    <?php }elseif($doc_lsnk == 'SPM-DITOLAK-KBUU'){ $stts_bendahara = 'active'; ?>   
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPM LSNK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >KUASA BUU </span></b> <b>[ <a href="javascript:void(0);" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    ...
    <?php }elseif($doc_lsnk == 'SPM-DITOLAK-BUU'){ $stts_bendahara = 'active'; ?>   
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPM LSNK Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >BUU </span></b> <b>[ <a href="javascript:void(0);" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    <?php } ?>
				...
				<tr>
                                    <td colspan="5" style="line-height: 16px;border-bottom: none;border-top: none;">
                                        <ol style="list-style-type: lower-alpha;margin-top: 0px;margin-bottom: 0px;" >
                                            <li>Jumlah pembayaran yang diminta : Rp. <span id="jumlah_bayar" style='mso-number-format:"\@";'><?=number_format($detail_lsnk['nom'], 0, ",", ".")?></span>,-<br>
                                                &nbsp;&nbsp;&nbsp;(Terbilang : <b><span id="terbilang"><?=ucwords($detail_lsnk['terbilang'])?> <?php echo substr($detail_lsnk['terbilang'],strlen($detail_lsnk['terbilang'])-6,6) == 'Rupiah' ? '' : 'Rupiah' ; ?></span></b>)</li>
...
<form action="<?=site_url('rsa_up/cetak_spp')?>" id="form_spp" method="post" style="display: none"  >
    ...
    <input type="text" name="dtahun" id="dtahun" value="<?=$cur_tahun?>" />
            ...
            <div class="alert alert-warning" style="text-align:center">
                ...
                <?php }elseif(($doc_lsnk == 'SPP-DITOLAK')||($doc_lsnk == 'SPM-DITOLAK-KPA')||($doc_lsnk == 'SPM-DITOLAK-VERIFIKATOR')||($doc_lsnk == 'SPM-DITOLAK-KBUU')||($doc_lsnk == 'SPM-DITOLAK-BUU')){ ?>
                    <?php if($detail_lsnk['nom'] == '0'):?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>
            <div class="form-group">
                <blockquote class="">
                <p class="text-danger">Untuk membuat SPP LSNK silahkan anda memulai dari daftar kuitansi yang akan diusulkan.</p>
              </blockquote>
            </div>
        </p>
      </div>
