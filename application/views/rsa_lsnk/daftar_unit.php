...
$(document).on("click","#show",function(){
    if($("#form_").validationEngine("validate")){
        window.location = "<?=site_url('rsa_lsnk/daftar_unit/')?>" + $('#tahun').val();
...
//     window.location = "<?=site_url("rsa_tup/spm_tup_verifikator/")?>" + unit + '/' + tahun; 
                                ...
                                <?php foreach($unit_usul as $i => $u){ ?>
                                    ...
                                    <tr rel="<?=$u->kode_unit?>" class="tr-unit" height="25px">
                                        ...
                                        <tr rel="<?=$uu->kode_subunit?>" class="tr-unit warning" height="25px">
                                            ...
                                            <td align="center">
                                                ...
                                                <a href="<?=site_url("rsa_lsnk/daftar_spm_verifikator/".$cur_tahun.'/'.$uu->kode_subunit)?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-share" aria-hidden="true"></span> Lihat</a>

                                                <?php else: ?>

                                                <a href="<?=site_url("rsa_lsnk/daftar_spm_verifikator/".$cur_tahun.'/'.$uu->kode_subunit)?>" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-share" aria-hidden="true"></span> Lihat</a>
                                    ...
                                    <tr rel="<?=$u->kode_unit?>" class="tr-unit" height="25px">
                                        ...
                                        <td align="center">
                                            ...
                                            <a href="<?=site_url("rsa_lsnk/daftar_spm_verifikator/".$cur_tahun.'/'.$u->kode_unit)?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-share" aria-hidden="true"></span> Lihat</a>

                                            <?php else: ?>

                                            <a href="<?=site_url("rsa_lsnk/daftar_spm_verifikator/".$cur_tahun.'/'.$u->kode_unit)?>" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-share" aria-hidden="true"></span> Lihat</a>
