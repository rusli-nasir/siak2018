...
<div id="page-wrapper" >
                ...
                <div class="row text-center pad-top">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                      <div class="div-square">
                           <a href="<?php echo base_url(); ?>index.php/rsa_lsnk/daftar_unit_kbuu" >
 <i class="fa fa-file-text fa-5x"></i>
                  ...
                  <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                      <div class="div-square">
                           <a href="<?php echo base_url(); ?>index.php/rsa_lsnk/daftar_unit" >
 <i class="fa fa-file-text fa-5x"></i>
                      <h4>SPM</h4>
                      </a>
                      </div>
 ...
 <i class="fa fa-file-archive-o fa-5x"></i>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                      <div class="div-square">
                           <a href="<?php echo base_url(); ?>index.php/rsa_lsnk/daftar_spp" >
 ...
 <i class="fa fa-file-text fa-5x"></i>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                      <div class="div-square">
                           <a href="<?php echo base_url(); ?>index.php/rsa_lsnk/daftar_spm" >
 <i class="fa fa-bars fa-5x"></i>
                      <h4>Daftar SPM</h4>
                      </a>
                      </div>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                      <div class="div-square">
                           <a href="<?php echo base_url(); ?>index.php/rsa_lsnk/daftar_spm_kpa" >
 <i class="fa fa-bars fa-5x"></i>
                      <h4>Daftar SPM</h4>
                      </a>
                      </div>
