...
<div id="page-inner">
    ...
    <?php if((substr($doc_gup,4,7)=='DITOLAK')&&($detail_gup['nom'] > 0)){ $stts_bendahara = 'active'; ?>   
    ...
    <?php }elseif($doc_gup == 'SPM-DITOLAK-BUU'){ $stts_bendahara = 'active'; ?>   
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPM GUP Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >BUU </span></b> <b>[ <a href="javascript:void(0);" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    <?php } ?>
...
<form action="<?=site_url('rsa_up/cetak_spp')?>" id="form_spp" method="post" style="display: none"  >
    ...
    <input type="text" name="dtahun" id="dtahun" value="<?=$cur_tahun?>" />
            ...
            <div class="alert alert-warning" style="text-align:center">
                ...
                <?php }elseif(($doc_gup == 'SPP-DITOLAK')||($doc_gup == 'SPM-DITOLAK-KPA')||($doc_gup == 'SPM-DITOLAK-VERIFIKATOR')||($doc_gup == 'SPM-DITOLAK-KBUU')||($doc_gup == 'SPM-DITOLAK-BUU')){ ?>
                    <?php if($detail_gup['nom'] == '0'):?>
