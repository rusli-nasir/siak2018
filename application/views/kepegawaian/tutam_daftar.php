		...
		<div class="row">
			<div class="col-md-12">
				<h4 class="page-header">
					<i class="glyphicon glyphicon-gift"></i>&nbsp;&nbsp;Data Insentif Tugas Tambahan - <a href="<?php echo site_url('kepegawaian'); ?>" title="ke Menu Utama Kepegawaian">Kepegawaian #3</a>
				</h4>
        <p class="text-right">
		  ...
		  <div class="col-md-12 result_data">
        	...
        	<div class="col-md-12" style="background-color:#fff;padding:3px;">
              ...
              Bulan <?php echo $this->cantik_model->wordMonth($_SESSION['tutam']['bulan']); ?> Tahun <?php if(!isset($_SESSION['tutam']['tahun'])){echo $cur_tahun;}else{echo $_SESSION['tutam']['tahun'];} ?>
            </h4>
        ...
        <div class="modal-body">
          <span class="message"></span>
        	<div class="row">
	              ...
	              <input type="text" class="form-control input-sm" name="tahun" value="<?php if(!isset($_SESSION['tutam']['tahun'])){echo $cur_tahun;}else{echo $_SESSION['tutam']['tahun'];} ?>" style="text-align:right;"/>
	            </div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
...
<script type="text/javascript">
	function load_list(){
		$('#load_list').load("<?php echo site_url('tutam/daftar_ajax'); ?>");
	}
