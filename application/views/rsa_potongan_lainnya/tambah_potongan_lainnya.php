...
//                            var sumber_dana = $('#sumber_dana').val();
                            window.location = "<?=site_url("rsa_potongan_lainnya/tambah_potongan_lainnya/").$kode_unit_subunit."/"?>" + $("#jenis").val() + '/' + $("#bulan").val() ;
...
//                        }
   ...
   //                  });
		...
		$(document).on("submit","#form_ptla",function(e){
			...
			// 	 akun_belanja_ket = '['+akun_belanja+'] '+$('#akun_belanja option:selected').text().substr(27, 200);
			// }
	...
	<div id="page-inner">
		...
		<div class="tab-base">
			<ul class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active"><a href="#" aria-controls="tambah_sp2d" role="tab" data-toggle="tab"><b><i class="fa fa-plus-circle"></i> Uraikan Potongan Lainnya</b></a></li>
				<li role="presentation"><a href="<?php echo site_url('rsa_potongan_lainnya/potongan_lainnya_per_spm') ?>"><b><i class="fa fa-list"></i> Daftar Potongan Lainnya</b></a></li>
			</ul>
		</div>
		...
		<div class="row">
				...
				<div class="row">
					...
					<div class="col-md-12 table-responsive">
						<span><b>*Catatan: SPM yang muncul adalah SPM yang memiliki nominal <span style="color: red;">Potongan Lainnya</span> dan telah memiliki transaksi SP2D</b></span>
												...
												<div class="btn-group" role="group" id="btn_group_ptla_<?php echo $value->id_trx_urut_spm_cair; ?>">
													...
													<?php if ($persen_ptla == 100): ?>
														<?php if ($value->proses == 0): ?>
															<?php if ($value->tolakstatus == 1): ?>
																<button class="btn btn-sm btn-info btn-ajukan" data-no-spm="<?php echo $value->str_nomor_trx_spm; ?>"><i class="fa fa-share-square-o"></i> Ajukan</button>
															<?php else: ?>
																<button class="btn btn-sm btn-primary btn-ajukan" data-no-spm="<?php echo $value->str_nomor_trx_spm; ?>"><i class="fa fa-share-square-o"></i> Ajukan</button>
															<?php endif ?>
														<?php elseif($value->proses == 1): ?>
															<button class="btn btn-xs btn-danger" disabled><i class="fa fa-clock-o"></i> Verif</button>
														...
														<?php elseif($value->proses == 3): ?>
															<button class="btn btn-sm btn-success" disabled><i class="fa fa-check-square-o"></i> Selesai</button>
														<?php endif ?>

														<button class="btn btn-sm btn-default btn-lihat" title="lihat" onclick="window.location.href='<?php echo site_url().'/rsa_potongan_lainnya/dokumen_ptla/'.urlencode(base64_encode($value->str_nomor_trx_spm)) ?>'"><i class="fa fa-search"></i></button>
													<?php else: ?>
