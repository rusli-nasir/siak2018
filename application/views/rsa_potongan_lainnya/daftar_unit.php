                            ...
                            <tbody id="tb-isi" >
                                <?php foreach($unit as $i => $u): ?>
                                    ...
                                    <?php foreach ($unit as $key => $value): ?>
                                    		<?php if (strlen($value->kode_unit) == 4): ?>
			                                	...
			                                	<tr rel="<?=$value->kode_unit?>" class="tr-unit warning" height="25px" style="background-color: ">
			                                        ...
			                                        <td align="center">&nbsp;
			                                        	<?php if ($value->jumlah > 0): ?>
			                                        	<a href="<?=site_url('rsa_potongan_lainnya/daftar_potongan_lainnya/'.$value->kode_unit)?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-share" aria-hidden="true"></span> Lihat</a>
			                                        	<?php else: ?>
			                                        	<a href="<?=site_url('rsa_potongan_lainnya/daftar_potongan_lainnya/'.$value->kode_unit)?>" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-share" aria-hidden="true"></span> Lihat</a>	
			                                        	<?php endif ?>
			                                        </td>
			                                    </tr>
                                    			<?php endif ?>
                                    ...
                                    <tr rel="<?=$u->kode_unit?>" class="tr-unit" height="25px">
                                        ...
                                        <td align="center">&nbsp;
                                        	<?php if ($u->jumlah > 0): ?>
											<a href="<?=site_url('rsa_potongan_lainnya/daftar_potongan_lainnya/'.$u->kode_unit)?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-share" aria-hidden="true"></span> Lihat</a>
                                        	<?php else: ?>
                                    		<a href="<?=site_url('rsa_potongan_lainnya/daftar_potongan_lainnya/'.$u->kode_unit)?>" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-share" aria-hidden="true"></span> Lihat</a>
                                        	<?php endif ?>
                                        </td>
                                    </tr>						
                                	<?php endif ?>
