...
<div id="page-inner">
    ...
    <?php }elseif($doc_tup == 'SPP-DITOLAK'){ $stts_bendahara = 'done';  ?>
    ...
    <?php }elseif($doc_tup == 'SPM-DITOLAK-KPA'){ $stts_bendahara = 'done'; $stts_ppk = 'done'; ?>   
    ...
    <?php }elseif($doc_tup == 'SPM-DITOLAK-VERIFIKATOR'){ $stts_bendahara = 'done'; $stts_ppk = 'done'; $stts_kpa = 'done' ; ?>   
