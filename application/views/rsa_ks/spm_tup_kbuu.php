...
//            console.log(nominal + ' ' + saldo_kas);
            ...
            if(parseInt(saldo_kas) < parseInt(jumlah_bayar)){
                ...
                if(confirm('Apakah anda yakin ?')){
                    ...
                    var data = 'proses=' + 'SPM-FINAL-KBUU' + '&nomor_trx=' + $('#nomor_trx_spm').html() + '&jenis=' + 'SPM' + '&tahun=' + '<?=$cur_tahun?>' +'&kd_unit=' + '<?=$kd_unit?>' + '&kd_akun_kas=' + kd_akun_kas + '&kredit=' + '<?php echo isset($detail_tup_spm['nom'])?$detail_tup_spm['nom']:''?>' + '&deskripsi=' + 'TUP-NIHIL <?=$alias?>' + '&nominal=' + jumlah_bayar + '&rel_kuitansi=' + encodeURIComponent('<?=$rel_kuitansi?>') ;
                    $.ajax({
                        type:"POST",
...
<div role="tabpanel" class="tab-pane" id="rekappajak">
        ...
        <div id="div-cetak-lampiran-rekappajak">
                <table id="table_rekappajak" class="table_lamppajak" style="font-family:arial;font-size:12px; line-height: 21px;border-collapse: collapse;width: 1300px;border: 1px solid #000;background-color: #FFF;" cellspacing="0" border="1" cellpadding="0" >
                    <tbody>
                            <tr >
                                <td colspan="14" class="text-left" style="text-align: left;border: none;padding-left:20px;">
                                    <!--<h4><b>UNIVERSITAS DIPONEGORO</b></h4>-->
                                    <h5><b>Lampiran Pajak</b></h5>
                                    <h5><b>Nomor SPP : <?=$nomor_spp?></b></h5>
                                    <!--<h5><b>Nomor SPM : <?=$nomor_spm?></b></h5>-->
                                    <!--<b style="text-transform: uppercase;">SUKPA : <?=$unit_kerja?> <span style="display: inline-block;width: 100px;">&nbsp;</span> UNIT KERJA : <?=$unit_kerja?></b><br>-->
                                </td>
                            </tr>
                            <tr >
                                ...
                                <td colspan="12" class="text-left" style="text-align: left;border: none;padding-left:20px;">
                            ...
                            <tr>
                                <td colspan="4" style="border-bottom: none; padding-left: 10px;"><b>Sub Jumlah Akun - <?=$data_pajak?></b></td>
                                <td class="text-right" style='padding-right: 10px;mso-number-format:"\@";'><b><?=number_format($tot_bruto, 0, ",", ".")?></b></td>
                            ...
                            <?php endforeach;?>
                            <tr>
                                <td colspan="4" style="border-bottom: none; padding-left: 10px;"><b>Jumlah</b></td>
                                <td class="text-right" style='padding-right: 10px;mso-number-format:"\@";'><b><?=number_format($tot_bruto_, 0, ",", ".")?></b></td>
