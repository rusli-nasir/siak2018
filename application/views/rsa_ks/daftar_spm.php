      ...
      $('#spm_tab a[href="' + hash + '"]').tab('show');
		...
		$(document).on("click","#pilih_tahun",function(){
                        ...
                        var type = window.location.hash.substr(1);
                            ...
                            window.location = "<?=site_url("rsa_gup/daftar_spm")?>/" + $("#tahun").val() + '#' + type;
  ...
  <div class="tab-content">
	...
	?>
					<tr>
						...
						<?php if( $key == ($n - 1)): ?>
						<td class="text-center"><b>[ <a href="<?=site_url('/rsa_gup/spm_gup/')?>">lihat</a> ]</b></td>
 						<?php else : ?>
						<td class="text-center"><b>[ <a href="<?=site_url('/rsa_gup/spm_gup_lihat/').urlencode(base64_encode($value->str_nomor_trx))?>">lihat</a> ]</b></td>
						<?php endif; ?>
					</tr>
	<?php
			}
