...
//                                    $('.ck_' + id).attr('rel','');
		...
		$(document).on("click","#pilih_tahun",function(){
                            ...
                            window.location = "<?=site_url("kuitansi/daftar_kuitansi2")?>/L3/" + $("#tahun").val();
...
<div id="page-wrapper">
	<div id="page-inner">
		<!-- start content -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2>DAFTAR KUITANSI LS PIHAK 3</h2> 
                    </div>
                </div>
                <hr />
	...
	?>
				...
				<form action="<?=site_url('rsa_lsphk3/create_spp_lsphk3')?>" id="form_usulkan_spp" method="post" style="display: none">
