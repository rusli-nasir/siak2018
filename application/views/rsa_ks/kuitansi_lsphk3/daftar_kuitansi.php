...
//                                    $('.ck_' + id).attr('rel','');
		...
		$(document).on("click","#pilih_tahun",function(){
                            ...
                            window.location = "<?=site_url("kuitansi/daftar_kuitansi")?>/GP/" + $("#tahun").val();
                                                    ...
                                                    <?php if($value->aktif == "1"):?>
                                                        ...
                                                        <?php else: ?>
                                                            <?php if($value->cair == '0'):?>
                                                                ...
                                                                <button type="button" class="btn btn-info btn-sm btn_proses" rel="" onclick="bootbox.alert('Telah diajukan SPM : <?=$value->str_nomor_trx_spm?> <br> dan SPP : <?=$value->str_nomor_trx?>')" title="Diajukan SPM"><i class="glyphicon glyphicon-file"></i></button>
                                                                <?php else: ?>
                                                                    <?php if(!is_null($value->str_nomor_trx)):?>
                                                                    <button type="button" class="btn btn-success btn-sm btn_proses" rel="" onclick="bootbox.alert('Telah diajukan SPP : <?=$value->str_nomor_trx?>')" title="Diajukan SPP"><i class="glyphicon glyphicon-file"></i></button>
