<div id="page-wrapper" >
 ...
 <i class="fa fa-file-text-o fa-5x"></i>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                      <div class="div-square">
                           <a href="<?php echo base_url(); ?>index.php/rsa_ks/daftar_unit_kbuu" >
 <i class="fa fa-file-text fa-5x"></i>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                      <div class="div-square">
                           <a href="<?php echo base_url(); ?>index.php/rsa_ks/spp_ks" >
 <i class="fa fa-bars fa-5x"></i>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                      <div class="div-square">
                           <a href="<?php echo base_url(); ?>index.php/rsa_ks/saldo" >
 <i class="fa fa-credit-card fa-5x"></i>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                      <div class="div-square">
                           <a href="<?php echo base_url(); ?>index.php/rsa_ks/daftar_unit" >
 <i class="fa fa-file-text fa-5x"></i>
                      <h4>SPM UP</h4>
                      </a>
                      </div>
 ...
 <i class="fa fa-bars fa-5x"></i>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                      <div class="div-square">
                           <a href="<?php echo base_url(); ?>index.php/rsa_ks/spm_up" >
 <i class="fa fa-file-text fa-5x"></i>
                      <h4>SPM UP</h4>
                      </a>
                      </div>
 ...
 <i class="fa fa-bars fa-5x"></i>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                      <div class="div-square">
                           <a href="<?php echo base_url(); ?>index.php/rsa_ks/spm_up_kpa" >
 <i class="fa fa-file-text fa-5x"></i>
                      <h4>SPM UP</h4>
                      </a>
                      </div>
