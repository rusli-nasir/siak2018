...
//                        $('#myModalKuitansi').modal('show');
                        if(data=='sukses'){
                            window.location = '<?=site_url('rsa_tambah_ks/daftar_spm')?>';
                        }
//                        
                }
            });
				...
				<tr>
                                    <td colspan="5" style="line-height: 16px;border-bottom: none;border-top: none;">
                                        <ol style="list-style-type: lower-alpha;margin-top: 0px;margin-bottom: 0px;" >
                                            <li>Jumlah pembayaran yang diminta : Rp. <span id="jumlah_bayar_spp"><?=number_format($detail_tambah_ks['nom'], 0, ",", ".")?></span>,-<br>
                                                &nbsp;&nbsp;&nbsp;(Terbilang : <b><span id="terbilang_spp"><?=ucwords($detail_tambah_ks['terbilang'])?> <?php echo substr($detail_tambah_ks['terbilang'],strlen($detail_tambah_ks['terbilang'])-6,6) == 'Rupiah' ? '' : 'Rupiah' ; ?></span></b>)</li>
                                                <li>Untuk keperluan : <span id="untuk_bayar_spp"><?=isset($detail_pic->untuk_bayar)?$detail_pic->untuk_bayar:'-'?></span></li>
                                                <li>Nama PIC : <span id="penerima_spp"><?=isset($detail_pic->penerima)?$detail_pic->penerima:'-'?></span></li>
