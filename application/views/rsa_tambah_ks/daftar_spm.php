...
//                            var sumber_dana = $('#sumber_dana').val();
                            window.location = "<?=site_url("rsa_tambah_ks/daftar_spm")?>/" + $("#tahun").val();
...
<div id="page-wrapper">
	...
	?>
					<tr>
						...
						<!--<td class="text-center"><b>[ <a href="<?=site_url('/rsa_tambah_ks/spm_tambah_ks/').urlencode(base64_encode($value->str_nomor_trx_spp))?>">lihat</a> ]</b></td>-->
						<?php if(($value->posisi == 'SPP-DRAFT')||($value->posisi == 'SPP-FINAL')):?>
						<td class="text-center"><b>[ <a href="<?=site_url('/rsa_tambah_ks/spm_tambah_ks/').urlencode(base64_encode($value->str_nomor_trx_spp))?>">lihat</a> ]</b></td>
