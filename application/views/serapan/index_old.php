                                ...
                                <?php if(!empty($data_akun)): ?>
                                    ...
                                    <?php foreach($data_akun as $i => $d): ?>
                                        ...
                                        <tr >
                                            ...
                                            <td style="text-align:right" rel="<?=$d->kode_akun?>" class="kode_akun_a_<?=$d->kode_akun?>"><?=number_format($data_anggaran[$d->kode_akun], 0, ",", ".")?></td>
                                            <?php // number_format($d->jum, 0, ",", "."); ?>
                                            <td style="text-align:right" rel="<?=$d->kode_akun?>" class="kode_akun_s_<?=$d->kode_akun?>"><?=number_format($data_serapan[$d->kode_akun], 0, ",", ".")?></td>
                                        ...
                                        <?php $tot_anggaran = $tot_anggaran + $data_anggaran[$d->kode_akun] ; ?>
                                        <?php $tot_serapan = $tot_serapan + $data_serapan[$d->kode_akun] ; ?>
