...
$(document).ready(function(){
    ...
    //     $.ajax({
    //                 type:"POST",
    //                 url :"<?=site_url("serapan/get_anggaran_dikti/")?>" + kode_akun + '/<?=$sumber_dana?>/<?=$unit?>/<?=$tahun?>' ,
    //                 data:'',
    ...
    //     $.ajax({
    //                 type:"POST",
    //                 url :"<?=site_url("serapan/get_serapan_dikti/")?>" + kode_akun + '/<?=$sumber_dana?>/<?=$unit?>/<?=$tahun?>/<?=$triwulan?>' ,
    //                 data:'',
    //                 success:function(respon){
    //                     el.text(angka_to_string(respon));
...
$(document).on("click","#show",function(){
    if($("#form_dpa").validationEngine("validate")){
        ...
        <?php if($r_unit != '99') : ?>
        window.location.href = "<?=site_url('/serapan/dikti/')?>" + $('#sumber_dana').val() + '/' + $('#triwulan').val() ;
        <?php else: ?>
        window.location.href = "<?=site_url('/serapan/dikti/')?>" + $('#sumber_dana').val() + '/' + $('#triwulan').val() + '/' + $('#unit').val() ;
        <?php endif; ?>
                            ...
                            <tbody id="tb-isi" >
                                <?php if(!empty($data_akun)): ?>
                                    ...
                                    <?php foreach($data_akun as $i => $d): ?>
                                        <?php if (!(in_array($d->kode_akun, $a1))): ?>
                                        <tr >
                                            <td><?=$d->kode_akun.' - '.$d->nama_akun?></td>
                                            <td style="text-align:right" rel="<?=$d->kode_akun?>" class="kode_akun_a5_<?=$d->kode_akun?>">0</td>
                                            <td style="text-align:right" rel="<?=$d->kode_akun?>" class="kode_akun_s5_<?=$d->kode_akun?>">0</td>
                                            <td style="text-align:right" rel="<?=$d->kode_akun?>" class="kode_akun_b5_<?=$d->kode_akun?>">0</td>
                                            <td style="text-align:right" rel="<?=$d->kode_akun?>" class="kode_akun_c5_<?=$d->kode_akun?>">0</td>
                                        </tr>
                                        <?php $a1[] = $d->kode_akun; ?>
                                        <?php endif; ?>
                                        <tr >
