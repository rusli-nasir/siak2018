...
<div id="page-wrapper" >
	<div id="page-inner">
		<div class="row">
			<div class="col-lg-12">
				<h3><b>CETAK KUITANSI KEMBALI</b></h3><hr>
								...
								<table id="table" style="font-family:arial;font-size:12px; line-height: 21px;border-collapse: collapse;width: 900px;border: 1px solid #000;background-color: #FFF;" cellspacing="0" border="1" cellpadding="0">
									<tbody>
										...
										<tr style="border-top: none;">
											<td colspan="7" style="text-align: center;font-size: 16px;border-bottom: none;border-top: none;"><b>KUITANSI PENGEMBALIAN UANG PANJAR</b></td>
										</tr>
										<tr >
											<td colspan="7" style="border-bottom: none;border-top: none;">&nbsp;</td>
										</tr>
										<tr>
											...
											<td style="border-left: none;border-right: none;"><b>Nomor : <?php echo $data_pumk->nomor_trx_rsa_pumk_kembali ?></b></td>
										...
										<tr >
											...
											<td colspan="5" style="border-bottom: none;border-top: none;border-right: none;border-left: none;">Bendahara Pengeluaran SUKPA menerima uang panjar kembali sebagai berikut :</td>
										...
										<tr>
											...
											<td colspan="5" style="border-right: none;border-left: none;line-height: 16px;border-bottom: none;border-top: none;">
												<ol style="list-style-type: lower-alpha;margin-top: 0px;margin-bottom: 0px;" >
													...
													&nbsp;&nbsp;&nbsp;(Terbilang : <?=ucwords($terbilang)?><?php echo substr($terbilang,strlen($terbilang)-6,6) == 'Rupiah' ? '' : 'Rupiah' ; ?><b></b>)</li>
													<li>Nama Pemberi : <?php echo $data_pumk->nama_pumk ?></li>
													<li>NIP : <?php echo $data_pumk->nomor_induk ?></li>
													<li>Keterangan : <?php echo $data_pumk->keterangan ?></li>
												</ol>
											</td>
											<td style="border-left: none;border-bottom: none;border-top: none;">&nbsp;</td>
										</tr>
										<tr>
											...
											<td colspan="5" style="line-height: 16px;border-bottom: none;border-top: none;border-left: none;border-right: none;">
												Kuitansi sebagaimana dimaksud diatas, disusun dan disampaikan kepada pengguna/kuasa pengguna anggaran sebagai bukti pengembalian uang panjar ke dana uang persediaan bendahara pengeluaran.<br><br>														
											</td>
											<td style="border-left: none;border-bottom: none;border-top: none;">&nbsp;</td>
										</tr>
										<tr>
