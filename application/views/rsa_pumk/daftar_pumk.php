...
$(document).ready(function(){
	...
	$(document).on("click",".lihat_cetak",function(){
		...
		$.ajax({
			type:"POST",
			url:"<?=site_url("rsa_pumk/cetak_pumk")?>",
			data:data,
					...
					<tbody id="row_space">
						...
						<?php foreach ($daftar_pumk as $key => $daftar_pumk): ?>
							...
							<tr>
								...
								<td>
									<?php echo $daftar_pumk->nomor_trx_rsa_pumk ?>
								</td>
								<td>
								...
								<td>
									<?php echo $daftar_pumk->keperluan ?>
								</td>
								<td style="text-align: center;">
									<button type="button" class="lihat_cetak btn btn-info btn-sm" rel="" value="<?php echo $daftar_pumk->nomor_trx_rsa_pumk ?>" id="lihat_<?php echo $daftar_pumk->id_trx_rsa_pumk ?>" aria-label="Center Align">Lihat</button>
									<button type="button" class="edit  btn btn-warning btn-sm" rel="" value="<?php echo $daftar_pumk->nomor_trx_rsa_pumk ?>" id="edit_<?php echo $daftar_pumk->id_trx_rsa_pumk ?>" aria-label="Center Align">Edit</button>
								</td>
							</tr>
							<?php  $i++; endforeach  ?>
						</tbody>
