...
$('#myModalKonfirm').on('hidden.bs.modal', function (e) {
    ...
    $(document).on("click",'#proses_spp',function(){
        if(confirm('Apakah anda yakin ?')){
            var data = 'proses=' + 'SPP-FINAL' + '&nomor_trx=' + $('#nomor_trx').html() + '&jenis=' + 'SPP'  + '&id_nomor_tambah_ks=' + '<?=$id_nomor_tambah_ks?>' ;
            $.ajax({
                type:"POST",
...
//                        
    ...
    $(document).on("click",'#tolak_spp_',function(){
        if(confirm('Apakah anda yakin ?')){
            var data = 'proses=' + 'SPP-DITOLAK' + '&nomor_trx=' + $('#nomor_trx').html() + '&jenis=' + 'SPP' + '&ket=' + $('#ket').val() + '&id_nomor_tambah_ks=' + '<?=$id_nomor_tambah_ks?>' ;
            $.ajax({
                type:"POST",
                url :"<?=site_url('rsa_tambah_ks/proses_spp_tambah_ks')?>",
                data:data,
				...
				<tr>
                                    <td colspan="5" style="line-height: 16px;border-bottom: none;border-top: none;">
                                        <ol style="list-style-type: lower-alpha;margin-top: 0px;margin-bottom: 0px;" >
                                            <li>Jumlah pembayaran yang diminta : Rp. <span id="jumlah_bayar_spp"><?php echo isset($detail_tambah_ks['nom'])?number_format($detail_tambah_ks['nom'], 0, ",", "."):''; ?></span>,-<br>
                                                &nbsp;&nbsp;&nbsp;(Terbilang : <b><span id="terbilang_spp"><?php echo isset($detail_tambah_ks['terbilang'])?ucwords($detail_tambah_ks['terbilang']):''; ?></span></b>)</li>
...
<form action="<?=site_url('rsa_tambah_ks/cetak_spp')?>" id="form_spp" method="post" style="display: none"  >
    <input type="text" name="dtable" id="dtable" value="" />
      ...
      <div role="tabpanel" class="tab-pane" id="spm">
          ...
          <div style="background-color: #EEE; padding: 10px;">
            ...
            <?php if($doc_tambah_ks != 'SPP-DITOLAK'): ?>
		<table id="table_spp" style="font-family:arial;font-size:12px; line-height: 21px;border-collapse: collapse;width: 900px;border: 1px solid #000;background-color: #FFF;" cellspacing="0" border="1" cellpadding="0" >
			<tbody>
                            <tr >
				...
				<tr>
                                    <td colspan="5" style="line-height: 16px;border-bottom: none;border-top: none;">
                                        <ol style="list-style-type: lower-alpha;margin-top: 0px;margin-bottom: 0px;" >
                                            <li>Jumlah pembayaran yang diminta : Rp. <span id="jumlah_bayar"><?php echo isset($detail_tambah_ks['nom'])?number_format($detail_tambah_ks['nom'], 0, ",", "."):''; ?></span>,-<br>
                                                &nbsp;&nbsp;&nbsp;(Terbilang : <b><span id="terbilang"><?php echo isset($detail_tambah_ks['terbilang'])?ucwords($detail_tambah_ks['terbilang']):''; ?></span></b>)</li>
							...
							<li>Kebenaran perhitungan dan isi tertuang dalam SPP ini menjadi tanggung jawab Bendahara Pengeluaran sepanjang sesuai dengan bukti-bukti pengeluaran yang telah ditandatangani oleh PPPK atau PPK</li>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" style="vertical-align: top;line-height: 16px;padding-left: 10px;">
                                        <?php if(isset($detail_spm_tambah_ks['nom'])){ ?>
                                            <?php if($detail_spm_tambah_ks['nom'] >= 100000000){ ?>
                                            Setuju dibayar : <br>
    ...
    <?php else: ?>
        ...
        <div class="alert alert-danger" style="background-color: #FFF;">
            Tidak ada SPM karena SPP tertolak.
        </div>
...
<form action="<?=site_url('rsa_tambah_ks/cetak_spm')?>" id="form_spm" method="post" style="display: none"  >
    <input type="text" name="dtable_2" id="dtable_2" value="" />
            ...
            <div class="alert alert-warning" style="text-align:center">
                ...
                <?php if($doc_tambah_ks == 'SPP-FINAL'){ ?>
