...
$(document).ready(function(){
    ...
    <?php if($doc_tambah_em == ''):?>
    
    <?php // if(($doc_tambah_em == '')||($doc_tambah_em == 'SPP-DITOLAK')||($doc_tambah_em == 'SPM-DITOLAK-KPA')||($doc_tambah_em == 'SPM-DITOLAK-VERIFIKATOR')||($doc_tambah_em == 'SPM-DITOLAK-KBUU')||($doc_tambah_em == 'SPM-DITOLAK-BUU')):?>
    
        <?php if($detail_tambah_em['nom'] == '0' ): ?>
    ...
    <?php elseif(($doc_tambah_em == 'SPP-DITOLAK')||($doc_tambah_em == 'SPM-DITOLAK-KPA')||($doc_tambah_em == 'SPM-DITOLAK-VERIFIKATOR')||($doc_tambah_em == 'SPM-DITOLAK-KBUU')||($doc_tambah_em == 'SPM-DITOLAK-BUU')):?>
    ...
    <?php elseif($doc_tambah_em == 'SPM-FINAL-KBUU'):?>
...
//            console.log($('#jml_penyesuaian').val());
            ...
            $.ajax({
                type:"POST",
                url :"<?=site_url('rsa_tambah_em/get_next_nomor_spp')?>",
                data:'' ,
...
//                        
    ...
    $(document).on("click",'#proses_spp',function(){
        if(confirm('Apakah anda yakin ?')){
            var data = 'proses=' + 'SPP-DRAFT' + '&nomor_trx=' + $('#nomor_trx').html() + '&jenis=' + 'SPP' + '&jumlah_bayar=' + string_to_angka($('#jumlah_bayar').text()) + '&terbilang=' + $('#terbilang').text() + '&untuk_bayar=' + $('#untuk_bayar').text() + '&penerima=' + $('#penerima').text() + '&alamat=' + $('#alamat').text() + '&nmbank=' + $('#nmbank').text() + '&rekening=' + $('#rekening').text() + '&npwp=' + $('#npwp').text() + '&nmbendahara=' + $('#nmbendahara').text() + '&nipbendahara=' + $('#nipbendahara').text() + '&id_nomor_tambah_em=' + '<?=$id_nomor_tambah_em?>' ;
            $.ajax({
                type:"POST",
                url :"<?=site_url('rsa_tambah_em/usulkan_spp_tambah_em')?>",
                data:data,
                success:function(data){
//                        console.log(data)
//                        $('#no_bukti').html(data);
//                        $('#myModalKuitansi').modal('show');
                        if(data!='gagal'){
                            window.location = "<?=site_url('rsa_tambah_em/spp_tambah_em_lihat/')?>" + data;
                        }else{
                          location.reload();
                        }
//                        
    ...
    $(document).on("click","#down",function(){
                    ...
                    var uri = $("#table_spp_tambah_em").excelexportjs({
                                    containerid: "table_spp_tambah_em"
                                    , datatype: "table"
                                    , returnUri: true
                                });
...
<div id="page-inner">
    ...
    <?php if($doc_tambah_em == ''){ $stts_bendahara = 'active'; ?>
    ...
    <?php }elseif($doc_tambah_em == 'SPP-DRAFT'){ $stts_bendahara = 'done'; $stts_ppk = 'active'; ?>
    ...
    <?php }elseif($doc_tambah_em == 'SPP-DITOLAK'){ $stts_bendahara = 'done'; $stts_ppk = 'done'; ?>
    ...
    <?php }elseif($doc_tambah_em == 'SPP-FINAL'){ $stts_bendahara = 'done';  $stts_ppk = 'done'; ?>   
    ...
    <?php }elseif($doc_tambah_em == 'SPM-DRAFT-PPK'){ $stts_bendahara = 'done'; $stts_ppk = 'done';  $stts_kpa = 'active'; ?>   
    ...
    <?php }elseif($doc_tambah_em == 'SPM-DRAFT-KPA'){ $stts_bendahara = 'done'; $stts_ppk = 'done'; $stts_kpa = 'done' ; $stts_verifikator = 'active';  ?>   
    ...
    <?php }elseif($doc_tambah_em == 'SPM-DITOLAK-KPA'){ $stts_bendahara = 'done'; $stts_ppk = 'done'; $stts_kpa = 'done' ; ?>   
    ...
    <?php }elseif($doc_tambah_em == 'SPM-FINAL-VERIFIKATOR'){ $stts_bendahara = 'done'; $stts_ppk = 'done'; $stts_kpa = 'done' ; $stts_verifikator = 'done'; $stts_kbuu = 'active' ?>   
    ...
    <?php }elseif($doc_tambah_em == 'SPM-DITOLAK-VERIFIKATOR'){ $stts_bendahara = 'active'; ?>   
    ...
    <?php }elseif($doc_tambah_em == 'SPM-FINAL-KBUU'){ $stts_bendahara = 'done'; $stts_ppk = 'done'; $stts_kpa = 'done' ; $stts_verifikator = 'done'; $stts_kbuu = 'done' ?>   
    ...
    <?php }elseif($doc_tambah_em == 'SPM-DITOLAK-KBUU'){ $stts_bendahara = 'active'; ?>   
    ...
    <?php }elseif($doc_tambah_em == 'SPM-FINAL-BUU'){ $stts_bendahara = 'done'; ?> 
    ...
    <?php }elseif($doc_tambah_em == 'SPM-DITOLAK-BUU'){ $stts_bendahara = 'active'; ?>   
				...
				<tr>
                                    <td colspan="5" style="line-height: 16px;border-bottom: none;border-top: none;">
                                        <ol style="list-style-type: lower-alpha;margin-top: 0px;margin-bottom: 0px;" >
                                            <li>Jumlah pembayaran yang diminta : Rp. <span id="jumlah_bayar"><?=number_format($detail_tambah_em['nom'], 0, ",", ".")?></span>,-<br>
                                                &nbsp;&nbsp;&nbsp;(Terbilang : <b><span id="terbilang"><?=ucwords($detail_tambah_em['terbilang'])?> <?php echo substr($detail_tambah_em['terbilang'],strlen($detail_tambah_em['terbilang'])-6,6) == 'Rupiah' ? '' : 'Rupiah' ; ?></span></b>)</li>
                                                <li>Untuk keperluan : <span id="untuk_bayar"><?=isset($detail_pic->untuk_bayar)?$detail_pic->untuk_bayar:'Pembayaran kegiatan kerjasama'?></span></li>
								...
								<td  style="text-align: center;">
									12111
                                                                ...
                                                                <td style="text-align: right;padding-right: 10px;">
                                                                    Rp. <span class="jumlah_bayar"><?=number_format($detail_tambah_em['nom'], 0, ",", ".")?></span>
								</td>
...
<br />
<form action="<?=site_url('rsa_tambah_em/cetak_spp')?>" id="form_spp" method="post" style="display: none"  >
...
<div class="modal" id="myModalTambahUP" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">TAMBAH EMONEY</h4>
      </div>
    <div class="modal-body">
        <p>
            <div class="form-group">
      ...
      <div class="modal-footer">
        ...
        <a href="<?php echo site_url('rsa_tambah_em/daftar_spp');?>" class="btn btn-danger" id="btn_batal_1"><span class="glyphicon glyphicon-repeat" aria-hidden="true"></span> Batal</a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
          <div class="alert alert-warning text-center">
              <button type="button" class="btn btn-success" id="btn_buat_lagi" ><span class="glyphicon glyphicon-ok-sign" aria-hidden="true"></span> Buat Lagi</button>
              <!--<a href="<?php echo site_url('rsa_tambah_em');?>" class="btn btn-danger"><span class="glyphicon glyphicon-remove-sign" aria-hidden="true"></span> Tidak</a>-->
