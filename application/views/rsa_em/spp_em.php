...
$(document).ready(function(){
        ...
        //             return $.get("<?=site_url('rsa_em/get_data_untuk_pekerjaan')?>", { query : query }, function (data) {
        //                 // console.log(data);
        //                 data = $.parseJSON(data);
        //                 return process(data);
        //             });
        ...
        //   source: function(query, process) {
        //             return $.get("<?=site_url('rsa_em/get_data_json')?>", { query : query }, function (data) {
        //                 // console.log(data);
        //                 data = $.parseJSON(data);
        //                 return process(data);
        //             });
        ...
        // $("#nama_pihak_ketiga").typeahead({
        //   source: function(query, process) {
        //             return $.get("<?=site_url('rsa_em/get_data_penerima')?>", { query : query }, function (data) {
        //                 // console.log(item);
        //                 data = $.parseJSON(data);
        //                 return process(data);
...
//    var pj_p_nilai_all = [];
  ...
  // do something…
    ...
    <?php if(($doc_em == '')&&($detail_em['nom'] == '0')&&($detail_em['pengembalian'] == '0'))://if($detail_em['nom'] == '0'):?>
...
//    }).show();
        ...
        $('#myModalKonfirm').on('show.bs.modal', function (e) {
            // do something...
            // alert('te');
            var pengeluaran_m = <?=$detail_em['nom']?> ;
            var pengembalian_n = <?=$detail_em['pengembalian']?> ;
    ...
    //                        $('#myModalKuitansi').modal('show');
                            if(data=='sukses'){
                                ...
                                window.location = "<?=site_url('rsa_em/daftar_spp')?>" ;
...
<div id="page-inner">
    ...
    <?php if((substr($doc_em,4,7)=='DITOLAK')&&($detail_em['nom'] > 0)){ $stts_bendahara = 'active'; ?>   
    ...
    <?php }elseif($doc_em == 'SPP-DRAFT'){ $stts_bendahara = 'done'; $stts_ppk = 'active'; ?>
        <div class="alert alert-info" style="border:1px solid #a94442;">SPP EM Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> menunggu persetujuan <b><span class="text-danger" >PPK </span></b> .</div>
    <?php }elseif($doc_em == 'SPP-DITOLAK'){ $stts_bendahara = 'active'; ?>
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPP EM Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >PPK </span></b> <b>[ <a href="javascript:void(0);" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    <?php }elseif($doc_em == 'SPP-FINAL'){ $stts_bendahara = 'done';  $stts_ppk = 'done'; ?>   
        <div class="alert alert-info" style="border:1px solid #a94442;">SPP EM Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah diterima oleh <b><span class="text-danger" >PPK </span></b> .</div>
    ...
    <?php }elseif($doc_em == 'SPM-DITOLAK-KPA'){ $stts_bendahara = 'active'; ?>   
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPM EM Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >KPA </span></b> <b>[ <a href="javascript:void(0);" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    ...
    <?php }elseif($doc_em == 'SPM-DITOLAK-VERIFIKATOR'){ $stts_bendahara = 'active'; ?>   
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPM EM Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >VERIFIKATOR </span></b> <b>[ <a href="javascript:void(0);" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    ...
    <?php }elseif($doc_em == 'SPM-DITOLAK-KBUU'){ $stts_bendahara = 'active'; ?>   
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPM EM Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >KUASA BUU </span></b> <b>[ <a href="javascript:void(0);" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    ...
    <?php }elseif($doc_em == 'SPM-DITOLAK-BUU'){ $stts_bendahara = 'active'; ?>   
        <div class="alert alert-warning" style="border:1px solid #a94442;">SPM EM Tahun <b><span class="text-danger" ><?=$cur_tahun?></span></b> telah ditolak oleh <b><span class="text-danger" >BUU </span></b> <b>[ <a href="javascript:void(0);" data-toggle="modal" data-target="#myModalLihatKet" >alasan</a> ]</b>.</div>
    <?php } ?>
				...
				<tr>
                                    <td colspan="5" style="line-height: 16px;border-bottom: none;border-top: none;">
                                        <ol style="list-style-type: lower-alpha;margin-top: 0px;margin-bottom: 0px;" >
                                            <li>Jumlah pembayaran yang diminta : Rp. <span id="jumlah_bayar" style='mso-number-format:"\@";'><?=number_format($detail_em['nom'], 0, ",", ".")?></span>,-<br>
                                                &nbsp;&nbsp;&nbsp;(Terbilang : <b><span id="terbilang"><?=ucwords($detail_em['terbilang'])?> <?php echo substr($detail_em['terbilang'],strlen($detail_em['terbilang'])-6,6) == 'Rupiah' ? '' : 'Rupiah' ; ?></span></b>)</li>
                                                <li>Untuk pembayaran: <span id="untuk_bayar"><?=isset($detail_pic->untuk_bayar)?$detail_pic->untuk_bayar:'-'?></span></li>
...
<form action="<?=site_url('rsa_up/cetak_spp')?>" id="form_spp" method="post" style="display: none"  >
    ...
    <input type="text" name="dtahun" id="dtahun" value="<?=$cur_tahun?>" />
            ...
            <div class="alert alert-warning" style="text-align:center">
                ...
                <?php }elseif(($doc_em == 'SPP-DITOLAK')||($doc_em == 'SPM-DITOLAK-KPA')||($doc_em == 'SPM-DITOLAK-VERIFIKATOR')||($doc_em == 'SPM-DITOLAK-KBUU')||($doc_em == 'SPM-DITOLAK-BUU')){ ?>
                    <?php if($detail_em['nom'] == '0'):?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>
            <div class="form-group">
                <blockquote class="">
                <p class="text-danger">Untuk membuat SPP EM silahkan anda memulai dari daftar kuitansi yang akan diusulkan.</p>
              </blockquote>
            </div>
        </p>
      </div>
      ...
      <div class="modal-body">
          <form class="form-horizontal" id="simpan_rincian_spp">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control validate[required]" id="untuk_pekerjaan" placeholder="- DI ISI -" data-provide="typeahead">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label">Nama Penerima</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control validate[required]" id="nama_pihak_ketiga" placeholder="" value="terlampir" readonly="readonly">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label">Alamat</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control validate[required]" id="alamat_ketiga" placeholder="" value="terlampir" readonly="readonly">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label">Nama Bank</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control validate[required]" id="nama_bank" placeholder="- DI ISI -" value="">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label">Nama Rekening</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control validate[required]" id="nama_rek_bank" placeholder="- DI ISI -" value="">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label">No Rekening Bank</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control validate[required]" id="nomor_rek_bank" placeholder="- DI ISI -" value="">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label">No NPWP</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control validate[required]" id="nomor_npwp" placeholder="" value="-" readonly="readonly">
                  </div>
                </div>
              </form>
      </div>
