...
//                            var sumber_dana = $('#sumber_dana').val();
                            window.location = "<?=site_url("rsa_spumk/daftar_spumk")?>/" + $("#tahun").val();
...
//                        }
			...
			$(document).on("click","#createspp",function(){
                            ...
                            window.location = "<?=site_url("rsa_spumk/spumk_tambah_ks")?>/" ;
...
<div id="page-wrapper">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="col-md-7">
									<button class="btn btn-danger" type="button" id="createspp" style="margin: 0 auto; width: 40%; display: block;" data-original-title="" title=""><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span> Create SPUMK</button>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="col-md-12 table-responsive">
				<table class="table table-bordered table-striped table-hover small">
					...
					<tr>
                        ...
                        <th class="text-center col-md-3">SPUMK</th>
                        <th class="text-center col-md-3">SPP</th>
	...
	?>
					<tr>
						...
						<td class="text-center"><?php echo $value->str_nomor_trx_spumk ?></td>
						<td class="text-center"><?php echo $value->str_nomor_trx_spumk_spp ?></td>
						...
						<td class="text-center"><b>[ <a href="<?=site_url('/rsa_spumk/spumk_lihat/').urlencode(base64_encode($value->str_nomor_trx_spumk))?>">lihat</a> ]</b></td>
					</tr>
	<?php
			}
		}else{
