...
//                        
    ...
    $(document).on("click",'#proses_spp',function(){
        if(confirm('Apakah anda yakin ?')){
            var data = 'proses=' + 'SPP-DRAFT' + '&nomor_trx=' + $('#nomor_trx').html() + '&jenis=' + 'SPP' + '&jumlah_bayar=' + string_to_angka($('#jumlah_bayar').text()) + '&terbilang=' + $('#terbilang').text() + '&untuk_bayar=' + $('#untuk_bayar').text() + '&penerima=' + $('#penerima').text() + '&alamat=' + $('#alamat').text() + '&nmbank=' + $('#nmbank').text() + '&rekening=' + $('#rekening').text() + '&npwp=' + $('#npwp').text() + '&nmbendahara=' + $('#nmbendahara').text() + '&nipbendahara=' + $('#nipbendahara').text() + '&id_nomor_tambah_ks=' + '<?=$id_nomor_tambah_ks?>' ;
            $.ajax({
                type:"POST",
			...
			<tbody>
                            ...
                            <tr style="">
                                ...
                                <tr style="border-top: none;">
                                    <td colspan="5" style="text-align: center;font-size: 16px;border-bottom: none;border-top: none;"><b>SURAT PERMOHONAN UANG MUKA KERJA</b></td>
                                </tr>
                                <tr style="border-top: none;border-bottom: none;">
                                    ...
                                    <td style="border-left: none;border-top: none;border-bottom: none;"><b>JENIS : DANA KERJASAMA</b></td>
                                </tr>
                                <tr style="border-top: none;">
				...
				<tr style="border-bottom: none;">
                                ...
                                <tr >
                                        <td colspan="5" style="border-bottom: none;border-top: none;">Dengan berpedoman pada DPA-SUKPA yang telah ditetapkan dalam RKAT, bersama ini kami mengajukan Surat Permohonan Uang Muka Kerja sebagai berikut:</td>
                                </tr>
				<tr>
                                    <td colspan="5" style="line-height: 16px;border-bottom: none;border-top: none;">
                                        <ol style="list-style-type: lower-alpha;margin-top: 0px;margin-bottom: 0px;" >
                                            <li>Jumlah pembayaran yang diminta : Rp. <span id="jumlah_bayar"><?=number_format($detail_tambah_ks['nom'], 0, ",", ".")?></span>,-<br>
                                                ...
                                                <li>Untuk pembayaran : <span id="untuk_bayar"><?=isset($detail_pic->untuk_bayar)?$detail_pic->untuk_bayar:'Pembayaran kegiatan kerjasama'?></span></li>
				...
				<tr style="border-bottom: none;">
						...
						Surat Permohonan Uang Muka Kerja sebagaimana dimaksud diatas, disusun sesuai dengan dokumen lampiran yang persyaratkan dan disampaikan secara bersamaan serta merupakan bagian yang tidak terpisahkan dari surat ini.<br><br>														
					</td>
				<tr>
				<tr style="border-top: none;"> 

        <td colspan="3" style="line-height: 16px;border-left: none;border-top:none;border-right:none;" class="ttd">
                  Menyetujui, <?php  // setlocale(LC_ALL, 'id_ID.utf8'); echo $tgl_spp==''?'':strftime("%d %B %Y", strtotime($tgl_spp)); //  ?> <br>
                  Bendahara Pengeluaran<br>
                                                                        <br>
                                                                        <br>
                                                                        <br>
