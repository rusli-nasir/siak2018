<script>
	$('#tgl_retur').datepicker({
		...
		// alert();
		$("#no_retur").val(no_retur.replace(no_retur.substr(-8,8),bulan_str+"/"+tahun));
		// console.log(tahun);
	});
</script>
<form id="form_edit_retur" onsubmit="return false">
	...
	<div class="modal-header blue-gradient text-white">
		...
		<h4 class="modal-title text-center" id="myModalLabel">
			<b style="color:#fff;">Formulir Edit RETUR</b>
		</h4>
	</div>
		...
		<table class="table-condensed" style="margin: auto;width: 70%;">
			<tbody>
				...
				<tr>
					...
					<td><b>:</b></td>
					<td align="left">
						<input type="text" class="validate[required] form-control" id="no_retur" name="no_retur" value="<?php echo $no_retur ?>" required>
					</td>
				</tr>
				<tr>
					...
					<td align="left">
						<div class="input-group">
							...
							<input type="text" class="validate[required] form-control readonly" id="tgl_retur" name="tgl_retur" value="<?php echo $tgl_retur ?>" required>
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="left">
						<div class="input-group">
							...
							<input type="text" class="validate[required] form-control xnumber" id="nominal" name="nominal" value="<?php echo number_format($nominal_retur,0,',','.') ?>" disabled>
						</div>
					</td>
				</tr>
	...
	<div class="modal-footer">
		<button type="reset" id="close_retur" class="btn btn-default cancel btn-sm" aria-label="Center Align" data-dismiss="modal">
			Batal
		</button>
