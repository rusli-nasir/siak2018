...
<script>
	$(document).on("change","#bulan",function(){
		if ($("#bulan").val() == '') {
			...
			window.location = "<?=site_url("rsa_sp2d/sp2d_per_spm/")?>" + $("#bulan").val()  ;
	...
	$(document).on("click","#dl",function(){
        ...
        if (bulan != '') {
        	var nama_file = 'download_sp2d_<?php echo $bulan ?>.xls';
        }else{
        	var nama_file = 'download_sp2d_all.xls';
        }
	...
	<div id="page-inner">
		...
		<div class="tab-base">
			<ul class="nav nav-tabs" role="tablist">
				...
				<!-- <li role="presentation"><a href="<?php echo site_url('rsa_sp2d/history_sp2d') ?>#history_sp2d"><b>Riwayat SP2D</b></a></li> -->
				<li role="presentation" class="active"><a href="#laporan_sp2d_per_spm" aria-controls="laporan_sp2d_per_spm" role="tab" data-toggle="tab"><b><i class="fa fa-file-text-o"></i> Laporan SP2D per SPM</b></a></li>
			</ul>
		</div>

		<div class="tab-content">
			<div role="tabpanel" class="tab-pane active" id="laporan_sp2d_per_spm">
				<div class="row">
					<div class="col-lg-8">
						<h2>Laporan SP2D Per SPM <?php if($bulan != '13' AND $bulan != ''){echo 'Bulan '.$bulan;} ?></h2> 
						<br>
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<?php endif ?>
							<?php foreach ($list_sp2d as $key => $value): ?>
								<?php $tmp_array = array(); ?>
									<thead>
										<tr>
											...
											<th class="text-center">NO SP2D/RETUR</th>
									...
									<tbody class="tb-isi">
									<?php foreach ($list_sp2d[$key]['data_sp2d'] as $key2 => $value2): ?>
										<tr <?php if($value2['jenis_sp2d']=='Retur'){echo 'style="color:#e47c32;"';} ?>>
										<?php if (!in_array($value2['no_spm'], $tmp_array)): ?>
											<td class="text-center" rowspan="<?php echo count($list_sp2d[$key]['data_sp2d'])+1; ?>" style="vertical-align: middle;padding: 2px;border-bottom: 0px;text-align: center;"><?php echo $value2['no_spm']; ?></td>
										<?php endif ?>
											<td style="vertical-align: middle;padding: 2px;"><b style="text-transform: uppercase;">[<?php echo strtoupper( $value2['jenis_sp2d']); ?>]</b> <?php echo $value2['keterangan']; ?></td>
											...
											<td class="text-left" style="vertical-align: middle;padding: 2px;text-align: left;"><?php echo $value2['bank']; ?></td>
												<td  class="text-center" style="border-bottom: 0px;width: 50px;vertical-align: middle;text-align: center;"><?php echo $value2['nama_unit']; ?></td>
											<?php $tmp_array[] = $value2['no_spm']; ?>
											<?php $unit = $value2['nama_unit']; ?>
										</tr>
									<?php endforeach ?>
									<tr>
										...
										<td  class="text-center" style="border-bottom: 0px;width: 50px;vertical-align: middle;text-align: center;"><?php echo $unit; ?></td>
									</tr>
									<tr>
