...
//                            var sumber_dana = $('#sumber_dana').val();
                            window.location = "<?=site_url("rsa_sp2d/tambah_sp2d/")?>" + $("#tahun").val() + '/' + $("#unit").val() + '/' + $("#jenis").val() + '/' + $("#bulan").val()  ;
	...
	<div id="page-inner">
		...
		<div class="tab-base">
			<ul class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active"><a href="#tambah_sp2d" aria-controls="tambah_sp2d" role="tab" data-toggle="tab"><i class="fa fa-plus-circle"></i> <b>Tambah SP2D</b></a></li>
