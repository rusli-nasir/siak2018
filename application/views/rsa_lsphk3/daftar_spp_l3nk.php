...
?>
		$('#kentut').on('submit',function(e){
			...
			window.location='<?php echo site_url('Rsa_lsphk3/daftar_spp')."/tahun/"; ?>'+data;
		});
			...
			<div class="col-md-12 table-responsive">
				<table class="table table-bordered table-striped table-hover small">
					...
					<tr>
						...
						<th class="text-center" width="150">Proses SPP/SPM</th>
					</tr>
					</thead>
					<tbody>
	<?php
		if(isset($daftar_spp) && count($daftar_spp)>0){
			$i=1;
...
<form action="<?=site_url('rsa_lsphk3/create_spm_lsphk3_nk')?>" id="form_usulkan_spp" method="post" style="display: none">
