...
$(document).on("click","#show",function(){
    if($("#form_").validationEngine("validate")){
        window.location = "<?=site_url('rsa_lsphk3/daftar_spm_verifikator_nk/')?>" + $('#kd_unit')+ $('#tahun').val();
...
<div id="page-wrapper" >
    ...
    <form class="form-horizontal alert alert-warning col-sm-8" method="post" id="form_tor" action="<?php echo site_url('rsa_lsphk3/daftar_unit_verifikator');?>">
	    ...
	    <div class="col-sm-offset-2 col-sm-10">
	      ...
	      <button type="reset" class="btn btn-info" id="reset"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span> Reset</button>
			...
			<div id="temp" style="display:none"></div>
					...
					<form action="<?=site_url('rsa_lsphk3/view_spm_lsphk3_verifikator_nk')?>" id="form_usulkan_spm" method="post" style="display: none">
