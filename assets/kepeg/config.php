...
$_CONFIG['display'][0]="";
// set for path
$_CONFIG['path'] = "http://10.69.12.215/rsa/hack-sign";
// $_CONFIG['path'] = "http://gaji.web.id";
$_PATH = $_CONFIG['path'];
$GLOBALS['path'] = $_PATH;
...
$_CONFIG['logo'] = "<a href=\"".$_PATH."\" class=\"navbar-brand\"><i class=\"fa fa-users\"></i></a>";
// end configuration
