<?php
	function getNominalTutam($id,$kel){
		...
		WHERE b.status_aktif = 1 AND a.nip NOT LIKE '%196006271990011001%' AND (a.status = 1 OR a.status = 3 OR a.status = 6 OR a.status = 12) AND e.jenisrek = 2
		ORDER BY a.nip, a.nama";
		$dt = getdatadb($sql);
?>
