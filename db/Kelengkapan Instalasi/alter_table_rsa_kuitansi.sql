...
ALTER TABLE `trx_spm_tambah_em_data` ADD `flag_proses_akuntansi` int(1) NOT NULL DEFAULT '0';
ALTER TABLE `trx_spm_em_data` ADD `flag_proses_akuntansi` int(1) NOT NULL DEFAULT '0';
ALTER TABLE `trx_spm_tambah_ks_data` ADD `flag_proses_akuntansi` int(1) NOT NULL DEFAULT '0';