...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2017 at 05:29 AM
...
--
ALTER TABLE `akuntansi_kuitansi_jadi`
  MODIFY `id_kuitansi_jadi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT for table `akuntansi_relasi_kuitansi_akun`
--
ALTER TABLE `akuntansi_relasi_kuitansi_akun`
  MODIFY `id_relasi_kuitansi_akun` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
